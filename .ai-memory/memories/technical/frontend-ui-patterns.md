...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `02-spec/20-gsearch-cli/02-frontend/05-ui-patterns.md`
...
- Spec: `02-spec/20-gsearch-cli/02-frontend/05-ui-patterns.md`
- Hooks: `02-spec/28-shared-cli-frontend/15-hooks-library.md`
