...
| 2 | **43 stale directory references** to modules that were renamed/moved (e.g., `02-spec/02-coding-guidelines/03-golang/` → `02-spec/02-coding-guidelines/03-golang/`) | Implementation Blocker — AI following these links will fail to find referenced material | Cross-module |
...
### 3.1 02-spec/11-spec-management-software (Score: 6.2)
...
### 3.2 02-spec/01-general-spec (Score: 5.5)
...
### 3.3 02-spec/24-nexus-flow-cli (Score: 6.1)
...
### 3.4 02-spec/60-ai-research (Score: 4.4)
...
### 3.5 02-spec/53-e2-activity-feed (Score: 3.8)
...
### 3.6 02-spec/52-shared-preset-data (Score: 3.1)
...
- **02-spec/06-split-db-architecture/** — referenced by GSearch, BRun, AI Bridge, Nexus Flow, WP SEO, License Manager
- **02-spec/07-seedable-config-architecture/** — referenced by all CLI tools
- **02-spec/03-error-code-registry/** — referenced by all modules with error codes
- **02-spec/28-shared-cli-frontend/** — referenced by all CLI frontend specs
- **02-spec/04-error-resolution/** — referenced by all modules with error handling

### 4.2 Circular Dependencies
- None detected at folder level

### 4.3 Orphaned Specs
- **02-spec/52-shared-preset-data/** — referenced by very few modules
- **02-spec/99-archive/** — expected orphan (deprecated)
- **02-spec/51-upload-scripts/** — minimally referenced
...
|-----------------|--------------------|
| `02-spec/02-coding-guidelines/03-golang/` | `02-spec/02-coding-guidelines/03-golang/` |
| `02-spec/02-coding-guidelines/04-php/` | `02-spec/02-coding-guidelines/04-php/` |
| `02-spec/02-coding-guidelines/02-typescript/` | `02-spec/02-coding-guidelines/02-typescript/` |
| `02-spec/33-wp-plugin-development/` | `02-spec/33-wp-plugin-development/` |
| `02-spec/30-wp-plugin/` | `02-spec/30-wp-plugin/` |
| `02-spec/32-wp-seo-publish-cli/` | `02-spec/32-wp-seo-publish-cli/` |
| `02-spec/07-seedable-config-architecture/` → `02-spec/07-seedable-config-architecture/` | Path is correct; refs are stale |
