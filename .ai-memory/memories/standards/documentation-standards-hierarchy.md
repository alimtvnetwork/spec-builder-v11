...
| DBOperation Wrapper | `02-spec/11-spec-management-software/13-shared-packages/06-pkg-database-operations.md` | Mandatory wrapper implementation |
...
| Standard | Location | Purpose |
|----------|----------|---------|
| Seedable Config Architecture | `02-spec/07-seedable-config-architecture/00-overview.md` | Core seeding patterns |
...
| Standard | Location | Purpose |
|----------|----------|---------|
| Error Resolution | `02-spec/04-error-resolution/` | Universal debugging process |
