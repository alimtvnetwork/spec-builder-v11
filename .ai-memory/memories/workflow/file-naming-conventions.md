...
- Master authority: `02-spec/11-spec-management-software/02-instructions/01-file-naming-convention.md`
...
| Reference | Location |
|-----------|----------|
| Spec file naming | `02-spec/11-spec-management-software/02-instructions/01-file-naming-convention.md` |
| Source file naming | `02-spec/02-coding-guidelines/01-cross-language/00-master-coding-guidelines.md` § 1.3 |
