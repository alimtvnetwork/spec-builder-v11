...
| 3 | `project/folder-rename-history.md` | `../../02-spec/.../CONTEXT-FOR-AI.md` (renamed) | → `96-context-for-ai.md` |
...
| 7 | `features/ai-bridge/plan-synchronization.md` | `02-spec/22-ai-bridge-cli/...` (wrong depth) | → `../../../../02-spec/22-ai-bridge-cli/...` |
