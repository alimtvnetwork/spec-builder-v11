...
Extract four tools/systems from `02-spec/11-spec-management-software/05-features/` into standalone root-level specifications, while maintaining references from the parent spec.
...
|---|-----------------|-----------------|-------|--------|
| 1 | `05-features/22-golang-search-cli/` | `02-spec/20-gsearch-cli/` | 27 files | ✅ Complete |
| 2 | `05-features/30-ai-bridge/` | `02-spec/22-ai-bridge-cli/` | 8 files | ✅ Complete |
| 3 | `14-microservices/` (Nexus files) | `02-spec/24-nexus-flow-cli/` | 7 files | ✅ Complete |
| 4 | `05-features/23-build-runner-cli/` | `02-spec/21-brun-cli/` | 19 files | ✅ Complete |
| 5 | *NEW* | `02-spec/28-shared-cli-frontend/` | 10 files | ✅ Complete |
...
Updated in `02-spec/11-spec-management-software/15-external-tools/`
...
**Shared Spec:** `02-spec/28-shared-cli-frontend/` (10 files)
...
2. Implement React frontends following `02-spec/28-shared-cli-frontend/`
