...
**Updated:** 2026-02-17  
**Version:** 1.0.0  
**Spec Location:** `02-spec/21-brun-cli/` (standalone, extracted from spec-management-software)
...
Located at `02-spec/21-brun-cli/`:
...
Integration reference at: `02-spec/11-spec-management-software/15-external-tools/04-brun-reference.md`
