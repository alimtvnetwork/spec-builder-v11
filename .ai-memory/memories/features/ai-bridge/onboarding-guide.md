...
| Reference | Location |
|-----------|----------|
| Full Specification | `02-spec/22-ai-bridge-cli/01-backend/47-onboarding-guide.md` |
| RAG Pipeline | `.lovable/memories/features/ai-bridge/rag-pipeline.md` |
| Plan Synchronization | `02-spec/22-ai-bridge-cli/01-backend/45-plan-synchronization.md` |
| Execution Monitoring | `02-spec/22-ai-bridge-cli/01-backend/48-plan-execution-monitoring.md` |
