...
**Updated:** 2026-02-03  
**Version:** 1.0.0  
**Spec Location:** `02-spec/11-spec-management-software/05-features/22-golang-search-cli/`
...
- URL Extraction Spec: `02-spec/22-ai-bridge-cli/01-backend/29-gsearch-url-extraction.md`
- Company Profile: `02-spec/22-ai-bridge-cli/01-backend/28-company-profile-management.md`
- Crawler Spec: `02-spec/20-gsearch-cli/01-backend/17-full-site-crawler.md`
- Caching Spec: `02-spec/20-gsearch-cli/01-backend/10-caching-system.md`
