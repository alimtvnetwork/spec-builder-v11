...
GSearch CLI provides a comprehensive unified CLI and REST API reference (02-spec/20-gsearch-cli/01-backend/60-unified-cli-api-reference.md) covering all search, provider, SERP, schedule, enum, and cache operations. All options use enum-based configuration.
...
- Specification: `02-spec/20-gsearch-cli/01-backend/60-unified-cli-api-reference.md`
