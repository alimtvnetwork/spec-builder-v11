...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `02-spec/22-ai-bridge-cli/01-backend/29-gsearch-url-extraction.md`
...
- GSearch Crawler: `02-spec/20-gsearch-cli/01-backend/17-full-site-crawler.md`
- Authority Scoring: `02-spec/20-gsearch-cli/01-backend/18-authority-credibility-scoring.md`
- Caching: `02-spec/20-gsearch-cli/01-backend/10-caching-system.md`
