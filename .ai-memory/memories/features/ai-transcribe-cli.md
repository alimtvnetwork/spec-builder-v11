...
- **Folder Structure:** `02-spec/26-ai-transcribe-cli/{00-overview, 01-backend, 02-frontend, 03-deploy}`
...
- Overview: `02-spec/26-ai-transcribe-cli/00-overview.md`
- Tool Delegation: `02-spec/22-ai-bridge-cli/01-backend/32-tool-delegation.md`
