...
- Model Router — *file removed; see spec for current agentic search specs*
- [Seedable Configuration](../patterns/seedable-configuration.md)
- [AI Integration Overview](../../../02-spec/11-spec-management-software/05-features/06-ai-integration/00-overview.md)
