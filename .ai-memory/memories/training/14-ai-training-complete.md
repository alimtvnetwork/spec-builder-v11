...
Check `02-spec/11-spec-management-software/05-features/` for the highest existing number.
If `25-ai-enhancements/` exists, your new feature is `26-{feature-name}/`.

### Step 2: Create Folder Structure

```bash
mkdir 02-spec/11-spec-management-software/05-features/26-new-feature
touch 02-spec/11-spec-management-software/05-features/26-new-feature/00-overview.md
touch 02-spec/11-spec-management-software/05-features/26-new-feature/01-core-spec.md
mkdir 02-spec/11-spec-management-software/05-features/26-new-feature/tests
```
