...
| File | Purpose |
|------|---------|
| `97-ai-handoff-guide.md` (Section 6-7) | Minimal handoff + startup modes |
...
├── 97-ai-handoff-guide.md                # Handoff instructions
└── 05-features/
...
```
02-spec/11-spec-management-software/05-features/27-automation-pipeline/
├── 00-overview.md               # START HERE
