...
**Spec Location:** `02-spec/11-spec-management-software/04-coding-guidelines/05-seedable-config-pattern.md`
...
- [Split Database System](../architecture/01-split-db-architecture.md) — Where settings.db lives
