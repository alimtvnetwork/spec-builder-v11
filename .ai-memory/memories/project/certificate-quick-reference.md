...
|---|---------------|------|-------|------------|----------|
| 1 | CERT-2026-0314-ISS18 | 2026-03-14 | Issue #18 — Code example audit across 1,164 spec files | ~18,900 violations remediated, 9/9 categories clear | `02-spec/validation-reports/05-completion-certificate-issue-18.md` |
| 2 | CERT-2026-0318-REFRESH | 2026-03-18 | v30.0.0 baseline — project-wide consistency refresh (30 modules, 1,246 files) | 847/847 broken links fixed, 100/100 health score (A+) | `02-spec/validation-reports/14-audit-certificate-2026-03-18.md` |
...
| 4 | CERT-2026-0330-V2COMP | 2026-03-30 | Spec Authoring Guide v2.0.0 compliance rollout (33 modules, 1,567 files) | 139 overviews upgraded, 100% compliance | `02-spec/validation-reports/16-audit-certificate-v2-compliance-2026-03-30.md` |
