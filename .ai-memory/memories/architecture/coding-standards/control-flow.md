...
| Reference | Location |
|-----------|----------|
| P7 Rule | `02-spec/02-coding-guidelines/03-golang/02-boolean-standards.md` § 2.5 |
| Coding Standards §10 | `02-spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` |
