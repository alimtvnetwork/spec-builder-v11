...
- `02-spec/02-coding-guidelines/04-php/forbidden-patterns.md` (rules 1.8, 1.9)
- `02-spec/33-wp-plugin-development/02-logging-standards.md`
- `02-spec/33-wp-plugin-development/07-error-handling.md`
- `02-spec/61-how-app-issues-track/17-missing-stack-trace-in-catch-blocks.md`
