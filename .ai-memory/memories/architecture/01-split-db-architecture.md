...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `02-spec/06-split-db-architecture/00-overview.md`
...
- `02-spec/06-split-db-architecture/00-overview.md` (full spec)
- `02-spec/06-split-db-architecture/01-cli-examples.md` (concrete examples)
- `02-spec/22-ai-bridge-cli/01-backend/26-database-paths-reference.md` (path reference)
