...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `02-spec/07-seedable-config-architecture/00-overview.md`
...
**Spec:** `02-spec/07-seedable-config-architecture/06-validation-data-seeding.md`
...
- All CLI frontends (`02-spec/28-shared-cli-frontend/`)
