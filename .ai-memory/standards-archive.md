...
- `02-spec/general-spec/99-meta/` - 3 files
- `02-spec/wp-plugin/exam-manager/` root - 8 files
- `02-spec/wp-plugin/exam-manager/02-frontend/` - 2 files
- `02-spec/wp-plugin/exam-manager/01-admin-backend/split-spec/` - 1 file
...
| `BooleanHelpers.IsFunctionMissing()` | `FunctionHelpers.IsFunctionMissing()` |
| `BooleanHelpers.HasItems(arr)` | `ArrayHelpers.HasItems(arr)` |
...
Create `02-spec/spec-management-software/99-consistency-report.md` documenting:
