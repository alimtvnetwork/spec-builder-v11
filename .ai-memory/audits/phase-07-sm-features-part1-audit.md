...
**Date:** 2026-02-07  
**Auditor:** AI  
**Scope:** `02-spec/11-spec-management-software/05-features/01-authentication/` through `15-api-client/`  
...
- Path `02-spec/00-overview.md` at max length (255 chars) MUST be accepted; 256 chars MUST be rejected
...
| Resource | Location |
|----------|----------|
| Features Overview | `02-spec/11-spec-management-software/05-features/00-overview.md` |
| Database Schema | `02-spec/11-spec-management-software/07-database-design/01-schema.md` |
| Error Management | `02-spec/11-spec-management-software/06-error-management/00-overview.md` |
| Enum Specification | `02-spec/17-enum-specification/` |
| Foundation Standards | `02-spec/01-general-spec/01-foundation/` |
