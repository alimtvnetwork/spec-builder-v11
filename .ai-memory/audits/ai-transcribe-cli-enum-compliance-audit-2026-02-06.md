...
Create `02-spec/26-ai-transcribe-cli/01-backend/14-enum-architecture.md` with all enum definitions following `02-spec/17-enum-specification/` standard.
...
| Architecture | `02-spec/26-ai-transcribe-cli/01-backend/01-architecture.md` |
| STT Providers | `02-spec/26-ai-transcribe-cli/01-backend/03-stt-providers.md` |
| TTS Providers | `02-spec/26-ai-transcribe-cli/01-backend/04-tts-providers.md` |
| Database Schema | `02-spec/26-ai-transcribe-cli/01-backend/08-database-schema.md` |
| Configuration | `02-spec/26-ai-transcribe-cli/01-backend/11-configuration.md` |
