...
| File | Changes |
|------|---------|
| `02-spec/25-spec-reverse-cli/01-backend/12-enum-architecture.md` | Created with all 10 compliant enums |
| `02-spec/25-spec-reverse-cli/01-backend/01-architecture.md` | Updated GORM models to use enum types |
| `02-spec/25-spec-reverse-cli/01-backend/02-code-analysis.md` | Replaced Language, Framework, PatternType string aliases |
| `02-spec/25-spec-reverse-cli/01-backend/03-ai-bridge-integration.md` | Replaced SpecType, KnowledgeCategory string aliases |
...
| Enum Architecture | `02-spec/25-spec-reverse-cli/01-backend/12-enum-architecture.md` |
