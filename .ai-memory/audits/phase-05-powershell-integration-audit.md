...
**Date:** 2026-02-07  
**Auditor:** AI  
**Scope:** `02-spec/06-powershell-integration-v1/`, `02-spec/06-powershell-integration-v2/`  
...
|---|---------|-------------|----------|
| I-01 | v1 `00-overview.md` line 6, v2 `00-overview.md` line 7 | **Stale location reference.** Both state `Location: 02-spec/powershell-integration/` but actual paths are `02-spec/06-powershell-integration-v1/` and `02-spec/06-powershell-integration-v2/`. | 🔴 Critical |
| I-02 | v1 `00-overview.md` lines 209-211 | **Stale cross-references.** References `02-spec/spec-management-software/` and `link-manager/` — neither matches current folder structure (`02-spec/11-spec-management-software/`, and Link Manager is under `02-spec/30-wp-plugin/`). | 🟡 Warning |
...
| I-10 | v1 `00-overview.md` lines 172-182 | **Stale cross-reference paths.** References `../../powershell-integration/00-overview.md` and `../../../02-spec/powershell-integration/00-overview.md` — these are relative paths that don't match the actual `06-powershell-integration-v1/` location. | 🟡 Warning |
| I-11 | v1/v2 `04-error-codes.md` line 11 | **Error code range 9500-9599 conflicts.** The PowerShell error range 9500-9599 overlaps with the central error code registry where PS (Spec Reverse CLI) uses 9500-9999. The `02-spec/03-error-code-registry/` assigns 9500 to a different tool. | 🔴 Critical |
...
| I-13 | v1 `03-integration-guide.md` lines 273, 280 | **Stale spec path references.** References `30-powershell-integration/` and `02-spec/powershell-integration/` — neither is the current folder name. | 🟡 Warning |
...
| R-04 | 🟡 Medium | Update all `Location:` headers and internal cross-references to use actual folder names (`02-spec/06-powershell-integration-v1/`, `02-spec/06-powershell-integration-v2/`). |
...
| Resource | Location |
|----------|----------|
| PowerShell Integration v1 | `02-spec/06-powershell-integration-v1/` |
| PowerShell Integration v2 | `02-spec/06-powershell-integration-v2/` |
| Error Code Registry | `02-spec/03-error-code-registry/` |
| Shared CLI Frontend | `02-spec/28-shared-cli-frontend/` |
