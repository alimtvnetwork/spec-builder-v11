...
**Objective:** Create `02-spec/11-spec-management-software/07-database-design/05-enum-architecture.md` with all 29 compliant enums.
...
**Deliverables:**
- [x] `02-spec/11-spec-management-software/07-database-design/05-enum-architecture.md` created
...
**Objective:** Update `02-spec/11-spec-management-software/07-database-design/01-schema.md` to replace inline string-based enums.
...
**Objective:** Update `02-spec/11-spec-management-software/03-data-models/01-core-entities.md` TypeScript types to use enum references.
...
**Objective:** Update `02-spec/11-spec-management-software/03-data-models/02-ai-types.md` TypeScript types to use enum references.
