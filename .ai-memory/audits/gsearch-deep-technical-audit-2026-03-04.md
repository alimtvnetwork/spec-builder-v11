...
**Scope:** Specifications in `02-spec/20-gsearch-cli/` — SERP scraping, caching, YouTube/SRT, coding guideline compliance  
**Standards Reference:** `02-spec/02-coding-guidelines/01-cross-language/00-master-coding-guidelines.md`
...
**File:** `02-spec/20-gsearch-cli/01-backend/23-platform-search.md` (line 864)  
...
**File:** `02-spec/20-gsearch-cli/01-backend/23-platform-search.md`  
...
**File:** `02-spec/20-gsearch-cli/01-backend/05-google-api.md`  
**Rule:** §6 / §7.1
...
**File:** `02-spec/20-gsearch-cli/01-backend/44-serp-position-tracking.md` (line 194-204)  
...
**File:** `02-spec/20-gsearch-cli/01-backend/44-serp-position-tracking.md` (line 285-289)
...
**File:** `02-spec/20-gsearch-cli/01-backend/44-serp-position-tracking.md` (line 148-152)
...
**File:** `02-spec/20-gsearch-cli/01-backend/23-platform-search.md` (line 516)
...
**File:** `02-spec/20-gsearch-cli/01-backend/04-html-parser.md`
...
**File:** `02-spec/20-gsearch-cli/00-overview.md` (line 105-113)
...
**File:** `02-spec/20-gsearch-cli/01-backend/23-platform-search.md` (line 249-268)
...
**File:** `02-spec/20-gsearch-cli/01-backend/05-google-api.md` (line 288-303)
...
**File:** `02-spec/20-gsearch-cli/01-backend/10-caching-system.md` (lines 278, 283)
...
| Go Enum Specification | `02-spec/02-coding-guidelines/03-golang/01-enum-specification/` |
| GSearch Overview | `02-spec/20-gsearch-cli/00-overview.md` |
