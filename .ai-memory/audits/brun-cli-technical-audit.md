...
**Scope:** `02-spec/21-brun-cli/` (21 backend files + frontend/deploy + consistency report)  
...
| Location | Version |
|----------|---------|
| `02-spec/21-brun-cli/00-overview.md` | 2.1.0 |
| `02-spec/21-brun-cli/01-backend/00-overview.md` | 2.3.0 |
| `02-spec/11-spec-management-software/05-features/23-build-runner-cli/00-overview.md` | 2.0.0 |
| `02-spec/11-spec-management-software/15-external-tools/04-brun-reference.md` | 2.1.0 |
...
|------|-----------|-------|
| `09-integration-api.md` line 17 | `../06-ai-integration/00-overview.md` | Resolves to `02-spec/21-brun-cli/06-ai-integration/` — does NOT exist |
