...
| ✅ Archive | — | 1 | `02-spec/99-archive/` — frozen |
...
|-----------|---------|-------|-------|
| `02-spec/11-spec-management-software/05-features/` | ~350 | ~10 | Code-gen system config, AI integration, build-runner, AI Bridge (YAML+JSON) |
| `02-spec/11-spec-management-software/14-microservices/` | ~175 | ~5 | Gateway, AI Bridge (Ollama/OpenAI already EXEMPTED), Voice CLI |
| `02-spec/30-wp-plugin/wp-plugin-publish/03-implementation/` | ~200 | 3 | Git service, publish service, plugin service — all camelCase JSON |
| `02-spec/04-error-resolution/` | ~92 | 8 | Session logging, apperror, debugging guides |

### 🟡 Medium Priority

| Directory | Matches | Files | Notes |
|-----------|---------|-------|-------|
| `02-spec/20-gsearch-cli/` | ~84 | 2 | Google Maps search (EXEMPTED), contact extraction (JSON-LD) |
| `02-spec/11-spec-management-software/07-database-design/` | ~40 | 1 | Seed data YAML tags |
| `02-spec/31-wp-plugin-builder/` | ~13 | 1 | Error handling struct |
| `02-spec/26-ai-transcribe-cli/` | ~41 | 2 | STT/TTS providers (mostly EXEMPTED) |

### 🟢 Already Clean (0 violations)

| Directory | Status |
|-----------|--------|
| `02-spec/21-brun-cli/` | ✅ Clean |
| `02-spec/24-nexus-flow-cli/` | ✅ Clean |
| `02-spec/25-spec-reverse-cli/` | ✅ Clean |
| `02-spec/32-wp-seo-publish-cli/` | ✅ Clean |
| `02-spec/22-ai-bridge-cli/` | ✅ Clean (34 matches all EXEMPTED — Ahrefs, Moz, OpenPageRank) |
...
## YAML Tags Analysis (02-spec/11-spec-management-software/05-features/30-ai-bridge/)
...
**Note:** These files are in `02-spec/11-spec-management-software/05-features/30-ai-bridge/` (feature specs), NOT `02-spec/22-ai-bridge-cli/` (CLI module specs). The CLI module specs are already clean.
...
|------|-------|------------|----------|--------|
| 11a | `02-spec/30-wp-plugin/wp-plugin-publish/03-implementation/` — Remove redundant JSON tags | ~95 | 🔴 | ✅ DONE |
| 11b | `02-spec/04-error-resolution/` — Remove redundant JSON tags | ~92 | 🔴 | ✅ DONE |
| 11c | `02-spec/11-spec-management-software/05-features/` — Remove redundant JSON tags (non-config) | ~200 | 🔴 | ✅ DONE |
| 11d | `02-spec/31-wp-plugin-builder/` — Remove redundant JSON tags | ~8 | 🟡 | ✅ DONE |
...
16 files remediated across `02-spec/11-spec-management-software/05-features/`:
