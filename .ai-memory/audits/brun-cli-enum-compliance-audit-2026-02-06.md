...
| File | Changes |
|------|---------|
| `02-spec/21-brun-cli/01-backend/19-enum-architecture.md` | Created with all 7 compliant enums |
| `02-spec/21-brun-cli/01-backend/03-configuration.md` | Added Go configuration structs with enum types |
| `02-spec/21-brun-cli/01-backend/08-asset-operations.md` | Replaced `CopyMode string` with `copy_mode.Variant` |
| `02-spec/21-brun-cli/01-backend/10-data-models.md` | Updated GORM structs to use enum types |
| `02-spec/21-brun-cli/01-backend/04-runtime-executors.md` | Replaced `RuntimeType` with `runtime.Variant` |
| `02-spec/21-brun-cli/01-backend/07-build-profiles.md` | Updated `BuildProfile.Runtime` and validation logic |
| `02-spec/21-brun-cli/01-backend/06-error-handling.md` | Replaced severity strings with `severity.Variant` |
...
| Enum Architecture | `02-spec/21-brun-cli/01-backend/19-enum-architecture.md` |
| Configuration | `02-spec/21-brun-cli/01-backend/03-configuration.md` |
