...
|--------|------|-----------------|----------|
| **GSearch CLI (main)** | `02-spec/20-gsearch-cli/01-backend/` | ~1,500 ctx, ~600 fmt.Errorf, ~800 tuples | 🔴 Critical |
| **Spec Management Software** | `02-spec/11-spec-management-software/` | ~2,000 ctx, ~800 fmt.Errorf, ~1,200 tuples | 🔴 Critical |
| **GSearch CLI (features)** | `02-spec/02-.../22-golang-search-cli/` | ~500 ctx, ~250 fmt.Errorf, ~400 tuples | 🔴 Critical |
...
| Module | Path | Est. Violations | Priority |
|--------|------|-----------------|----------|
| **Nexus Flow CLI** | `02-spec/24-nexus-flow-cli/` | ~400 ctx, ~150 fmt.Errorf, ~250 tuples | 🟠 High |
| **WP Plugin Builder** | `02-spec/31-wp-plugin-builder/` | ~300 ctx, ~120 fmt.Errorf, ~200 tuples | 🟠 High |
| **Spec Reverse CLI** | `02-spec/25-spec-reverse-cli/` | ~200 ctx, ~80 fmt.Errorf, ~150 tuples | 🟠 High |
| **AI Transcribe CLI** | `02-spec/26-ai-transcribe-cli/` | ~250 ctx, ~100 fmt.Errorf, ~180 tuples | 🟠 High |
| **WP SEO Publish** | `02-spec/32-wp-seo-publish-cli/` | ~180 ctx, ~70 fmt.Errorf, ~120 tuples | 🟠 High |
...
| Module | Path | Est. Violations | Priority |
|--------|------|-----------------|----------|
| **Shared CLI Frontend** | `02-spec/28-shared-cli-frontend/` | ~300 ctx, ~150 fmt.Errorf, ~200 tuples | 🟡 Medium |
| **Error Code Registry** | `02-spec/03-error-code-registry/` | ~50 ctx, ~20 fmt.Errorf, ~30 tuples | 🟡 Medium |
| **PowerShell Integration** | `02-spec/50-powershell-integration/` | ~100 ctx, ~40 fmt.Errorf, ~60 tuples | 🟡 Medium |
...
|--------|------|----------|
| **Coding Guidelines** | `02-spec/02-coding-guidelines/01-cross-language/` | Mark with ❌ indicators |
| **Go Standards** | `02-spec/02-coding-guidelines/03-golang/` | Mark with ❌ indicators |
...
| Wave | Files | Target |
|------|-------|--------|
| 20 | `02-spec/24-nexus-flow-cli/` | Context assembly, RAG |
| 21 | `02-spec/31-wp-plugin-builder/` | Plugin generation |
| 22 | `02-spec/25-spec-reverse-cli/` | Reverse engineering |
| 23 | `02-spec/26-ai-transcribe-cli/` | Audio transcription |
| 24 | `02-spec/32-wp-seo-publish-cli/` | SEO publishing |

### Wave 25-27: Shared Infrastructure

| Wave | Files | Target |
|------|-------|--------|
| 25 | `02-spec/28-shared-cli-frontend/` | Frontend hooks, services |
| 26 | `02-spec/50-powershell-integration/` | PS cmdlets |
| 27 | `02-spec/03-error-code-registry/` | Error definitions |

### Wave 28-30: Standards Annotation

| Wave | Files | Target |
|------|-------|--------|
| 28 | `02-spec/02-coding-guidelines/01-cross-language/` | Add ❌ markers to forbidden patterns |
| 29 | `02-spec/02-coding-guidelines/03-golang/` | Add ❌ markers to forbidden patterns |
...
- `02-spec/20-gsearch-cli/01-backend/42-multi-engine-search.md`
- `02-spec/11-spec-management-software/05-features/02-file-management/01-file-operations.md`
- `02-spec/11-spec-management-software/05-features/09-knowledge-memory/08-vector-db-implementation-guide.md`
...
| Master Coding Guidelines | `02-spec/02-coding-guidelines/01-cross-language/` |
