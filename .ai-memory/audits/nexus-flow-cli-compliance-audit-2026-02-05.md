 ...
 **Evidence**: `04-error-codes.md` defines 12+ error codes across 4 domains (Canvas 80xx, Workflow 81xx, Execution 82xx, State 83xx).
 ...
 | Document | Path |
 |----------|------|
 | Nexus Flow Overview | `02-spec/24-nexus-flow-cli/00-overview.md` |
 | Backend Overview | `02-spec/24-nexus-flow-cli/01-backend/00-overview.md` |
 ...
 | Error Codes | `02-spec/24-nexus-flow-cli/01-backend/04-error-codes.md` |
 | Observability | `02-spec/24-nexus-flow-cli/01-backend/07-observability.md` |
