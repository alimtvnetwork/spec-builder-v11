...
Create `02-spec/12-wp-seo-publish-cli/01-backend/12-enum-architecture.md` with all enum definitions following `02-spec/17-enum-specification/` standard.
...
| Architecture | `02-spec/12-wp-seo-publish-cli/01-backend/01-architecture.md` |
| Content Generation | `02-spec/12-wp-seo-publish-cli/01-backend/03-content-generation.md` |
| Variable System | `02-spec/12-wp-seo-publish-cli/01-backend/05-variable-system.md` |
| Split DB Schema | `02-spec/12-wp-seo-publish-cli/01-backend/06-split-db-schema.md` |
| Export Service | `02-spec/12-wp-seo-publish-cli/01-backend/07-export-service.md` |
