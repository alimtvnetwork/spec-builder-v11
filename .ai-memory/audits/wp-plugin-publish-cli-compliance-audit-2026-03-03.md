...
**Evidence**: `02-spec/30-wp-plugin/wp-plugin-publish/00-overview.md` lines 266-271 explicitly link to:
- `02-spec/11-spec-management-software/13-shared-packages/06-pkg-database-operations.md`
...
| Document | Path |
|----------|------|
| WP Plugin Publish Overview | `02-spec/30-wp-plugin/wp-plugin-publish/00-overview.md` |
| Database Schema | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/02-database-schema.md` |
| Error Management | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/13-error-management.md` |
| Logging System | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/14-logging-system.md` |
| Seedable Config | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/15-seedable-config.md` |
| Split DB Architecture | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/16-split-db-architecture.md` |
| REST API Endpoints | `02-spec/30-wp-plugin/wp-plugin-publish/01-backend/11-rest-api-endpoints.md` |
| Shared Constants | `02-spec/30-wp-plugin/wp-plugin-publish/66-shared-constants.md` |
