...
**Date:** 2026-02-07  
**Auditor:** AI  
**Scope:** `02-spec/22-ai-bridge-cli/00-overview.md` + `02-spec/22-ai-bridge-cli/01-backend/00-overview.md` through `14-reset-and-export-api.md`  
...
**GIVEN** `02-spec/22-ai-bridge-cli/01-backend/`  
