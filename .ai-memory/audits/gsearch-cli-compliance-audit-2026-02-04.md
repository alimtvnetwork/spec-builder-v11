...
| Document | Path |
|----------|------|
| GSearch Overview | `02-spec/20-gsearch-cli/01-backend/00-overview.md` |
| Database Architecture | `02-spec/20-gsearch-cli/01-backend/22-database-architecture.md` |
| Settings Service | `02-spec/20-gsearch-cli/01-backend/21-settings-service.md` |
| Error Codes | `02-spec/20-gsearch-cli/01-backend/15-error-codes.md` |
| Observability | `02-spec/20-gsearch-cli/01-backend/16-observability.md` |
