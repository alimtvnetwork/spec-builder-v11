...
| # | Gap | Resolution |
|---|-----|-----------|
| 1 | `CL-01` ID collision (Changelog vs Component Library) | Component Library renamed to `CL-03` in `02-spec/28-shared-cli-frontend/99-acceptance-criteria.md` |
| 2 | `SS-01` ID collision (GSearch Scheduled Search vs Settings Service) | Scheduled Search renamed to `GS-SS-02` in `02-spec/20-gsearch-cli/01-backend/99-acceptance-criteria.md` |
