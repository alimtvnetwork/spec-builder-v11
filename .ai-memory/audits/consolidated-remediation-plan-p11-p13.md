...
**Remediation:**
1. Designate `02-spec/21-brun-cli/06-error-handling.md` as BRun's error registry (range 7100-7599 only)
2. Designate `02-spec/22-ai-bridge-cli/01-backend/05-error-codes.md` as AI Bridge's sole error registry (9000-9999)
...
**Remediation:** Convert all to `type Variant byte` with `iota`, implement 9 mandatory methods per `02-spec/17-enum-specification/`.
