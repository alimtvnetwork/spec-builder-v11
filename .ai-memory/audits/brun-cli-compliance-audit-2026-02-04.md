...
**Evidence**: `02-spec/21-brun-cli/00-overview.md` lines 121-122 explicitly link to:
...
| Document | Path |
|----------|------|
| BRun Overview | `02-spec/21-brun-cli/00-overview.md` |
| Backend Overview | `02-spec/21-brun-cli/01-backend/00-overview.md` |
| Database Architecture | `02-spec/21-brun-cli/01-backend/16-database-architecture.md` |
| Settings Service | `02-spec/21-brun-cli/01-backend/17-settings-service.md` |
| Error Handling | `02-spec/21-brun-cli/01-backend/06-error-handling.md` |
| Observability | `02-spec/21-brun-cli/01-backend/15-observability.md` |
