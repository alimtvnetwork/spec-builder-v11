...
**Severity:** Low  
**Feature / Module:** Error Code Registry (`02-spec/03-error-code-registry/`)
...
In `02-spec/22-ai-bridge-cli/`, the constant name `ErrTokenBudgetExceeded` is allocated at code 9845 (Core AI Bridge) and at 9914 (Plan Templates).
