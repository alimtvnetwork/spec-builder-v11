...
|---------|----------|--------|------------|--------|
| Spec Management Software | `02-spec/11-spec-management-software/` | ✅ Ready | 400+ | 100/100 |
| GSearch CLI | `02-spec/20-gsearch-cli/` | ✅ Ready | 27 | 100/100 |
| BRun CLI | `02-spec/21-brun-cli/` | ✅ Ready | 19 | 100/100 |
| AI Bridge CLI | `02-spec/22-ai-bridge-cli/` | ✅ Ready | 9 | 100/100 |
| Nexus Flow CLI | `02-spec/24-nexus-flow-cli/` | ✅ Ready | 9 | 100/100 |
| Shared CLI Frontend | `02-spec/03-shared-cli-frontend/` | ✅ Ready | 10 | 100/100 |
| Split DB Architecture | `02-spec/06-split-db-architecture/` | ✅ Ready | 1 | 100/100 |
| Seedable Config Architecture | `02-spec/07-seedable-config-architecture/` | ✅ Ready | 1 | 100/100 |
| Link Manager WP Plugin | `02-spec/30-wp-plugin/link-manager/` | ✅ Ready | 30 | 100/100 |
...
| Issue Tracking System | ✅ Established at `02-spec/61-how-app-issues-track/` |
...
| v17.0.0: Legacy README Rename + Master Index | ✅ Complete — 11 README/readme files renamed to numeric prefixes, ~60+ cross-refs updated, `02-spec/00-overview.md` master index created with Mermaid dependency diagram |
...
| v19.0.0: Module Health Dashboard + Validation Reports | ✅ Complete — Per-module dashboard (30 modules, all 100/100 A+), `02-spec/validation-reports/` created (6 reports) |
...
|--------|---------------|--------|
| Link Manager | `02-spec/30-wp-plugin/link-manager/` | ✅ Spec Ready |
| WP Plugin Builder | `02-spec/31-wp-plugin-builder/` | ✅ Spec Ready |
| WP SEO Publish | `02-spec/32-wp-seo-publish-cli/` | ✅ Spec Ready |
...
|---------|----------|--------|
| Split DB Architecture | `02-spec/06-split-db-architecture/` | ✅ Complete |
| Seedable Config | `02-spec/07-seedable-config-architecture/` | ✅ Complete |
| PowerShell Integration | `02-spec/50-powershell-integration/` | ✅ Complete |
| Error Code Registry | `02-spec/03-error-code-registry/` | ✅ Complete |
| Registry Overlap Validator | `02-spec/03-error-code-registry/02-overlap-validator.md` | 📋 Spec Ready |
| Shared CLI Frontend | `02-spec/03-shared-cli-frontend/` | ✅ Complete |
| Enum Specification | `02-spec/25-golang-standards/01-enum-specification/` | ✅ Complete (moved from `02-spec/17-enum-specification/`, now archived) |
...
| ~~Issue Tracking System~~ | ~~Set up `02-spec/61-how-app-issues-track/` with template, checklist, and first issue write-up~~ | ✅ Done (2026-02-22) |
...
| ~~v17.0.0 README Rename + Master Index~~ | ~~Rename 11 legacy README files, create 02-spec/00-overview.md master index with dependency diagram~~ | ✅ Done (2026-03-15) |
...
|----------|---------|-------------|---------------|--------|
| **1** | **SM-010** | **Implement Golang Backend** | `02-spec/11-spec-management-software/05-features/SM-010-golang-backend-implementation.md` *(spec not yet created)* | High |
...
| Issue Tracking | Active at `02-spec/61-how-app-issues-track/` (21 issues, #03–#21) |
...
| 2026-03-15 | Plan v17.0.0 — Renamed 11 legacy README/readme files to numeric prefixes (~60+ cross-refs updated). Created `02-spec/00-overview.md` master index with Mermaid dependency diagram (30 modules, 6 layers). Issues #19–#20 documented. Suggestions C-064/C-065/C-066 completed. P-052/P-053 opened. | Structural integrity + discoverability |
