...
**Cross-References:**
- [Nexus-Flow Service](../../11-spec-management-software/14-microservices/06-nexus-flow.md) — Core service specification
- [React Flow Canvas](../../11-spec-management-software/14-microservices/07-react-flow-canvas.md) — Visual editor components
- [Shared pkg/ Modules](../../11-spec-management-software/14-microservices/08-shared-pkg-modules.md) — Common utilities
- [Split Database System](../../11-spec-management-software/14-microservices/../07-database-design/00-overview.md)
...
- [Nexus-Flow Service](../../11-spec-management-software/14-microservices/06-nexus-flow.md) — Core service architecture
- [React Flow Canvas](../../11-spec-management-software/14-microservices/07-react-flow-canvas.md) — Visual editor details
- [Database Design](../../11-spec-management-software/14-microservices/../07-database-design/00-overview.md) — Schema conventions
- [Error Management](../../11-spec-management-software/06-error-management/02-backend/01-error-codes.md) — Error handling patterns
- [AI-Bridge Service](../../11-spec-management-software/14-microservices/04-ai-bridge.md) — LLM integration for prompts
- [Scout Service](../../11-spec-management-software/14-microservices/05-scout.md) — RAG integration for search stages
