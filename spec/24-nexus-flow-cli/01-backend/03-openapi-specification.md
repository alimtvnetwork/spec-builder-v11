...
- [Nexus-Flow Standalone Architecture](../../11-spec-management-software/14-microservices/09-nexus-flow-standalone-architecture.md)
- [Gateway OpenAPI](../../11-spec-management-software/14-microservices/14-gateway-openapi.md)
- [AI-Bridge OpenAPI](../../11-spec-management-software/14-microservices/13-ai-bridge-openapi.md)
...
See [Nexus-Flow Service Specification](../../11-spec-management-software/14-microservices/06-nexus-flow.md) §3 for detailed node type configurations.
