# WP Plugin Development — Changelog


**Version:** 1.0.0  
**Last Updated:** 2026-03-20  

All notable changes to the WP Plugin Development specification are documented here.
...
Project-wide major version increment (+1.0.0) applied to all specification files in `33-wp-plugin-development`.
