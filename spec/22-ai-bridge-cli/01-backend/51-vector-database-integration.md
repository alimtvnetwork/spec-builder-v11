...
| RAG Architecture | `.lovable/memories/technical/rag-chunk-configuration.md` |
| Database Architecture | `spec/22-ai-bridge-cli/01-backend/12-database-architecture.md` |
| Settings Service | `spec/22-ai-bridge-cli/01-backend/57-settings-service.md` |
| Observability | `spec/22-ai-bridge-cli/01-backend/56-observability.md` |
