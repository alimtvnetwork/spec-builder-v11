...
```go
// In GSearch CLI: spec/20-gsearch-cli/01-backend/
...
| GSearch Platform Search | `../../20-gsearch-cli/01-backend/23-platform-search.md` |
| WP SEO AI Bridge Client | `../../32-wp-seo-publish-cli/01-backend/04-ai-bridge-client.md` |
