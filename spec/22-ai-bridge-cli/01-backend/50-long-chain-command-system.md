...
// See: spec/22-ai-bridge-cli/01-backend/53-enum-architecture.md
//
// Usage:
...
| Document | Relevance |
|----------|-----------|
| `spec/04-error-resolution/` | Error handling patterns |
| `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` | Error code registry |
| `spec/22-ai-bridge-cli/01-backend/09-agentic-mode.md` | Prompt-to-Search pipeline, SearchPlan schema |
| `spec/22-ai-bridge-cli/01-backend/37-adaptive-reasoning-flow.md` | Reasoning mode selection, heuristics |
| `spec/22-ai-bridge-cli/01-backend/40-gsearch-context-integration.md` | GSearch delegation, context detection |
| `spec/22-ai-bridge-cli/01-backend/49-execution-retry-strategies.md` | Retry patterns |
