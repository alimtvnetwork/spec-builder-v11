...
- [**Error Code Registry (Centralized)**](../../11-spec-management-software/06-error-management/01-error-code-registry.md) — Authoritative source for all 7xxx error codes
...
> **📋 Canonical Reference:** The authoritative error code definitions are maintained in the [Central Error Code Registry](../../11-spec-management-software/06-error-management/01-error-code-registry.md). This section provides a local reference; for the latest codes and cross-domain consistency, always consult the central registry.
