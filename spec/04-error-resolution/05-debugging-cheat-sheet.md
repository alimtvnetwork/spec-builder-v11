...
| Guide | Target |
|-------|--------|
| [PHP Debugging](./03-debugging-guides/01-debugging-php.md) | WordPress, PHP backends |
| [Go Debugging](./03-debugging-guides/02-debugging-go.md) | CLI tools, Go backends |
| [TypeScript Debugging](./03-debugging-guides/03-debugging-typescript.md) | React frontends |
| [Frontend-Backend Sync](./02-verification-patterns/01-frontend-backend-sync.md) | Integration verification |
| [Cross-Reference Diagram](./04-cross-reference-diagram.md) | Architecture overview |
