...
- [Golang Coding Standards](../../02-coding-guidelines/03-golang/04-golang-standards-reference.md) — File size, function size, type safety, file naming
- [Cross-Language Code Style](../../02-coding-guidelines/01-cross-language/04-code-style.md) — Braces, nesting, spacing
...
*apperror package specification v1.5.0 — 2026-02-26*
