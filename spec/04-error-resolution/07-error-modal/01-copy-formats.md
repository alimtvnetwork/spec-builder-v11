...
3. **Implement `CapturedError` interface** — See Section 2 of `spec/07-error-manage/07-error-modal/03-error-modal-reference.md`
...
- [Envelope Schema](../09-response-envelope/envelope.schema.json) — JSON Schema source of truth
- [Envelope Error Sample](../09-response-envelope/envelope-error.json) — Canonical error response
- [Error Handling Spec](../06-error-handling/02-error-handling-reference.md) — Cross-stack error architecture
- [Session Logging Spec](../08-logging-and-diagnostics/02-session-based-logging.md) — Session data model
- [React Execution Logger](../08-logging-and-diagnostics/01-react-execution-logger.md) — Frontend call chain
