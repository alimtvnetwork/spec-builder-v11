...
> **Note:** `DelegatedRequestServer` is accessed via `error.envelopeErrors?.DelegatedRequestServer`, not as a top-level field on `CapturedError`. See `spec/07-error-manage/07-error-modal/03-error-modal-reference.md` for the full interface.
...
- [Error Resolution Retrospectives](../01-retrospectives/)
- [Session-Based Logging](../08-logging-and-diagnostics/02-session-based-logging.md)
- [React Execution Logger](../08-logging-and-diagnostics/01-react-execution-logger.md)
- [Error Modal Spec](../07-error-modal/03-error-modal-reference.md)
- [Copy Format Samples](../07-error-modal/01-copy-formats.md)
- [Response Envelope Schema](../09-response-envelope/envelope.schema.json)
- [Envelope Configurability](../09-response-envelope/01-adr.md)
