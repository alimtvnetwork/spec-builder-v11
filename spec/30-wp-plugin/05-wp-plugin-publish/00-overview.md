...
| Document | Purpose |
|----------|---------|
| [Error Resolution Overview](../../04-error-resolution/00-overview.md) | Frontend-backend verification patterns |
| [Go Debugging Guide](../../04-error-resolution/03-debugging-guides/02-debugging-go.md) | Initialization order, zerolog, response envelope |
| [TypeScript Debugging Guide](../../04-error-resolution/03-debugging-guides/03-debugging-typescript.md) | React frontend debugging |
