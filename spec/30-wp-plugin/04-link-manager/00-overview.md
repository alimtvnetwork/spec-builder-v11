...
| [PHP Debugging Guide](../../04-error-resolution/03-debugging-guides/01-debugging-php.md) | Initialization order, logging |
| [PHP Coding Guidelines](../../11-spec-management-software/12-prompts/01-coding-guideline/04-backend-php.md) | BooleanUtil, 15-line limit |
