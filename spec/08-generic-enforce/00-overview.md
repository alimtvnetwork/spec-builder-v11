...
`generic-enforce` · `type-aliases` · `generics` · `golang` · `typescript` · `rust` · `naming-conventions` · `type-safety`
...
|----------|------|----------------|
| TypeScript | [`02-typescript.md`](./02-typescript.md) | `type X = Y<A, B>` |
| Go 1.18+ | [`01-golang.md`](./01-golang.md) | `type X = Y[A, B]` |
| C# | [`03-csharp.md`](./03-csharp.md) | Inheritance or `global using` (C# 12+) |
| Rust | [`04-rust.md`](./04-rust.md) | `type X = Y<A, B>;` |
...
- [Type Safety Rules](../02-coding-guidelines/02-typescript/08-typescript-standards-reference.md)
- [DRY Principles](../02-coding-guidelines/01-cross-language/08-dry-principles.md)
