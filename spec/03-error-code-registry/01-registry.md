...
| `SM` | Spec Management Software | 2000-2999 | `spec/11-spec-management-software/` | ✅ Active |
| `LM` | Link Manager | 3000-3999 | `spec/30-wp-plugin/04-link-manager/` | ⚠️ Deprecated — range reassigned to 15000-15999 |
| `CLI` | CLI Tools (legacy) | 4000-4999 | (deprecated) | ⚠️ Deprecated |
| `GS` | GSearch CLI Core | 7000-7099 | `spec/20-gsearch-cli/` | ✅ Active |
| `BR` | BRun CLI | 7100-7599 | `spec/21-brun-cli/` | ✅ Active |
| `GS` | GSearch Movie Search | 7600-7609 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `GS` | GSearch BI Suite | 7700-7839 | `spec/20-gsearch-cli/01-backend/openapi-bi-suite.yaml` | ✅ Active |
| `GS` | GSearch Multi-Source | 7840-7859 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `GS` | GSearch Scheduled | 7860-7879 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `GS` | GSearch Chrome Extension | 7880-7899 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `GS` | GSearch Enum Architecture | 7900-7919 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `GS` | GSearch Provider Integration | 7920-7949 | `spec/20-gsearch-cli/01-backend/` | ✅ Active |
| `NF` | Nexus Flow | 8000-8399 | `spec/24-nexus-flow-cli/` | ✅ Active |
| `AB` | AI Bridge Core | 9000-9499 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `PS` | PowerShell Integration | 9500-9599 | `spec/50-powershell-integration/` | ✅ Active |
| `AB` | AI Bridge SEO | 9500-9540 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Extended | 9600-9699 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Revisions/Suggestions | 9700-9749 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge RAG Session Memory | 9750-9809 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Adaptive Reasoning | 9810-9829 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge WebSocket Resilience | 9830-9839 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Context Integration | 9840-9847 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Research Mode | 9848-9849 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Code Pattern Learning | 9850-9869 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Plan Generation | 9870-9889 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Plan Synchronization | 9890-9909 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Plan Templates | 9910-9929 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Execution Monitoring | 9930-9949 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Retry Strategies | 9950-9969 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Long-Chain Commands | 9970-9989 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Vector DB | 9990-9999 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB` | AI Bridge Lovable Reasoning | 19000-19019 | `spec/22-ai-bridge-cli/` | ✅ Active |
| `AB-TR` | AI Bridge Non-Vector RAG | 20000-20999 | `spec/23-ai-bridge-non-vector-rag/` | ✅ Active |
| `WPB` | WP Plugin Builder | 10000-10499 | `spec/31-wp-plugin-builder/` | ✅ Active |
| `SRC` | Spec Reverse CLI | 11000-11999 | `spec/25-spec-reverse-cli/` | ✅ Active |
| `WSP` | WP SEO Publish | 12000-12599 | `spec/32-wp-seo-publish-cli/` | ✅ Active |
| `WPP` | WP Plugin Publish | 13000-13999 | `spec/30-wp-plugin/05-wp-plugin-publish/` | ✅ Active |
| `AIT` | AI Transcribe CLI | 14000-14499 | `spec/26-ai-transcribe-cli/` | ✅ Active |
| `EQM` | Exam Manager | 14500-14999 | `spec/30-wp-plugin/03-exam-manager/` | ✅ Active |
| `LM` | Link Manager | 15000-15999 | `spec/30-wp-plugin/04-link-manager/` | ✅ Active |
| `SM-CG` | SM Code Generation | 16000-16799 | `spec/11-spec-management-software/05-features/24-code-generation-system/` | ✅ Active |
| `SM-PE` | SM Project Editor | 17000-17999 | `spec/11-spec-management-software/05-features/28-project-editor/` | ✅ Active |
| `SM-GS` | SM GSearch CLI | 18000-18249 | `spec/11-spec-management-software/05-features/22-golang-search-cli/` | ✅ Active |
| `SM-RT` | SM Realtime | 2800-2849 | `spec/11-spec-management-software/05-features/18-realtime/` | ✅ Active |
| `SM-RV` | SM Registry Validator | 2850-2859 | `spec/03-error-code-registry/08-overlap-validator.md` | ✅ Active |
...
**Resolution:** SM Code Generation reassigned to **16000-16799**. WSP retains 12000-12599. All 12xxx codes in `spec/11-spec-management-software/05-features/24-code-generation-system/16-error-codes.md` remapped to 16xxx equivalents.
...
**Resolution:** SM Project Editor reassigned to **17000-17999**. WPP retains 13000-13999. All 13xxx codes in `spec/11-spec-management-software/05-features/28-project-editor/05-error-codes.md` remapped to 17xxx equivalents.
...
- PS: `spec/50-powershell-integration/04-error-codes.md`
- AB SEO: `spec/22-ai-bridge-cli/01-backend/16-ai-seo-error-codes.md`
...
**Resolution:** All 92 GSearch CLI codes reassigned to **SM-GS 18000-18249** with 20-slot sub-ranges per domain. Full migration table in `spec/11-spec-management-software/05-features/22-golang-search-cli/15-error-codes.md`.
...
|--------|--------|-------|-------------------|-----------------|
| GSearch CLI Core | `GS` | 7000-7099 | 7050-7069 | `spec/20-gsearch-cli/01-backend/15-error-codes.md` |
| BRun CLI | `BR` | 7100-7599 | 7150-7169 | `spec/21-brun-cli/01-backend/06-error-handling.md` |
| GSearch Movie Search | `GS` | 7600-7609 | N/A | `spec/20-gsearch-cli/01-backend/` |
| GSearch BI Suite | `GS` | 7700-7839 | 7800-7819 | `spec/20-gsearch-cli/01-backend/openapi-bi-suite.yaml` |
| GSearch Multi-Source | `GS` | 7840-7859 | N/A | `spec/20-gsearch-cli/01-backend/` |
| GSearch Scheduled | `GS` | 7860-7879 | N/A | `spec/20-gsearch-cli/01-backend/` |
| GSearch Chrome Extension | `GS` | 7880-7899 | N/A | `spec/20-gsearch-cli/01-backend/` |
| GSearch Enum Architecture | `GS` | 7900-7919 | N/A | `spec/20-gsearch-cli/01-backend/` |
| GSearch Provider Integration | `GS` | 7920-7949 | N/A | `spec/20-gsearch-cli/01-backend/` |
| Nexus Flow | `NF` | 8000-8399 | 8050-8069 | `spec/24-nexus-flow-cli/01-backend/04-error-codes.md` |
| AI Bridge Core | `AB` | 9000-9499 | 9050-9069 | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge SEO | `AB` | 9500-9540 | N/A | `spec/22-ai-bridge-cli/01-backend/16-ai-seo-error-codes.md` |
| AI Bridge Extended | `AB` | 9600-9699 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Revisions/Suggestions | `AB` | 9700-9749 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge RAG Session Memory | `AB` | 9750-9809 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Adaptive Reasoning | `AB` | 9810-9829 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge WebSocket Resilience | `AB` | 9830-9839 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Context Integration | `AB` | 9840-9847 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Research Mode | `AB` | 9848-9849 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Code Pattern Learning | `AB` | 9850-9869 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Plan Generation | `AB` | 9870-9889 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Plan Synchronization | `AB` | 9890-9909 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Plan Templates | `AB` | 9910-9929 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Execution Monitoring | `AB` | 9930-9949 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Retry Strategies | `AB` | 9950-9969 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Long-Chain Commands | `AB` | 9970-9989 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Vector DB | `AB` | 9990-9999 | N/A | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
| AI Bridge Lovable Reasoning | `AB` | 19000-19019 | N/A | `spec/22-ai-bridge-cli/01-backend/42-lovable-reasoning-defaults.md` |
| WP Plugin Builder | `WPB` | 10000-10499 | N/A | `spec/31-wp-plugin-builder/10-error-handling.md` |
| Spec Reverse CLI | `SRC` | 11000-11999 | N/A | `spec/25-spec-reverse-cli/01-backend/05-error-codes.md` |
| WP SEO Publish | `WSP` | 12000-12599 | N/A | `spec/32-wp-seo-publish-cli/01-backend/` |
| WP Plugin Publish | `WPP` | 13000-13999 | N/A | `spec/30-wp-plugin/05-wp-plugin-publish/66-shared-constants.md` |
| AI Transcribe CLI | `AIT` | 14000-14499 | N/A | `spec/26-ai-transcribe-cli/01-backend/10-error-codes.md` |
| Exam Manager | `EQM` | 14500-14999 | N/A | `spec/30-wp-plugin/03-exam-manager/66-shared-constants.md` |
| Link Manager | `LM` | 15000-15999 | N/A | `spec/30-wp-plugin/04-link-manager/` |
| AI Bridge Non-Vector RAG | `AB-TR` | 20000-20999 | N/A | `spec/23-ai-bridge-non-vector-rag/08-error-codes.md` |
...
> See `spec/50-powershell-integration/04-error-codes.md` for full list.
