...
> Generated: 2026-02-28 | Source: `spec/03-error-code-registry/01-registry.md`
**Version:** 1.0.0  
...
- All resolutions are logged in the canonical registry at `spec/03-error-code-registry/01-registry.md`.
- Remediation tracking: `spec/61-how-app-issues-track/16-error-code-collision-remediation.md`.
