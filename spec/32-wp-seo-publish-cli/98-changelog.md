# WP SEO Publish CLI — Changelog


**Version:** 1.0.0  
**Last Updated:** 2026-03-20  

All notable changes to the WP SEO Publish CLI specification are documented here.
...
Project-wide major version increment (+1.0.0) applied to all specification files in `32-wp-seo-publish-cli`.
