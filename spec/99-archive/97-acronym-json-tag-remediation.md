...
| File | Issues |
|------|--------|
| `spec/20-gsearch-cli/01-backend/11-rag-export.md` | Rag→Rag, JSON tags |
| `spec/20-gsearch-cli/01-backend/45-contact-extraction.md` | JSON tags |
| `spec/20-gsearch-cli/01-backend/48-unified-rest-api.md` | Api→Api, JSON tags |
| `spec/20-gsearch-cli/01-backend/54-model-decomposition.md` | JSON tags |
| `spec/22-ai-bridge-cli/01-backend/50-long-chain-command-system.md` | Cli→Cli, JSON tags |
| `spec/22-ai-bridge-cli/01-backend/51-vector-database-integration.md` | Rag→Rag, JSON tags |
| `spec/22-ai-bridge-cli/01-backend/12-database-architecture.md` | JSON tags |
| `spec/22-ai-bridge-cli/01-backend/57-settings-service.md` | JSON tags |
| `spec/21-brun-cli/01-backend/16-database-architecture.md` | JSON tags |
| `spec/24-nexus-flow-cli/01-backend/05-database-architecture.md` | JSON tags |

### Medium Priority (Overview & Architecture)

| File | Issues |
|------|--------|
| `spec/20-gsearch-cli/01-backend/00-overview.md` | Rag, Cli, Api acronyms |
| `spec/22-ai-bridge-cli/01-backend/00-overview.md` | Rag, Cli, Api acronyms |
| `spec/22-ai-bridge-cli/00-overview.md` | Cli, Api acronyms |
| `spec/21-brun-cli/00-overview.md` | Cli acronyms |
| `spec/25-spec-reverse-cli/01-backend/01-architecture.md` | Cli, Api acronyms |

### Low Priority (Memory Files)

| File | Issues |
|------|--------|
| `.lovable/memories/features/ai-bridge/*.md` | Rag, Cli acronyms |
| `.lovable/memories/technical/rag-*.md` | Rag acronym |
| `.lovable/memories/architecture/rag-*.md` | Rag acronym |
...
Files to update:
1. `spec/20-gsearch-cli/01-backend/11-rag-export.md`
2. `spec/20-gsearch-cli/01-backend/45-contact-extraction.md`
3. `spec/20-gsearch-cli/01-backend/48-unified-rest-api.md`
4. `spec/20-gsearch-cli/01-backend/54-model-decomposition.md`

### Phase 2: AI Bridge CLI
Files to update:
1. `spec/22-ai-bridge-cli/01-backend/50-long-chain-command-system.md`
2. `spec/22-ai-bridge-cli/01-backend/51-vector-database-integration.md`
3. `spec/22-ai-bridge-cli/01-backend/12-database-architecture.md`
4. `spec/22-ai-bridge-cli/01-backend/57-settings-service.md`

### Phase 3: Other CLIs
Files to update:
1. `spec/21-brun-cli/01-backend/16-database-architecture.md`
2. `spec/24-nexus-flow-cli/01-backend/05-database-architecture.md`
3. `spec/25-spec-reverse-cli/01-backend/01-architecture.md`

### Phase 4: Memory Files
Update all `.lovable/memories/` files with acronym fixes.
...
| Resource | Path |
|----------|------|
| Naming Convention Memory | `.lovable/memories/style/naming-convention` |
| Original Remediation Plan | `spec/99-archive/96-naming-convention-remediation.md` |
| PascalCase Standard | `.lovable/memories/training/01-conventions.md` |
