...
**File:** `spec/22-ai-bridge-cli/01-backend/51-vector-database-integration.md`
...
**File:** `spec/22-ai-bridge-cli/01-backend/50-long-chain-command-system.md`
...
**File:** `spec/22-ai-bridge-cli/01-backend/40-gsearch-context-integration.md`
...
**File:** `spec/20-gsearch-cli/01-backend/48-unified-rest-api.md`
...
**File:** `spec/20-gsearch-cli/01-backend/54-model-decomposition.md`
...
**Files to Review:**
- `spec/20-gsearch-cli/01-backend/50-bi-error-codes.md`
- `spec/20-gsearch-cli/01-backend/51-bi-validation-checklist.md`
- `spec/20-gsearch-cli/01-backend/openapi-bi-suite.yaml`
...
**File:** `spec/32-wp-seo-publish-cli/01-backend/07-api-endpoints.md`
...
**File:** `spec/31-wp-plugin-builder/11-api-interface.md`
...
| File | Action |
|------|--------|
| `.lovable/memories/training/01-conventions.md` | Add explicit JSON/API examples |
| `context-for-ai.md` | Reference remediation completion |
| `.lovable/memories/standards/00-database-standards-hub.md` | Cross-reference JSON naming |
...
| Document | Purpose |
|----------|---------|
| `.lovable/memories/training/01-conventions.md` | Naming convention source |
| `spec/99-consistency-report.md` | Prior consistency audit |
| `.lovable/memories/workflow/spec-audit-consistency-review.md` | Memory tracking |
