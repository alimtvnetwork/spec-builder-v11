...
| # | Old Path | New Path |
|---|----------|----------|
| 01 | `spec/general-spec/` | `spec/01-general-spec/` |
| 02 | `spec/spec-management-software/` | `spec/11-spec-management-software/` |
| 03 | `spec/shared-cli-frontend/` | `spec/28-shared-cli-frontend/` |
| 04 | `spec/split-db-architecture/` | `spec/06-split-db-architecture/` |
| 05 | `spec/cw-config-architecture/` | `spec/07-seedable-config-architecture/` |
| 06 | `spec/powershell-integration/` | `spec/50-powershell-integration/` |
| 07 | `spec/error-code-registry/` | `spec/03-error-code-registry/` |
| 08 | `spec/gsearch-cli/` | `spec/20-gsearch-cli/` |
| 09 | `spec/brun-cli/` | `spec/21-brun-cli/` |
| 10 | `spec/ai-bridge/` + `spec/ai-bridge-cli/` | `spec/22-ai-bridge-cli/` |
| 11 | `spec/nexus-flow/` | `spec/24-nexus-flow-cli/` |
| 12 | `spec/wp-plugin/` | `spec/30-wp-plugin/` |
| 13 | `spec/wp-plugin-builder/` | `spec/31-wp-plugin-builder/` |
...
- [x] Global consistency report created at `spec/99-consistency-report.md`
...
grep -r "spec/gsearch-cli/" spec/
grep -r "spec/brun-cli/" spec/
grep -r "spec/nexus-flow/" spec/
grep -r "spec/ai-bridge/" spec/
