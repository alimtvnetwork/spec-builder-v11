...
|--------|--------|--------|
| `00-overview.md` → CI/CD Compliance Automation | `.lovable/memories/project/ci-cd-compliance-automation.md` | ✅ Resolves |
...
| `03-package-json-safeguard.md` → Guard Patterns | `.lovable/memories/architecture/coding-standards/guard-patterns.md` | ✅ Resolves |
