...
```markdown
See: [GSearch Backend](../../20-gsearch-cli/01-backend/00-overview.md)
```
...
| From | To | Path |
|------|----|------|
| `spec/20-gsearch-cli/01-backend/01-arch.md` | `spec/02-coding-guidelines/00-overview.md` | `../../02-coding-guidelines/00-overview.md` |
| `spec/20-gsearch-cli/00-overview.md` | `spec/02-coding-guidelines/00-overview.md` | `../02-coding-guidelines/00-overview.md` |
| `spec/20-gsearch-cli/01-backend/01-arch.md` | `spec/20-gsearch-cli/00-overview.md` | `../00-overview.md` |
...
2. **Extracts** all `[text](path)` links
...
When a module's numeric prefix changes (e.g., `20-gsearch-cli` → `20-gsearch-cli`), ALL cross-references pointing to it must be updated. This includes:

1. **Other spec files** — Any `../20-gsearch-cli/...` → `../20-gsearch-cli/...`
