...
| # | Criterion | Source |
|---|-----------|--------|
| AC-016 | All cross-references use relative paths (never root-relative or absolute) | `07-cross-references.md` |
| AC-017 | All linked files include `.md` extension | `07-cross-references.md` |
| AC-018 | Zero broken links reported by dashboard scanner | `07-cross-references.md` |
...
- [Cross-References Guide](./07-cross-references.md)
