...
### Example: AI Research (60-ai-research)
...
### Example: Coding Guidelines (02-coding-guidelines)
...
### Example: Time Log Combined (42-time-log-combined)

This module aggregates acceptance criteria from `40-time-log-cli` and `41-time-log-ui` into a single summary without duplicating the actual spec content.

---

## Massive Module: Spec Management Software

`11-spec-management-software` is the largest module (500+ files, 60+ subfolders). It uses an extended structure:
