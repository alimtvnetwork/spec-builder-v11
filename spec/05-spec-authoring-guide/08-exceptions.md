...
| 24–27 (range) | Modules 23–26 were consolidated into `02-coding-guidelines/` subfolders. Numbers retired. |

**Example:**
```
spec/
├── 32-wp-seo-publish-cli/       # Module 21 exists
├── 61-how-app-issues-track/     # Module 23 exists (22 is skipped)
├── ...
├── 33-wp-plugin-development/    # Module 28 exists (24-27 retired)
```
...
**Exception:** Prefix `02` is used by both `11-spec-management-software/` (the folder) and the root file `02-prefix-disambiguation.md`.
...
41-time-log-ui/                   # Separate UI module
...
**Exception:** `02-coding-guidelines/03-golang/01-enum-specification/` reaches the maximum depth with its own internal files.

```
spec/
└── 02-coding-guidelines/            # Level 1
    └── 03-golang/                    # Level 2
...
| 10 | 3-level depth in coding guidelines | 02-coding-guidelines/ | ✅ Yes |
