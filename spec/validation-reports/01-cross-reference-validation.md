...
**Scope:** All 1,289 markdown files in `spec/` + `.lovable/memories/`  
...
| **Wave 2** | `spec/11-spec-management-software/05-features/` (51 files) | 119 | 417 |
...
Reports: `spec/validation-reports/07-broken-link-remediation-wave1.md` through `12-…wave6.md`.
