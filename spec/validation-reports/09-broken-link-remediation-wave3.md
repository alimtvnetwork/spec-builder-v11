...
**Date:** 2026-03-15  
**Scope:** All broken links outside `spec/11-spec-management-software/05-features/` (388 starting)
...
| 24-nexus-flow-cli microservices refs | 35 | Microservices context file refs redirected to `../../11-spec-management-software/14-microservices/` |
