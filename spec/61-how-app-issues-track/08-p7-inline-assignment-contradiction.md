...
The P7 rule in `spec/02-coding-guidelines/03-golang/02-boolean-standards.md` originally prohibited **all** semicolon-separated inline assignments in `if` conditions without exemptions, while `spec/02-coding-guidelines/01-cross-language/04-code-style.md` simultaneously demonstrated `if err := fn(); err != nil` as correct idiomatic Go in multiple code examples. This created a direct contradiction: following one spec required violating the other.

### Where it happened

- **Feature / Module:** Coding standards — control flow rules
- **File paths:**
  - `spec/02-coding-guidelines/03-golang/02-boolean-standards.md` (P7 rule definition)
  - `spec/02-coding-guidelines/01-cross-language/04-code-style.md` (code examples using `if err := ...`)
  - `spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` (§10 log key rules)
...
1. **`spec/02-coding-guidelines/03-golang/02-boolean-standards.md`** — Added explicit exemptions section to P7:
...
2. **`spec/01-general-spec/01-foundation/01-coding-standards-foundation.md`** — Added §10.3 Exemptions listing the same four patterns, with cross-reference to P7

3. **`.lovable/memories/architecture/coding-standards/control-flow.md`** — Updated to reflect exemptions
...
1. `spec/02-coding-guidelines/03-golang/02-boolean-standards.md` P7 section must list all four exemptions
2. `spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` §10.3 must list matching exemptions
3. `spec/02-coding-guidelines/01-cross-language/04-code-style.md` examples using `if err := fn(); err != nil` must not violate P7
...
- `spec/02-coding-guidelines/03-golang/02-boolean-standards.md` — P7 exemptions added
- `spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` — §10.3 exemptions added
...
- [x] Issue write-up created at `spec/61-how-app-issues-track/08-p7-inline-assignment-contradiction.md`
