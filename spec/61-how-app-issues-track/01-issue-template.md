...
**Usage:** Copy this template when creating a new issue file at `spec/61-how-app-issues-track/{NN}-{issue-slug}.md`.
...
- [ ] Issue write-up created at `spec/61-how-app-issues-track/{NN}-{slug}.md`
