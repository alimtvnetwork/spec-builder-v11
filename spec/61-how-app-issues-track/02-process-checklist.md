...
- [ ] Create a new file at `spec/61-how-app-issues-track/{NN}-{issue-slug}.md`
...
- [ ] Update `.lovable/memories/workflow/03-mistake-remediation-protocol.md`
...
| Item | Location |
|------|----------|
| Issue files | `spec/61-how-app-issues-track/{NN}-{slug}.md` |
| Template | `spec/61-how-app-issues-track/01-issue-template.md` |
