...
### 1a — `spec/11-spec-management-software/`
...
### 1b — `spec/61-how-app-issues-track/`

| Before | After | Reason |
|--------|-------|--------|
| `07-snake-case-log-keys-...` | `14-snake-case-log-keys-...` | Duplicate `07-` prefix |

### 1c — `spec/02-coding-guidelines/01-cross-language/`
...
| Action | Detail |
|--------|--------|
| Archived | `spec/02-coding-guidelines/02-typescript/` → `spec/99-archive/17-enum-specification/` |
| Canonical location | `spec/02-coding-guidelines/03-golang/01-enum-specification/` |
| Reason | Content already migrated to `spec/02-coding-guidelines/03-golang/`; old folder was redundant |

### 2b — CLI 3-Folder Compliance (`spec/25-spec-reverse-cli/`)

| Action | Detail |
|--------|--------|
| Created | `spec/25-spec-reverse-cli/02-frontend/` |
| Created | `spec/25-spec-reverse-cli/03-deploy/` |
...
| Action | Detail |
|--------|--------|
| Updated | `spec/00-folder-structure-guideline.md` to **v5.0.0** |
| Added | Folder assignments for range **22–30** |
| Documented | `spec/99-archive/` as canonical archive location |
...
| Unprefixed files in `spec/02-coding-guidelines/01-cross-language/` | ✅ 0 remaining |
...
| Folder Guideline | `spec/00-folder-structure-guideline.md` (v5.0.0) |
| Consistency Report | `spec/11-spec-management-software/99-consistency-report.md` (v11.0.0) |
| Archived Enum Spec | `spec/99-archive/17-enum-specification/` |
| Issue Tracking | `spec/61-how-app-issues-track/` |
