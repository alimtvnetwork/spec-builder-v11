...
1. Updated `.lovable/memories/architecture/coding-standards/control-flow.md` — added explicit prohibition of nested `if` for error type discrimination
2. Updated `.lovable/memories/architecture/coding-standards/filesystem-access.md` — strengthened language and added the anti-pattern example
3. Updated `.lovable/memories/workflow/03-mistake-remediation-protocol.md` — added issue #13 to registry
...
- `.lovable/memories/architecture/coding-standards/control-flow.md`
- `.lovable/memories/architecture/coding-standards/filesystem-access.md`
- `.lovable/memories/workflow/03-mistake-remediation-protocol.md`
...
- [x] Remediate `os.IsNotExist` in spec/10-brun-cli, spec/13-wp-plugin, spec/14-wp-plugin-builder, spec/07-seedable-config-architecture — **zero remaining**
- [x] `spec/06-split-db-architecture/` — **zero remaining** (Wave 31)
- [x] `spec/24-nexus-flow-cli/` — **zero remaining** (Wave 31)
...
- [x] Issue write-up created at `spec/61-how-app-issues-track/13-raw-filesystem-nested-if-violations.md`
