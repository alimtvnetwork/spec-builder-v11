...
1. **Line 128:** `spec/28-shared-cli-frontend/15-hooks-library.md` — folder was renamed to `spec/28-shared-cli-frontend/` but plan.md was not updated.
2. **Line 153:** `spec/11-spec-management-software/05-features/SM-010-golang-backend-implementation.md` — referenced as if it existed, but the spec file was never created.
3. **Line 176:** `.lovable/memories/suggestions/01-suggestions-tracker.md` — previously referenced wrong directory (`memory` vs `memories`) and wrong filename; now corrected to canonical path.
...
- `plan.md` line 128: path updated from `spec/28-shared-cli-frontend/` to `spec/28-shared-cli-frontend/`
- `plan.md` line 153: added annotation `*(spec not yet created)*`
- `plan.md` line 176: path corrected to `.lovable/memories/suggestions/README.md`
...
- `spec/99-consistency-report.md` (v9.5.0 entry added)
...
- [x] Issue write-up created at `spec/61-how-app-issues-track/06-broken-plan-md-references.md`
