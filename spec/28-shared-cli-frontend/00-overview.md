...
|-----|----------|-------------|
| GSearch CLI | `spec/20-gsearch-cli/` | 7000-7099 |
| BRun CLI | `spec/21-brun-cli/` | 7100-7599 |
| AI Bridge CLI | `spec/22-ai-bridge-cli/` | 9000-9999 |
| Nexus Flow CLI | `spec/24-nexus-flow-cli/` | 8000-8399 |
...
|---------|----------|-------------|
| Split DB Architecture | [06-split-db-architecture/](../06-split-db-architecture/) | Hierarchical SQLite organization |
| Seedable Config Architecture | [07-seedable-config-architecture/](../07-seedable-config-architecture/) | Versioned configuration with changelog |
| PowerShell Integration | [50-powershell-integration/](../50-powershell-integration/) | Build and run scripts |
| Error Resolution | [04-error-resolution/](../04-error-resolution/) | Frontend-backend debugging and verification patterns |
| TypeScript Debugging | [04-error-resolution/03-debugging-guides/03-debugging-typescript.md](../04-error-resolution/03-debugging-guides/03-debugging-typescript.md) | React/TypeScript debugging patterns |
| DBOperation Wrapper | [11-spec-management-software/13-shared-packages/08-pkg-database-operations.md](../11-spec-management-software/13-shared-packages/08-pkg-database-operations.md) | Mandatory database operation wrapper (Go backends) |
...
| Reference | Location |
|-----------|----------|
| GSearch Implementation | `spec/20-gsearch-cli/02-frontend/02-frontend-architecture.md` |
| BRun Implementation | `spec/21-brun-cli/02-frontend/01-frontend-architecture.md` |
| AI Bridge CLI Implementation | `spec/22-ai-bridge-cli/02-frontend/01-architecture.md` |
| Nexus Flow CLI Implementation | `spec/24-nexus-flow-cli/02-frontend/02-frontend-architecture.md` |
| PowerShell Integration | `spec/50-powershell-integration/` |
| Error Management | `spec/11-spec-management-software/06-error-management/` |
