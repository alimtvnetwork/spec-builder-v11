...
Each CLI project includes a PowerShell runner script following the pattern defined in `spec/50-powershell-integration/`.
...
- `spec/50-powershell-integration/00-overview.md`
- `spec/50-powershell-integration/02-script-reference.md`
- `spec/50-powershell-integration/05-firewall-rules.md`
