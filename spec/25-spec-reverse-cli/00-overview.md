...
|----------------|----------|---------|
| General Spec Patterns | `spec/01-general-spec/` | Foundation standards |
| Error Resolution | `spec/04-error-resolution/` | Debugging & verification patterns |
| Split DB Architecture | `spec/06-split-db-architecture/` | Database pattern |
| Seedable Config | `spec/07-seedable-config-architecture/` | Config pattern |
| Shared CLI Frontend | `spec/28-shared-cli-frontend/` | React UI patterns |
| PowerShell Integration | `spec/50-powershell-integration/` | Build scripts |
| Error Code Registry | `spec/03-error-code-registry/` | Error standards |
| RAG Memory Patterns | `spec/11-spec-management-software/05-features/09-knowledge-memory/` | RAG system |
...
| Spec Management Software | `../11-spec-management-software/00-overview.md` |
