...
- [RAG System](../../11-spec-management-software/05-features/09-knowledge-memory/01-rag-system.md)
...
func (l *RAGLoader) loadCategory(category KnowledgeCategory) apperror.Result[[]RAGChunk] {
    paths := map[KnowledgeCategory]string{
        KnowledgeSplitDb:     "spec/06-split-db-architecture/00-overview.md",
        KnowledgeSeedable:    "spec/07-seedable-config-architecture/00-overview.md",
        KnowledgeErrorCodes:  "spec/03-error-code-registry/00-overview.md",
        KnowledgeGeneralSpec: "spec/01-general-spec/00-overview.md",
        KnowledgeCLIPatterns: "spec/28-shared-cli-frontend/00-overview.md",
    }
