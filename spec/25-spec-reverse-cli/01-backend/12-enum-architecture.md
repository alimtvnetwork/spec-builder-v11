...
func NewRegistry() *Registry {
    return &Registry{
        Enums: []EnumMeta{
            ...
            {Name: "spec", Values: spectype.Values()},
...
func (v Variant) SpecPath() string {
    switch v {
    case SplitDb:        return "spec/06-split-db-architecture/00-overview.md"
    case SeedableConfig: return "spec/07-seedable-config-architecture/00-overview.md"
    case ErrorCodes:     return "spec/03-error-code-registry/00-overview.md"
    case GeneralSpec:    return "spec/01-general-spec/00-overview.md"
    case CliPatterns:    return "spec/28-shared-cli-frontend/00-overview.md"
    default:             return ""
    }
}
```
...
*Spec Reverse CLI enum architecture v2.0.0 — 10 compliant enums following spec/02-coding-guidelines/03-golang/01-enum-specification/.*
