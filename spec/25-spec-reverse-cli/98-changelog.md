# Spec Reverse CLI — Changelog


**Version:** 1.0.0  
**Last Updated:** 2026-03-20  

All notable changes to the Spec Reverse CLI specification are documented here.
...
Project-wide major version increment (+1.0.0) applied to all specification files in `25-spec-reverse-cli`.
