...
| File | Description |
|------|-------------|
| `02-rag-chunk-settings.md` | RAG chunk size and overlap configuration |
| `03-rag-validation-helpers.md` | Go validation patterns for RAG config |
| `04-rag-validation-tests.md` | Unit test specifications for validators |
| `05-rag-test-coverage-matrix.md` | Test coverage matrix for RAG |
| **`06-validation-data-seeding.md`** | **Validation arrays loaded from CW Config → Root DB** |
...
| [Go Debugging Guide](../04-error-resolution/03-debugging-guides/02-debugging-go.md) | Initialization order, config loading |
| [Split DB Architecture](../06-split-db-architecture/00-overview.md) | Database organization patterns |
...
| Reference | Location |
|-----------|----------|
| Split DB Architecture | [06-split-db-architecture/00-overview.md](../06-split-db-architecture/00-overview.md) |
| Settings Service | [28-shared-cli-frontend/03-settings-service.md](../28-shared-cli-frontend/03-settings-service.md) |
| PowerShell Integration | [50-powershell-integration/00-overview.md](../50-powershell-integration/00-overview.md) |
