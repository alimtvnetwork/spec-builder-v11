...
- [AI Bridge](../22-ai-bridge-cli/00-overview.md) — LLM communication layer
- [BRun CLI](../21-brun-cli/00-overview.md) — Build and execution patterns
- [GSearch CLI](../20-gsearch-cli/00-overview.md) — Configuration patterns
- [Error Code Registry](../03-error-code-registry/01-registry.md) — Error code allocation (10xxx)
- [Error Resolution](../04-error-resolution/00-overview.md) — Debugging and verification patterns
- [PHP Debugging Guide](../04-error-resolution/03-debugging-guides/01-debugging-php.md) — WordPress/PHP debugging
- [DBOperation Wrapper](../11-spec-management-software/13-shared-packages/08-pkg-database-operations.md) — Mandatory database operation wrapper
- [ORM-Only Policy](../../.lovable/memories/workflow/implementation-strategy.md) — Raw SQL prohibition
- [Database Pre-flight Checklist](../../.lovable/memories/workflow/implementation-strategy.md) — Pre-development verification
...
- [AI Bridge](../22-ai-bridge-cli/00-overview.md) — LLM abstraction layer
- [Shared Error Package](../03-error-code-registry/01-registry.md) — Centralized error handling

---

## See Also

- [WordPress Plugin Spec](../30-wp-plugin/00-overview.md)
- [Coding Guidelines - PHP](../11-spec-management-software/12-prompts/01-coding-guideline/00-overview.md)
