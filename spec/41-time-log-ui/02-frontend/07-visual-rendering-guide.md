...
| Reference | Location |
|-----------|----------|
| Theme & Animation Spec | `spec/06-docs-viewer-ui/02-features/06-ui-theme-animations.md` |
| Syntax Highlighting Spec | `spec/06-docs-viewer-ui/02-features/02-syntax-highlighting.md` |
| Typography Spec | `spec/06-docs-viewer-ui/02-features/01-typography.md` |
