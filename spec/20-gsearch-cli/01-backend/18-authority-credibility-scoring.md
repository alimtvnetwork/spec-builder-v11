...
Define the authority scoring, source weighting, and credibility classification system for evaluating search results. All configuration values follow the [Seedable Configuration Pattern](../../11-spec-management-software/04-coding-guidelines/05-seedable-config-pattern.md).
...
- [Seedable Config Pattern](../../11-spec-management-software/04-coding-guidelines/05-seedable-config-pattern.md) - Configuration pattern
- [Agentic Search](../../11-spec-management-software/05-features/25-ai-enhancements/10-offline-first-storage.md) - Search pipeline integration
