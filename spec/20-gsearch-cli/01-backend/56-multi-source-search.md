...
| BI Suite | `spec/20-gsearch-cli/01-backend/50-business-intelligence-suite.md` |
| Error Registry | `.lovable/memories/technical/error-code-registry.md` |
| Parallel Engine | `spec/22-ai-bridge-cli/01-backend/50-long-chain-command-system.md` |
