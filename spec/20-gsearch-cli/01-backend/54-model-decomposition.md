...
| Document | Path |
|----------|------|
| Database Architecture | `spec/20-gsearch-cli/01-backend/03-database-schema.md` |
| Contact Extraction | `spec/20-gsearch-cli/01-backend/45-contact-extraction.md` |
| Business Intelligence Suite | `spec/20-gsearch-cli/01-backend/43-business-intelligence-suite.md` |
| PascalCase Standard | `.lovable/memories/style/naming-convention.md` |
