...
**Reference:** `spec/28-shared-cli-frontend/08-common-components.md`
...
**Reference:** `spec/28-shared-cli-frontend/03-settings-service.md`
...
**Reference:** `spec/28-shared-cli-frontend/06-changelog-system.md`
...
**Reference:** `spec/28-shared-cli-frontend/07-port-management.md`
...
| GSearch Frontend Architecture | `spec/20-gsearch-cli/02-frontend/02-frontend-architecture.md` |
| BRun Frontend Architecture | `spec/21-brun-cli/02-frontend/01-frontend-architecture.md` |
| AI Bridge Frontend Architecture | `spec/22-ai-bridge-cli/02-frontend/01-architecture.md` |
| Nexus Flow Frontend Architecture | `spec/24-nexus-flow-cli/02-frontend/02-frontend-architecture.md` |
...
| **UI Patterns** | `spec/20-gsearch-cli/02-frontend/05-ui-patterns.md` — Modal scroll, spinner, password, localStorage |
| **Shared Hooks** | `spec/28-shared-cli-frontend/15-hooks-library.md` — `useLocalStorageForm` |
