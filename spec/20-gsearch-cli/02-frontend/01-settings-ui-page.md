...
- [SettingsService Implementation](../01-backend/21-settings-service.md)
- [Seedable Config Pattern](../../11-spec-management-software/04-coding-guidelines/05-seedable-config-pattern.md)
- [Trend Analysis Engine](../01-backend/19-trend-analysis-engine.md)
- [Authority & Credibility Scoring](../01-backend/18-authority-credibility-scoring.md)
