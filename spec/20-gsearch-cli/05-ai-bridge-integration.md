...
| Reference | Location |
|-----------|----------|
| AI Bridge Agentic Mode | `spec/22-ai-bridge-cli/01-backend/09-agentic-mode.md` |
| gSearch CLI Overview | `spec/20-gsearch-cli/00-overview.md` |
| Tool Delegation Config | `spec/22-ai-bridge-cli/01-backend/09-agentic-mode.md` |
