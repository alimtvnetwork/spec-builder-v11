...
- [Error Resolution](../04-error-resolution/00-overview.md) — Debugging & verification patterns
- [AI Bridge CLI](../22-ai-bridge-cli/00-overview.md) — Parent service for LLM routing
- [Error Code Registry](../03-error-code-registry/00-overview.md) — Central error code allocation
- [Shared CLI Frontend](../28-shared-cli-frontend/00-overview.md) — Common UI components
- **[DBOperation Wrapper](../11-spec-management-software/13-shared-packages/08-pkg-database-operations.md)** — Mandatory DB operation wrapper
- **[ORM-Only Policy](../../.lovable/memories/workflow/implementation-strategy.md)** — No raw SQL mandate
