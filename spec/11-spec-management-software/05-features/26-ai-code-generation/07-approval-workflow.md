...
type ApprovalRequest struct {
    ...
    DryRunResult    *DryRunResult    `json:",omitempty"`
    CreatedAt       time.Time
...
type DryRunResult struct {
    ...
    CompilationOk   bool
    CompileErrors   []string `json:",omitempty"`
}

type AffectedFile struct {
    Path      string
    Operation string
    SizeBefore int64 `json:",omitempty"`
    SizeAfter  int64 `json:",omitempty"`
}
...
func (aw *ApprovalWorkflow) RunDryRun(requestId string) apperror.Result[DryRunResult] {
    ...
    tempDir, err := pathutil.MkdirTemp("", "codegen-dryrun-*")
    if err != nil {
        return nil, err
    }
    ...
    if err := pathutil.WriteFile(mainPath, []byte(request.GolangCode), 0644); err != nil {
        return nil, err
    }
...
type ApprovalDecision struct {
    ...
    EditedCode string `json:",omitempty"`
}
