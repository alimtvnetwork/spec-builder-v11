...
- [Cross-Project Memory](./60-cross-project-memory.md)
...
| Spec | Description |
|------|-------------|
| [51-chat-layout.md](./51-chat-layout.md) | Responsive layout, panels, keyboard navigation |
| [52-chat-input.md](./52-chat-input.md) | Plus menu, input component, voice input, draft persistence |
| [53-message-display.md](./53-message-display.md) | Message bubbles, streaming, code blocks, execution status |
| [54-mode-selector.md](./54-mode-selector.md) | Mode switching, mode-specific UI and behavior |
