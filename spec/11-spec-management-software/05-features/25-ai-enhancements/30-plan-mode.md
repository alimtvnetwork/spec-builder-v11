...
| File | Description |
|------|-------------|
| [31-plan-generation.md](./31-plan-generation.md) | AI plan generation service and prompts |
| [32-plan-execution.md](./32-plan-execution.md) | Step execution engine and state machine |
| [33-approval-workflow.md](./33-approval-workflow.md) | User approval UI and modification flow |
| [34-mermaid-integration.md](./34-mermaid-integration.md) | Mermaid diagram generation and rendering |

**Cross-References:**
- [AI Integration](../06-ai-integration/00-overview.md)
- [AI Chat UI](../06-ai-integration/08-ai-chat-ui.md)
- [Mermaid Diagrams](./40-mermaid-diagrams.md)
...
export interface PlanStep {
  ...
  inputs?: AnalyzeStepInputs | GenerateStepInputs | ExecuteStepInputs;
...
/** Typed inputs for analyze steps */
export interface AnalyzeStepInputs {
  files: string[];
}

/** Typed inputs for generate steps */
export interface GenerateStepInputs {
  targetPath: string;
  template?: string;
}

/** Typed inputs for execute steps */
export interface ExecuteStepInputs {
  command: string;
  args?: string[];
  workDir?: string;
}

/** Typed output data from step execution */
...
CREATE INDEX IdxPlansProject ON execution_plans(project_id);
CREATE INDEX IdxPlansStatus ON execution_plans(status);
CREATE INDEX IdxStepHistoryPlan ON plan_step_history(plan_id);
```
...
- [Mermaid Diagrams](./40-mermaid-diagrams.md)
- [AI Chat UI](../06-ai-integration/08-ai-chat-ui.md)
- [Offline Storage](./10-offline-first-storage.md)
