...
`code`, `generation`, `system`, `management`, `software`, `features`
...
- [Model Categories](../06-ai-integration/02-presets-guidelines.md)
...
> ⚠️ **REASSIGNED:** Previously used the 12xxx range, which collided with WSP (WP SEO Publish CLI, 12000-12599). Moved to 16xxx per collision resolution (2026-02-28).

The Code Generation System uses the **SM-CG 16xxx** error code range:

| Range | Category |
|-------|----------|
| 16000-16099 | General Code Generation |
| 16100-16199 | Guideline Resolution |
| 16200-16299 | Plan Generation |
| 16300-16399 | Parallel Execution |
| 16400-16499 | Git Operations |
| 16500-16599 | Build Verification |
| 16600-16699 | Credit System |
| 16700-16799 | WebSocket |
| 16800-16805 | Suggestions System |
...
- [Build Runner CLI](../23-build-runner-cli/00-overview.md)
- [AI Model Categories](../06-ai-integration/02-presets-guidelines.md)
- [Instruction System](../06-ai-integration/03-instruction-system.md)
