...
**This file location:** `spec/11-spec-management-software/05-features/24-code-generation-system/12-spec-folder-guideline.md`
...
├────────────────────────────────────────────────────────────────┤
│                                                                 │
│  START: spec/11-spec-management-software/95-master-index.md       │
│                                                                 │
│  FEATURES: spec/11-spec-management-software/05-features/          │
│    └── {NN}-{feature}/00-overview.md                           │
│                                                                 │
│  ERRORS: spec/11-spec-management-software/06-error-management/    │
│    └── 02-error-code-registry.md                               │
│                                                                 │
│  DATABASE: spec/11-spec-management-software/07-database-design/   │
