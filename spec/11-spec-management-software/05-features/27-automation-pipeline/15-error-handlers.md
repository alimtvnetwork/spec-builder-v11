...
CREATE INDEX IdxErrorExecution ON PipelineError(ExecutionId);
CREATE INDEX IdxErrorCategory ON PipelineError(Category);
CREATE INDEX IdxCircuitHandler ON CircuitBreakerState(HandlerId);
```
