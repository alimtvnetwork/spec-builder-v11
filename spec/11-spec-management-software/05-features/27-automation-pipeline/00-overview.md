...
`automation`, `features`, `management`, `pipeline`, `software`
...
- [System Architecture Diagram](./98-architecture-diagram.md) — Complete visual architecture with Mermaid diagrams
