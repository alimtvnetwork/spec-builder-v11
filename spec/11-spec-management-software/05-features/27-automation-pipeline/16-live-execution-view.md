...
CREATE INDEX IdxEventExecution ON ExecutionEvent(ExecutionId);
CREATE INDEX IdxEventTimestamp ON ExecutionEvent(Timestamp);
CREATE INDEX IdxSnapshotExecution ON ExecutionSnapshot(ExecutionId);
CREATE INDEX IdxLogExecution ON ExecutionLog(ExecutionId);
CREATE INDEX IdxLogLevel ON ExecutionLog(Level);
```
