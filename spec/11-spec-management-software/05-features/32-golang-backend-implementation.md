...
| 1.6 | Registry overlap validator | `spec/03-error-code-registry/08-overlap-validator.md` |
...
| SM-RV | Registry overlap validator (`spec/03-error-code-registry/08-overlap-validator.md`) — error codes 2850-2859 |
