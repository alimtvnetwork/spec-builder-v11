...
* `.lovable/memories/style/visual-dashboard-design.md` (general dashboard chrome)
...
| Dashboard visual style | `.lovable/memories/style/visual-dashboard-design.md` |
| Frontend UI patterns | `spec/20-gsearch-cli/02-frontend/05-ui-patterns.md` |
