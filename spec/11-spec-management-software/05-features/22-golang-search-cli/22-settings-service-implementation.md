...
> union struct pattern (see `spec/21-brun-cli/01-backend/17-settings-service.md` and
> `spec/28-shared-cli-frontend/03-settings-service.md`) supersedes this approach for new implementations.
