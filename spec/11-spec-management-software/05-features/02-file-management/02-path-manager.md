...
func TestPathManager_Resolve(t *testing.T) {
    ...
    result := pm.Resolve("spec/project/file.md")
    assert.False(t, result.HasError())
    assert.Equal(t, "/home/user/specs/spec/project/file.md", result.Value())
}
...
func TestPathManager_ToRelative(t *testing.T) {
    ...
    relResult := pm.ToRelative("/home/user/specs/spec/project/file.md")
    assert.False(t, relResult.HasError())
    assert.Equal(t, "spec/project/file.md", relResult.Value())
