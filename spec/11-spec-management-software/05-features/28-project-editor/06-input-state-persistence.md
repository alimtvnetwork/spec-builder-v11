...
- [data-resilience memory](../../../../.lovable/memories/constraints/validation-data-pattern.md) — Zero data loss principle
- [chat-ui memory](../../../../.lovable/memories/ui/ai-chat-interface.md) — Chat input persistence
