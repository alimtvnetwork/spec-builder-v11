...
All configuration keys use dot.notation format (see [Seeding Configuration](../../../07-seedable-config-architecture/00-overview.md)):
...
6. **Error Management** (`../../../01-general-spec/02-systems/01-logging-system-systems.md`): Follows dual-file strategy
