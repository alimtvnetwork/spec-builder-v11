...
- [Voice-CLI Service](../../14-microservices/10-voice-cli.md) — Backend integration
    ...
    return new Promise((resolve, reject) => {
      ...
      ws.onerror = (event) => {
        ...
        const wsError: VoiceError = {
          code: 11060,
          constant: 'ErrWsConnectionFailed',
...
- [Voice-CLI Service](../../14-microservices/10-voice-cli.md)
