...
- **Voice-CLI Service**: [/memories/architecture/microservices/voice-cli-service](../../../../.lovable/memories/features/ai-transcribe-backend.md)
- **Split Database System**: [/memories/architecture/split-database-system](../../../../.lovable/memories/architecture/01-split-db-architecture.md)
- **Resilient Execution**: [/memories/features/resilient-execution-system](../../../../.lovable/memories/features/resilient-execution-system.md)
