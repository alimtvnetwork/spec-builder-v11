...
- [Backend Error Codes](../06-error-management/02-backend/01-error-codes.md)
...
func Wrap(h HandlerFunc) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        if err := h(w, r); err != nil {
            // EXEMPTED: apperror package internal — error type extraction (§7.2)
            var appErr *AppError
...
// Check specific code — EXEMPTED: apperror package internal (§7.2)
