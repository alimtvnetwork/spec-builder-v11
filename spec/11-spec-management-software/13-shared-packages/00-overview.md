...
`management`, `packages`, `shared`, `software`
...
| `pkg/database` (Operations) | [08-pkg-database-operations.md](./08-pkg-database-operations.md) | P0 | `pkg/logging` |
...
- [pkg/database Operations Wrapper](./08-pkg-database-operations.md) ⭐ **NEW**
