...
**Cross-References:**
- [Vector Search Service](../05-features/09-knowledge-memory/05-vector-search-service.md) - Phase 1: sqlite-vss integration
- [Context Window Manager](../05-features/09-knowledge-memory/06-context-window-manager.md) - Phase 2: Token budgeting
- [Instruction Segmentation](../05-features/06-ai-integration/05-instruction-segmentation.md) - Phase 3: Multi-turn execution
- [Memory Compression](../05-features/09-knowledge-memory/07-memory-compression.md) - Phase 4: Summarization
- [Vector Database Plan](../05-features/09-knowledge-memory/04-vector-database-plan.md) - Overall enhancement strategy
- [Testing Standards](../../01-general-spec/03-quality/01-testing-standards-quality.md) - Testing patterns
...
- [Vector Search Service](../05-features/09-knowledge-memory/05-vector-search-service.md) - Component under test
