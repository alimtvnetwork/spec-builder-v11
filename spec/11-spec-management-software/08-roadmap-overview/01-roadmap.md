...
**Output:** `spec/30-wp-plugin/03-exam-manager/ideas/02-spec-management-software.md`
...
**Deliverables:**
- [x] Create `spec/11-spec-management-software/` folder
...
- All specs follow [General Spec Standards](../../01-general-spec/00-overview.md)
