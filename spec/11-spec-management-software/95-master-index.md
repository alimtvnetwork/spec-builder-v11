...
|------|----------|-------|-------------|
| GSearch CLI | `spec/20-gsearch-cli/` | 27 | 7000-7999 |
| AI Bridge | `spec/22-ai-bridge-cli/` | 8 | 9000-9999 |
| Nexus Flow | `spec/24-nexus-flow-cli/` | 7 | 8000-8399 |
| BRun CLI | `spec/21-brun-cli/` | 18 | 7100-7599 |
