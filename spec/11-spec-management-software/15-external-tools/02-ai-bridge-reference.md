...
> **External Spec:** `spec/22-ai-bridge-cli/`  
> **Version:** 3.0.0  
...
📁 **Location:** [`spec/22-ai-bridge-cli/`](../../22-ai-bridge-cli/00-overview.md)
...
See: [`spec/22-ai-bridge-cli/01-backend/05-error-codes.md`](../../22-ai-bridge-cli/01-backend/05-error-codes.md)
