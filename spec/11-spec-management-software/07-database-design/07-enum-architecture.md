...
| Core Entities | `spec/11-spec-management-software/19-data-models/01-core-entities.md` |
| AI Types | `spec/11-spec-management-software/19-data-models/02-ai-types.md` |
