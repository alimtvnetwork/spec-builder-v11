...
// See: model_provider.Variant in 07-database-design/05-enum-architecture.md
type ModelProvider = 'ollama' | 'llama.cpp' | 'openai' | 'anthropic';

// See: model_category.Variant in 07-database-design/05-enum-architecture.md
type ModelCategory = 'thinking' | 'writing' | 'voice' | 'coding' | 'embedding';

// See: model_capability.Variant in 07-database-design/05-enum-architecture.md
...
// See: finish_reason.Variant in 07-database-design/05-enum-architecture.md
...
// See: ai_error_type.Variant in 07-database-design/05-enum-architecture.md
...
// See: output_format.Variant in 07-database-design/05-enum-architecture.md
