...
|-----------|-----------------|-------------|
| **Full Project** | `spec/11-spec-management-software/` | Complete spec set (375+ files) |
| **gsearch CLI** | `spec/11-spec-management-software/05-features/22-golang-search-cli/` | Multi-engine search CLI (26 files) |
| **brun CLI** | `spec/11-spec-management-software/05-features/23-build-runner-cli/` | Build runner CLI (18 files) |
...
```
spec/11-spec-management-software/05-features/22-golang-search-cli/
...
```
spec/11-spec-management-software/05-features/23-build-runner-cli/
├── 00-overview.md               # Start here
...
```
Required Context:
├── spec/11-spec-management-software/
