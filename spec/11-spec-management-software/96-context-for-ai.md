...
**File:** `spec/11-spec-management-software/95-master-index.md`
...
### 2. Project Overview
**File:** `spec/11-spec-management-software/00-overview.md`

Short overview of the project philosophy and folder layout.

### 3. Features Overview (Formerly Split-Spec)
**File:** `spec/11-spec-management-software/05-features/00-overview.md`
...
**Folder:** `spec/11-spec-management-software/05-features/24-code-generation-system/`
