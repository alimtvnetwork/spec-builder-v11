...
| Rule | How It Helps |
|------|-------------|
| [Rule 2: Zero Nested `if`](./04-code-style.md) | Enforces the same principle at the syntax level |
| [Rule 6: 15-Line Function Limit](./04-code-style.md) | Guards keep functions short — if too many guards, extract a `validate()` helper |
| [Boolean Principles](./02-boolean-principles.md) | Guards use `is`/`has` named booleans for clarity |
...
- [Code Style — Rules 2, 6, 7](./04-code-style.md) — Zero nesting, 15-line limit
- [Boolean Principles](./02-boolean-principles.md) — Named boolean variables
