...
- [Code Style — Rule 6: 15-Line Limit](./04-code-style.md) — Test functions have a relaxed 20-line limit
...
- [Boolean Principles](./02-boolean-principles.md) — Table case fields use `is`/`has` prefixes for boolean columns
- [Master Coding Guidelines — §13](./15-master-coding-guidelines.md) — Summary table in the master reference
