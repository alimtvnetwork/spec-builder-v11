...
- [Response Envelope Spec](../../04-error-resolution/09-response-envelope/04-response-envelope-reference.md)
- [Envelope JSON Schema](../../04-error-resolution/09-response-envelope/envelope.schema.json)
- [ADR #7: JSON Schema Strategy](../../04-error-resolution/09-response-envelope/01-adr.md)
- [CHANGELOG](../../04-error-resolution/09-response-envelope/00-overview.md)
