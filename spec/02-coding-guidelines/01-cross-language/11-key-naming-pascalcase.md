...
See [Master Coding Guidelines §1.2](./15-master-coding-guidelines.md#12--abbreviation-standard-all-languages) for the full abbreviation table.

## 8. Cross-References

- [Master Coding Guidelines §1.1](./15-master-coding-guidelines.md) — JSON / API keys row
- [Go Backend Prompt](../../11-spec-management-software/12-prompts/01-coding-guideline/01-backend-go.md) — PascalCase mandate
- [Coding Standards Foundation §10](../../01-general-spec/01-foundation/01-coding-standards-foundation.md) — Log key constants
