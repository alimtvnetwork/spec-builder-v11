...
|-------|---------------|---------------|----------|
| P7 inline assignment | "All inline `if` assignments banned" | "`if err := fn(); err != nil` is correct Go" | [Issue #08](../../61-how-app-issues-track/08-p7-inline-assignment-contradiction.md) |
...
|-------------|-----------------|
| Naming (all languages) | `spec/02-coding-guidelines/01-cross-language/15-master-coding-guidelines.md` |
| Key naming (PascalCase) | `spec/02-coding-guidelines/01-cross-language/11-key-naming-pascalcase.md` |
| Boolean logic | `spec/02-coding-guidelines/03-golang/02-boolean-standards.md` + `spec/02-coding-guidelines/01-cross-language/02-boolean-principles.md` |
| Strict typing | `spec/02-coding-guidelines/01-cross-language/13-strict-typing.md` |
| Error handling | `spec/04-error-resolution/10-apperror-package/01-apperror-reference.md` |
| Code style | `spec/02-coding-guidelines/01-cross-language/04-code-style.md` |
...
|---------------|--------|
| **True contradiction** — rule A says X, rule B says Y | Fix the non-canonical file. Create issue in `spec/61-how-app-issues-track/` |
...
1. Create issue write-up at `spec/61-how-app-issues-track/{NN}-{slug}.md`
...
- [ ] **Update all prompts** — `spec/11-spec-management-software/12-prompts/` must reflect the new rule
...
- [Global Consistency Report](../../99-consistency-report.md)
- [Mistake Remediation Protocol](../../../.lovable/memories/workflow/03-mistake-remediation-protocol.md)
- [Issue Template](../../61-how-app-issues-track/01-issue-template.md)
