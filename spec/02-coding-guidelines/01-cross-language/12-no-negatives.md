...
- [PHP Boolean Logic](../04-php/07-php-standards-reference.md#boolean-logic) — PHP-specific helpers
- [PHP Forbidden Patterns](../04-php/02-forbidden-patterns.md) — Pattern 4.x
- [Cross-Language Code Style](./04-code-style.md) — Braces, nesting, spacing
...
*No-negatives specification v2.2.0 — 2026-02-25*
