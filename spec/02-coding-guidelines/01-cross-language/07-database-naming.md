...
- [Cross-Language Code Style](./04-code-style.md) — Formatting rules
- [PHP Naming Conventions](../04-php/00-overview.md) — PHP-specific naming
- [Go Coding Standards](../03-golang/04-golang-standards-reference.md) — Go-specific naming
- [Master Coding Guidelines](./15-master-coding-guidelines.md) — Consolidated cross-language reference
