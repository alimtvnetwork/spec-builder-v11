...
> **Cross-language parity:** [Go Standards §IsDefined](../03-golang/04-golang-standards-reference.md)
...
> **Canonical source:** [Cross-Language Code Style](../01-cross-language/04-code-style.md) — this section repeats key rules with PHP-specific examples.
...
- [WordPress Plugin Development Spec](../../33-wp-plugin-development/) — Full 10-document guide *(Phase 4 target)*
- [Error Handling Spec](../../04-error-resolution/06-error-handling/) — Cross-language error strategy
- [Generic Enforce Spec](../../08-generic-enforce/) — Type safety rules *(Phase 5/6 target)*
- [DRY Principles](../01-cross-language/08-dry-principles.md) — Cross-language DRY rules
- [Cross-Language Code Style](../01-cross-language/04-code-style.md) — Braces, nesting & spacing rules (canonical)
