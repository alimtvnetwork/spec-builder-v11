...
**Reference:** [response-key-type-inventory.md](./05-response-array-standard.md)
...
- [Enum Consumer Checklist](../../11-spec-management-software/18-enum-consumer-checklist.md)
