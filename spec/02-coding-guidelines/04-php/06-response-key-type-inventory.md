...
> **Go Mirror**: `backend/internal/enums/responsekeytype/variant.go`  
...
| Go | `backend/internal/enums/responsekeytype/variant.go` | Mirrors all PHP cases, camelCase labels |
