...
- [PHP Coding Standards](./07-php-standards-reference.md) — Parent spec with forbidden patterns
- [Naming Conventions](./03-naming-conventions.md) — PascalCase for enums, camelCase for methods
- [Golang Standards](../03-golang/04-golang-standards-reference.md) — Go equivalent patterns
