...
> **Version:** 4.0.0  
> **Updated:** 2026-03-09  
> **Consolidates:** [readme.md](./07-php-standards-reference.md), [enums.md](./01-enums.md), [WP Error Handling](../../33-wp-plugin-development/07-error-handling.md)
...
- [PHP Coding Standards](./07-php-standards-reference.md) — Full spec with examples
- [PHP Enum Classes](./01-enums.md) — `HookType`, `CapabilityType`, `HttpMethodType`, Path enums, `ErrorType`, `ErrorChecker`
- [Cross-Language Code Style](../01-cross-language/04-code-style.md) — Rules 1-9 (braces, nesting, spacing, function size, Throwable, multi-line params)
- [WordPress Error Handling](../../33-wp-plugin-development/07-error-handling.md) — Complete error handling patterns
- [WordPress Initialization](../../33-wp-plugin-development/01-initialization-patterns.md) — Bootstrap patterns
- [WordPress API Design](../../33-wp-plugin-development/04-api-design.md) — REST endpoint patterns
