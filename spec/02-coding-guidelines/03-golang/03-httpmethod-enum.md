...
- Enum architecture: `spec/21-brun-cli/01-backend/19-enum-architecture.md` §7
- Audit report: `spec/61-how-app-issues-track/07-magic-string-tuple-return-audit.md`
