...
This standard mirrors the PHP Boolean Guard System (P1–P6) with Go-specific exemptions for idiomatic patterns (comma-ok, handler guards, error-nil checks) and Go-specific additions (P7–P9). See `spec/02-coding-guidelines/04-php/naming-conventions.md` for the PHP counterpart.
