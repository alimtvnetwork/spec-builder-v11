...
> **Tracks**: Issue #10 (`spec/61-how-app-issues-track/10-domain-status-magic-strings.md`)
...
| `28-shared-cli-frontend/15-hooks-library.md` | `Status === 'running'/'error'` |
| `20-gsearch-cli/02-frontend/05-ui-patterns.md` | Execution status checks |
...
- [Issue #10 — Domain Status Magic Strings](../../61-how-app-issues-track/10-domain-status-magic-strings.md)
...
- [Master Coding Guidelines §8](../01-cross-language/15-master-coding-guidelines.md) — Magic strings zero tolerance
