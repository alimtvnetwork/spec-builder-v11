#!/usr/bin/env python3
"""
check-memory-mirror-drift.py — Detect drift between .ai-memory/memory/readme.md Core
...
MEMORY = Path(".ai-memory/memory/readme.md")
...
def main() -> int:
    ...
    if missing:
        ...
        print("        to mirror the latest .ai-memory/memory/readme.md Core rules.", file=sys.stderr)
        return 1
