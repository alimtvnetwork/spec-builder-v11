...
- **Issue documentation** in `02-spec/61-how-app-issues-track/`
...
- **apperror package docs** (`02-spec/04-error-resolution/10-apperror-package/`) — framework API documentation
- **Archive files** (`02-spec/99-archive/`) — deprecated reference material
...
- **Rule-prose** in `02-spec/02-coding-guidelines/01-cross-language/`, `02-spec/02-coding-guidelines/03-golang/`
- **Issue documentation** in `02-spec/61-how-app-issues-track/`

### Category 6 — Boolean Negation (53 matches)
- **Rule-prose & anti-pattern examples** in `02-spec/02-coding-guidelines/01-cross-language/`, `02-spec/02-coding-guidelines/03-golang/`
- **Issue documentation** in `02-spec/61-how-app-issues-track/`
- **Enforcement rules** in `02-spec/08-generic-enforce/`
...
- **Prompt templates** (`02-spec/11-spec-management-software/12-prompts/`) — showing code patterns for LLM consumption
