...
|----------|------:|--------|
| Other (deep structural) | 466 | Internal feature cross-refs to moved/renamed files within `02-spec/11-spec-management-software/` |
...
Most remaining links (466 "other") are references to files that were reorganized within `02-spec/11-spec-management-software/05-features/` during earlier restructuring campaigns and would require per-file investigation.
