...
| # | File |
|---|------|
| 1 | `02-spec/11-spec-management-software/01-ideas/README.md` |
| 2 | `02-spec/11-spec-management-software/02-instructions/README.md` |
| 3 | `02-spec/11-spec-management-software/05-features/22-golang-search-cli/25-configs/README.md` |
| 4 | `02-spec/25-gsearch-cli/06-configs/README.md` |
| 5 | `02-spec/34-wp-plugin/03-exam-manager/04-ideas/README.md` |
...
| # | File |
|---|------|
| 1 | `02-spec/04-error-resolution/06-error-handling/readme.md` |
| 2 | `02-spec/04-error-resolution/07-error-modal/readme.md` |
| 3 | `02-spec/04-error-resolution/09-response-envelope/readme.md` |
| 4 | `02-spec/04-error-resolution/10-apperror-package/readme.md` |
| 5 | `02-spec/11-spec-management-software/01-ideas/README.md` |
| 6 | `02-spec/11-spec-management-software/02-instructions/README.md` |
| 7 | `02-spec/11-spec-management-software/05-features/22-golang-search-cli/25-configs/README.md` |
| 8 | `02-spec/25-gsearch-cli/06-configs/README.md` |
| 9 | `02-spec/34-wp-plugin/03-exam-manager/04-ideas/README.md` |
| 10 | `02-spec/02-coding-guidelines/02-typescript/readme.md` |
| 11 | `02-spec/02-coding-guidelines/03-golang/readme.md` |
| 12 | `02-spec/02-coding-guidelines/04-php/readme.md` |
...
3. **Create root `02-spec/00-overview.md`** — master index for the specification tree
