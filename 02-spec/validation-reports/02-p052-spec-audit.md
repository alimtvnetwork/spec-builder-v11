...
| Root `02-spec/00-overview.md` master index | Present ✅ |
...
|--------|-----------|------------|
| `02-spec/02-coding-guidelines/02-typescript/` | Two files with prefix `06-` | `06-typescript-standards-reference.md` → `08-typescript-standards-reference.md` |
| `02-spec/02-coding-guidelines/04-php/` | Two files with prefix `06-` | `06-php-standards-reference.md` → `07-php-standards-reference.md` |
