...
**Pipeline responsibility**: Produce version-pinned install scripts and publish them as release assets (see [07-install-script-generation.md](./07-install-script-generation.md)).
...
> Full specification: [14-update/03-deploy-path-resolution.md](../14-update/03-deploy-path-resolution.md)
...
> Full specification: [14-update/04-rename-first-deploy.md](../14-update/04-rename-first-deploy.md)
...
> Full specification: [14-update/06-handoff-mechanism.md](../14-update/06-handoff-mechanism.md)
...
> Full specification: [14-update/05-build-scripts.md](../14-update/05-build-scripts.md)
...
> Full specification: [14-update/07-cleanup.md](../14-update/07-cleanup.md)
...
- **Full Client-Side Specs:**
  ...
  - [Deploy Path Resolution](../14-update/03-deploy-path-resolution.md) — 3-tier deploy target resolution
  - [Rename-First Deploy](../14-update/04-rename-first-deploy.md) — Rename-first with retry and rollback
  - [Build Scripts](../14-update/05-build-scripts.md) — Cross-platform build scripts
  - [Handoff Mechanism](../14-update/06-handoff-mechanism.md) — Windows self-replacement flow
  - [Cleanup](../14-update/07-cleanup.md) — Post-update artifact removal
