...
`powershell` · `build-runner` · `pnpm` · `cross-project` · `ci-cd` · `go-backend` · `react-frontend` · `firewall`
...
02-spec/51-upload-scripts/           ← Related: WordPress plugin upload scripts
├── 00-overview.md               ← Upload pipeline overview
...
| **[Upload Scripts Spec](../51-upload-scripts/00-overview.md)** | WordPress plugin upload scripts (V1, V2, V3) |
| [Upload V1](../51-upload-scripts/01-upload-plugin-v1.md) | Single-file upload via Invoke-RestMethod |
| [Upload V2](../51-upload-scripts/02-upload-plugin-v2.md) | Envelope-aware upload with unwrapping |
| [Upload V3](../51-upload-scripts/03-upload-plugin-v3.md) | Parallel multi-plugin deployment via Start-Job |
| [Upload Custom](../51-upload-scripts/04-upload-plugin-custom.md) | Custom path deployments via `run.ps1 -u -pp` |
| [Upload Config](../51-upload-scripts/05-configuration.md) | Authentication, headers, and fallback config |
