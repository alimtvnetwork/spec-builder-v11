...
| 03 | `03-issues/readme.md` | Issues tracker |
...
|-----------|-------------|
| [Seedable Config](../06-seedable-config-architecture/readme.md) | Configuration seeding patterns |
