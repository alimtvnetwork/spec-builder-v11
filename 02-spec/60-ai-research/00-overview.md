...
| AI Bridge Specs | `02-spec/27-ai-bridge-cli/` |
| GSearch Specs | `02-spec/25-gsearch-cli/` |
| RAG Pipeline | `02-spec/27-ai-bridge-cli/01-backend/47-onboarding-guide.md` |
| Memory Standard | `.ai-memory/memories/features/ai-bridge/memory-classification.md` |
| Memory Classification | `02-spec/27-ai-bridge-cli/01-backend/41-memory-classification-flags.md` |
