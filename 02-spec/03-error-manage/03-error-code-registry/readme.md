...
|---|--------|-------------|-------|
| 07 | [07-schemas/](./07-schemas/readme.md) | JSON schemas for validation | 2 |
| 08 | [08-linter-scripts/](./08-linter-scripts/readme.md) | Automation scripts | 4 |
| 09 | [09-templates/](./09-templates/readme.md) | Templates for project error docs | 1 |
...
- [Error Resolution](../01-error-resolution/readme.md) — Debugging and verification
- [Error Architecture](../02-error-architecture/readme.md) — Cross-stack error handling
