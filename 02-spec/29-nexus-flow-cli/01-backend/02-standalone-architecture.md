...
**Cross-References:**
- [Nexus-Flow Service](../../21-app/spec-management-software/14-microservices/06-nexus-flow.md) — Core service specification
- [React Flow Canvas](../../21-app/spec-management-software/14-microservices/07-react-flow-canvas.md) — Visual editor components
- [Shared pkg/ Modules](../../21-app/spec-management-software/14-microservices/08-shared-pkg-modules.md) — Common utilities
- [Split Database System](../../21-app/spec-management-software/14-microservices/../07-database-design/00-overview.md)
...
// FileOperation uses fileoperationtype.Variant from internal/enums/fileoperationtype/
// See: 10-enum-architecture.md §7 for full definition
//
// Usage: fileoperationtype.Read, fileoperationtype.Write, fileoperationtype.Copy, etc.
// Methods: .String(), .IsDestructive(), .IsReadOnly()
import "nexus-flow/internal/enums/fileoperationtype"

type FileOpConfig struct {
    Operation   fileoperationtype.Variant
    Source      PathSpec
    Destination PathSpec      `json:",omitempty"`
    Options     FileOpOptions
}

// PathType uses pathtype.Variant from internal/enums/pathtype/
// See: 10-enum-architecture.md §8
import "nexus-flow/internal/enums/pathtype"

type PathSpec struct {
    Path     string
    PathType pathtype.Variant
...
type FileOpOptions struct {
    ...
    Format        fileformattype.Variant          // See: 10-enum-architecture.md §9
}

// FileFormat uses fileformattype.Variant from internal/enums/fileformattype/
// Usage: fileformattype.Json, fileformattype.Yaml, fileformattype.Text, etc.
// Methods: .String(), .IsStructured()
import "nexus-flow/internal/enums/fileformattype"
```
...
// FlowRefType uses flowreftype.Variant from internal/enums/flowreftype/
// See: 10-enum-architecture.md §10
import "nexus-flow/internal/enums/flowreftype"
...
type FlowRef struct {
    Type         flow_ref_type.Variant
    FlowId       string `json:",omitempty"`
    DatabasePath string `json:",omitempty"`
...
// VariableType and VariableScope use enum types from 10-enum-architecture.md
// See: variable_type.Variant (§11) and variable_scope.Variant (§12)
type VariableType = string  // Maps to variable_type.Variant values
type VariableScope = string // Maps to variable_scope.Variant values
```
...
// RuntimeType uses runtimetype.Variant from internal/enums/runtimetype/
// See: 10-enum-architecture.md §13
// Methods: .FileExtension(), .DefaultExecutable()
import "nexus-flow/internal/enums/runtimetype"
...
type CodeExecConfig struct {
    ...
    Timeout     time.Duration
    CaptureMode outputcapturemodetype.Variant
}

// OutputCaptureMode uses outputcapturemodetype.Variant from internal/enums/outputcapturemodetype/
// See: 10-enum-architecture.md §14
...
func (s *CodeExecStage) Execute(context stdctx.Context, input StageInput) appfault.Result[StageOutput] {
    ...
    context, cancel := stdctx.WithTimeout(context, s.config.Timeout)
    defer cancel()
...
// IntegrationType uses integrationtype.Variant from internal/enums/integrationtype/
// See: 10-enum-architecture.md §15
import "nexus-flow/internal/enums/integrationtype"

// IntegrationConfig holds typed integration configuration
...
// IntegrationParams holds typed execution parameters
...
// IntegrationResult holds typed execution result
...
// BuildMode uses buildmodetype.Variant from internal/enums/buildmodetype/
// See: 10-enum-architecture.md §16
import "nexus-flow/internal/enums/buildmodetype"

type BuildConfig struct {
    FlowId           string
    OutputPath       string
    Mode             build_mode.Variant
    IncludeDeps      bool
    EmbedTemplates   bool
    PrerequisitesReq []runtime_type.Variant
...
func (r *Runner) extractDatabases() appfault.Result[string] {
    ...
    err = fs.WalkDir(embeddedDbs, "databases", func(path string, d fs.DirEntry, err error) error {
        ...
        ensureErr := pathutil.EnsureDir(filepath.Dir(outPath))
        if ensureErr != nil {
            return ensureErr
        }
...
type SafetyConfig struct {
    Enabled               bool                   // Enable safety checks
    RequireConfirmation   []DestructiveOperation // Operations requiring confirmation
...
- [Nexus-Flow Service](../../21-app/spec-management-software/14-microservices/06-nexus-flow.md) — Core service architecture
- [React Flow Canvas](../../21-app/spec-management-software/14-microservices/07-react-flow-canvas.md) — Visual editor details
- [Database Design](../../21-app/spec-management-software/14-microservices/../07-database-design/00-overview.md) — Schema conventions
- [Error Management](../../21-app/spec-management-software/06-error-management/02-backend/01-error-codes.md) — Error handling patterns
- [AI-Bridge Service](../../21-app/spec-management-software/14-microservices/04-ai-bridge.md) — LLM integration for prompts
- [Scout Service](../../21-app/spec-management-software/14-microservices/05-scout.md) — RAG integration for search stages
