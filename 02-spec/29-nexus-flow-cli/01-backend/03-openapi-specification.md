...
> **Service Port:** 5050
> **Error Code Range:** 8xxx (8000-8399)
...
- [Nexus-Flow Standalone Architecture](../../21-app/spec-management-software/14-microservices/09-nexus-flow-standalone-architecture.md)
- [Gateway OpenAPI](../../21-app/spec-management-software/14-microservices/14-gateway-openapi.md)
- [AI-Bridge OpenAPI](../../21-app/spec-management-software/14-microservices/13-ai-bridge-openapi.md)
...
```
Production:  http://localhost:5050/api/v1
Via Gateway: http://localhost:5050/api/v1/nexus-flow
```
...
```
WebSocket URL: ws://localhost:5050/ws/executions/{executionId}
```
...
```
ws://localhost:5050/ws/executions/{executionId}?token=<jwt_token>
```
...
See [Nexus-Flow Service Specification](../../21-app/spec-management-software/14-microservices/06-nexus-flow.md) §3 for detailed node type configurations.
