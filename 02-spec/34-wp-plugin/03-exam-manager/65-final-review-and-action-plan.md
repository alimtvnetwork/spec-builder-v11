...
│
├── 01-admin-backend/02-split-spec/      # Backend specs (numbered)
├── 02-frontend/02-split-spec/           # Frontend specs (numbered)
...
- **57 backend specs** (01-admin-backend/02-split-spec/)
- **31 frontend specs** (02-frontend/02-split-spec/)
