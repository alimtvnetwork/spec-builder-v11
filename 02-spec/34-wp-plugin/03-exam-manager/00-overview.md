...
## 📂 01-admin-backend/02-split-spec/ (64 Files)
...
| 42 | `42-test-spec-conditional-helpers.md` | logIf, execIf, ifNotNull test cases |
| 43 | `43-test-spec-file-loader.md` | FileLoaderHelpers stack trace tests |
| 44 | `44-test-spec-feature-flags.md` | Feature flag resolution tests |
| 45 | `45-test-spec-deadline-engine.md` | Deadline calculation algorithm tests |
| 46 | `46-test-spec-progress-calculation.md` | Progress percentage, SKIPPED handling tests |
...
## 📂 02-frontend/02-split-spec/ (33 Files)
...
| [PHP Debugging Guide](../../03-error-manage/01-error-resolution/05-debugging-cheat-sheet.md) | Initialization order, logging |
| [PHP Coding Guidelines](../../21-app/spec-management-software/12-prompts/01-coding-guideline/04-backend-php.md) | BooleanUtil, 15-line limit |
