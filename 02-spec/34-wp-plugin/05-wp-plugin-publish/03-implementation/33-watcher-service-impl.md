...
> **Location:** `02-spec/34-wp-plugin/05-wp-plugin-publish/03-implementation/33-watcher-service-impl.md`  
> **Updated:** 2026-03-12  
**Version:** 1.0.0  
...
type Service interface {
	...
	// Batch operations
	ScanAll(context stdctx.Context) ScanResultSlice
...
func (s *serviceImpl) ScanAll(context stdctx.Context) ScanResultSlice {
	s.mu.RLock()
