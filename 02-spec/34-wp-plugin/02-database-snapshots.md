...
{
    "Version": "1.0.0",
    "CreatedAt": "2026-02-06T14:30:22Z",
    "SourceSite": "https://example.com",
    "WpVersion": "6.4.2",
    "Tables": ["wp_posts", "wp_postmeta", "..."],
    "TableCounts": {"wp_posts": 2547, "wp_postmeta": 15234},
    "TotalRows": 45678,
    "Provider": "native"
}
```
...
```json
{
    ...
    "Data": {
        "SnapshotId": "007",
        "ScheduledAt": "2026-02-06T14:30:27Z",
        "Status": "scheduled",
        "Tables": ["wp_posts", "wp_postmeta", "wp_options"]
    }
}
...
```json
{
    ...
    "Error": {
        ...
        "Details": {
            "LockFile": "/snapshots/.lock",
            "LockedAt": "2026-02-06T14:30:00Z",
            "LockedBy": "cron"
        }
    }
}
