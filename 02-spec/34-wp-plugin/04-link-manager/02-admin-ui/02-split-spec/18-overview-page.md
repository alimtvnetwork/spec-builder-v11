...
|-----------|--------------|
| **UI Patterns** (`02-spec/25-gsearch-cli/02-frontend/05-ui-patterns.md`) | Modal vertical scrolling for Snapshot/Scan modals; spinner update pattern for scan progress |
