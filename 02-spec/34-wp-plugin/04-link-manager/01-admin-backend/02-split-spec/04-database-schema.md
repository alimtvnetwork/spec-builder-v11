...
class Schema
{
    ...
    private static function createPostTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPostWpPostId ON Post(WpPostId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPostSlug ON Post(Slug)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPostBrokenLinks ON Post(BrokenLinks)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPostLastScannedAt ON Post(LastScannedAt)");
    }
    ...
    private static function createPageTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPageWpPageId ON Page(WpPageId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPageSlug ON Page(Slug)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxPageBrokenLinks ON Page(BrokenLinks)");
    }
    ...
    private static function createCategoryTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxCategoryWpCategoryId ON Category(WpCategoryId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxCategorySlug ON Category(Slug)");
    }
    ...
    private static function createLinkTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkContentTypeContentId ON Link(ContentType, ContentId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkStatus ON Link(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkUrl ON Link(Url)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkWordCount ON Link(WordCount)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkHasHeadingWrapper ON Link(HasHeadingWrapper)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkScanHistoryId ON Link(ScanHistoryId)");
    }
    ...
    private static function createScanHistoryTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxScanHistoryStatus ON ScanHistory(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxScanHistoryCreatedAt ON ScanHistory(CreatedAt)");
    }
    ...
    private static function createSnapshotTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSnapshotSnapshotNumber ON Snapshot(SnapshotNumber)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSnapshotType ON Snapshot(Type)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSnapshotCreatedAt ON Snapshot(CreatedAt)");
    }
    ...
    private static function createSettingsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSettingsSettingKey ON Settings(SettingKey)");
    }
    ...
    private static function createScanJobsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxScanJobsStatus ON ScanJobs(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxScanJobsCreatedAt ON ScanJobs(CreatedAt DESC)");
    }
    ...
    private static function createJobQueueTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxJobQueueJobIdProcessed ON JobQueue(JobId, Processed)");
    }
    ...
    private static function createLinkTargetTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTargetCategory ON LinkTarget(Category)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTargetPriority ON LinkTarget(Priority DESC)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTargetIsActive ON LinkTarget(IsActive)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTargetSource ON LinkTarget(Source)");
    ...
    private static function createLinkTemplateTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTemplateIsDefault ON LinkTemplate(IsDefault)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkTemplateIsActive ON LinkTemplate(IsActive)");
    ...
    private static function createLinkVariableTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkVariableName ON LinkVariable(Name)");
    ...
    private static function createInternalLinkTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxInternalLinkContentTypeContentId ON InternalLink(ContentType, ContentId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxInternalLinkWpContentId ON InternalLink(WpContentId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxInternalLinkTargetUrl ON InternalLink(TargetUrl)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxInternalLinkSource ON InternalLink(Source)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxInternalLinkIsActive ON InternalLink(IsActive)");
    ...
    private static function createLinkHealthChecksTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkHealthChecksStatus ON LinkHealthChecks(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkHealthChecksNextCheckAt ON LinkHealthChecks(NextCheckAt)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkHealthChecksConsecutiveFailures ON LinkHealthChecks(ConsecutiveFailures)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxLinkHealthChecksLinkId ON LinkHealthChecks(LinkId)");
    ...
    private static function createHealthAlertsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthAlertsSeverity ON HealthAlerts(Severity)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthAlertsAcknowledged ON HealthAlerts(Acknowledged)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthAlertsCreatedAt ON HealthAlerts(CreatedAt)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthAlertsHealthCheckId ON HealthAlerts(HealthCheckId)");
    ...
    private static function createHealthCheckJobsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthCheckJobsStatus ON HealthCheckJobs(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxHealthCheckJobsCreatedAt ON HealthCheckJobs(CreatedAt)");
    ...
    private static function createHealthExclusionsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE UNIQUE INDEX IF NOT EXISTS IdxHealthExclusionsPattern ON HealthExclusions(Pattern, PatternType)");
    ...
    private static function createNotificationQueueTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationQueueStatus ON NotificationQueue(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationQueueScheduledFor ON NotificationQueue(ScheduledFor)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationQueueChannel ON NotificationQueue(Channel)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationQueueType ON NotificationQueue(Type)");
    ...
    private static function createNotificationRecipientsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE UNIQUE INDEX IF NOT EXISTS IdxNotificationRecipientsEmail ON NotificationRecipients(Email)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationRecipientsIsActive ON NotificationRecipients(IsActive)");
    ...
    private static function createWebhookEndpointsTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE UNIQUE INDEX IF NOT EXISTS IdxWebhookEndpointsUrl ON WebhookEndpoints(Url)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWebhookEndpointsIsActive ON WebhookEndpoints(IsActive)");
    ...
    private static function createNotificationLogTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationLogCreatedAt ON NotificationLog(CreatedAt)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationLogStatus ON NotificationLog(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationLogChannel ON NotificationLog(Channel)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationLogNotificationId ON NotificationLog(NotificationId)");
...
class HistorySchema
{
    ...
    private static function createContentVersionTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxContentVersionVersionNumber ON ContentVersion(VersionNumber)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxContentVersionCreatedAt ON ContentVersion(CreatedAt)");
    }
    ...
    private static function createModificationLogTable(PDO $pdo): void
    {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxModificationLogContentVersionId ON ModificationLog(ContentVersionId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxModificationLogModificationType ON ModificationLog(ModificationType)");
    }
}
```
...
CREATE UNIQUE INDEX IdxYoastSettingsKey ON YoastSettings(SettingKey);
```
...
CREATE INDEX IdxYoastOptimizationQueuePriority ON YoastOptimizationQueue(Priority DESC);
```
...
CREATE INDEX IdxAiProvidersProviderKey ON AiProviders(ProviderKey);
CREATE INDEX IdxAiProvidersIsEnabled ON AiProviders(IsEnabled);
CREATE INDEX IdxAiProvidersPriority ON AiProviders(Priority);
```
...
CREATE INDEX IdxAiProviderCredentialsProviderId ON AiProviderCredentials(ProviderId);
```
...
CREATE INDEX IdxAiModelsProviderId ON AiModels(ProviderId);
CREATE INDEX IdxAiModelsIsDefault ON AiModels(IsDefault);
CREATE INDEX IdxAiModelsCategory ON AiModels(ModelCategory);
```
...
CREATE UNIQUE INDEX IdxAiOAuthSessionsProviderId ON AiOAuthSessions(ProviderId);
```
