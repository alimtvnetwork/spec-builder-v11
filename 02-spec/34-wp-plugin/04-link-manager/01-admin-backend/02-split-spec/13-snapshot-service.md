...
CREATE INDEX IdxSnapshotsSequence ON Snapshots(Sequence DESC);
CREATE INDEX IdxSnapshotsCreated ON Snapshots(CreatedAt DESC);
```
...
final class SnapshotRestorer
{
    ...
    public function restore(
        ...
        $this->logger->info('Pre-restore backup created', [
            'BackupId' => $preRestoreBackup->getId()
        ]);
