...
class ScanService implements ScanServiceInterface
{
    ...
    public function startScan(
        ...
        if ($existingRunning !== null) {
            Logger::warning('Scan already running', ['ExistingId' => $existingRunning->id]);
    ...
    private function completeScan(int $scanHistoryId): void
    {
        ...
        Logger::info('Scan completed', [
            'ScanId' => $scanHistoryId,
            'DurationSeconds' => $duration,
            'TotalLinks' => $scanHistory->totalLinksFound,
            'BrokenLinks' => $scanHistory->brokenLinksFound
        ]);
    ...
    public function cancelScan(int $scanHistoryId): bool
    {
        ...
        Logger::info('Scan cancelled', ['ScanId' => $scanHistoryId]);
        return true;
    }
