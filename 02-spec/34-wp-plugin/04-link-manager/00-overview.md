...
```
02-spec/wp-plugin/link-manager/
...
| Reference | Location |
|-----------|----------|
| Memory Index | `.ai-memory/memories/wp-plugins/link-manager.md` |
| Architecture Memory | `.ai-memory/memories/wp-plugins/link-manager-architecture.md` |
| Implementation Plan | `.ai-memory/memories/wp-plugins/link-manager-plan.md` |
