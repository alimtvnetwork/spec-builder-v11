...
- **File paths:**
  - `02-spec/37-wp-plugin-development/07-error-handling.md` (10+ code examples)
  - `02-spec/37-wp-plugin-development/02-logging-standards.md` (FileLogger `error()` signature)
  - `02-spec/02-coding-guidelines/04-php/forbidden-patterns.md` (missing rule)
  - `02-spec/04-error-resolution/03-debugging-guides/01-debugging-php.md` (Logger class)
...
1. **`02-spec/02-coding-guidelines/04-php/forbidden-patterns.md`** — Added rule 1.8: catch blocks that log `$e->getMessage()` without passing the exception are forbidden
2. **`02-spec/37-wp-plugin-development/07-error-handling.md`** — Added critical rule: every catch block must pass `$e` to the logger; updated all code examples
3. **`02-spec/37-wp-plugin-development/02-logging-standards.md`** — Changed `FileLogger::error()` signature: first parameter is now `Throwable $e` (not `string $message`); message and stack trace are extracted automatically
4. **`02-spec/04-error-resolution/03-debugging-guides/01-debugging-php.md`** — Updated Logger class to accept `Throwable` as first parameter
...
- `02-spec/02-coding-guidelines/04-php/forbidden-patterns.md` (rule 1.8 + checklist)
- `02-spec/37-wp-plugin-development/07-error-handling.md` (critical rule + all examples)
- `02-spec/37-wp-plugin-development/02-logging-standards.md` (FileLogger signature)
- `02-spec/04-error-resolution/03-debugging-guides/01-debugging-php.md` (Logger class)
...
- [x] Issue write-up created at `02-spec/61-how-app-issues-track/17-missing-stack-trace-in-catch-blocks.md`
