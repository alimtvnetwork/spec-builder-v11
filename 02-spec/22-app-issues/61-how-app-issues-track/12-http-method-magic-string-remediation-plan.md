...
- **File paths:** 36 files across `02-spec/11-spec-management-software/`, `02-spec/33-shared-cli-frontend/`, `02-spec/25-gsearch-cli/` through `02-spec/31-ai-transcribe-cli/`, `02-spec/36-wp-seo-publish-cli/`, `02-spec/53-e2-activity-feed/`
...
The `HttpMethod` enum spec (`02-spec/02-coding-guidelines/02-typescript/http-method-enum.md`) was created but not retroactively applied to existing spec examples.
...
|---|------|-------------------|--------|
| 1 | `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/11-rest-api-endpoints.md` | 40 `.Methods("...")` | ✅ Fixed |
| 2 | `02-spec/11-spec-management-software/05-features/06-ai-integration/14-telemetry-dashboard.md` | 7 `.Methods("GET")` | ✅ Fixed |
| 3 | `02-spec/04-error-resolution/07-error-modal/03-error-modal-reference.md` | 2 `method: 'POST'` | ✅ Fixed |
| 4 | `02-spec/04-error-resolution/07-error-modal/react-components.md` | 1 `method: 'POST'` | ✅ Fixed |
| 5 | `02-spec/04-error-resolution/01-retrospectives/01-health-endpoint-mismatch.md` | 2 `.Methods("GET")` | ✅ Fixed |
| 6 | `02-spec/01-general-spec/01-foundation/error-resolution/01-health-endpoint-mismatch.md` | 2 `.Methods("GET")` | ✅ Fixed |
| 7 | `02-spec/11-spec-management-software/05-features/24-code-generation-system/28-file-modification-display.md` | 8 `.Methods("...")` | ✅ Fixed |
...
| # | File | Actual Violations | Status |
|---|------|-------------------|--------|
| 4 | `02-spec/11-spec-management-software/05-features/08-search/` | 0 (directory doesn't exist) | ✅ N/A |
| 5 | `02-spec/11-spec-management-software/05-features/03-automation/` | 0 (directory doesn't exist) | ✅ N/A |
| 6 | `02-spec/11-spec-management-software/05-features/09-file-management/` | 0 (directory doesn't exist) | ✅ N/A |
| 7 | `02-spec/33-shared-cli-frontend/04-api-tester.md` | 0 (JSON presets — exempt) | ✅ Exempt |
| 8 | `02-spec/25-gsearch-cli/01-backend/49-testing-ui.md` | 3 `endpoint.method !== "GET"` | ✅ Fixed |
| 9 | `02-spec/25-gsearch-cli/01-backend/48-unified-rest-api.md` | 1 CORS AllowMethods | ✅ Fixed |
| 10 | `02-spec/25-gsearch-cli/01-backend/12-testing-strategy.md` | 7 `httpmock.RegisterResponder` | ✅ Fixed |
| 11 | `02-spec/25-gsearch-cli/02-frontend/02-frontend-architecture.md` | 0 (JSON presets — exempt) | ✅ Exempt |
...
|---|-------|-------------------|--------|
| 9 | `02-spec/26-brun-cli/` | 0 (JSON config + enum def — exempt) | ✅ Exempt |
| 10 | `02-spec/27-ai-bridge-cli/` | 0 (no matches) | ✅ Clean |
| 11 | `02-spec/29-nexus-flow-cli/` | 0 (enum def + UI string — exempt) | ✅ Exempt |
| 12 | `02-spec/30-spec-reverse-cli/` | 0 (no matches) | ✅ Clean |
| 13 | `02-spec/36-wp-seo-publish-cli/` | 0 (JSON data + enum def — exempt) | ✅ Exempt |
| 14 | `02-spec/53-e2-activity-feed/` | 0 (action strings — not HTTP methods) | ✅ Exempt |
...
- `02-spec/02-coding-guidelines/02-typescript/http-method-enum.md` (already done in Issue #11)
- `02-spec/02-coding-guidelines/03-golang/03-httpmethod-enum.md` (already done in Issue #11)
...
- [x] Issue write-up created at `02-spec/61-how-app-issues-track/12-http-method-magic-string-remediation-plan.md`
