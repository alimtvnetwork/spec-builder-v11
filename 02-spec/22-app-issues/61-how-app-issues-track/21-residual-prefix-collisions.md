...
### Symptoms
- `02-spec/02-coding-guidelines/02-typescript/` had two files with prefix `06-`: `06-message-status-enum.md` and `06-typescript-standards-reference.md`.
- `02-spec/02-coding-guidelines/04-php/` had two files with prefix `06-`: `06-response-key-type-inventory.md` and `06-php-standards-reference.md`.
...
|--------|----------|----------|
| `02-spec/02-coding-guidelines/02-typescript/` | `06-typescript-standards-reference.md` | `08-typescript-standards-reference.md` |
| `02-spec/02-coding-guidelines/04-php/` | `06-php-standards-reference.md` | `07-php-standards-reference.md` |
