...
- **File paths (snake_case log keys — 20+ files):**
  - `02-spec/11-spec-management-software/13-shared-packages/07-integration-patterns.md`
  - `02-spec/11-spec-management-software/14-microservices/02-specmanager.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/03-config-system.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/04-site-service.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/05-plugin-service.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/06-file-watcher.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/07-sync-service.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/08-publish-service.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/09-backup-service.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/10-wp-rest-client.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/13-error-management.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/01-backend/16-split-db-architecture.md`
  - `02-spec/34-wp-plugin/05-wp-plugin-publish/02-frontend/26-ui-patterns.md`
  - `02-spec/11-spec-management-software/05-features/22-golang-search-cli/16-observability.md`
  - `02-spec/01-general-spec/02-systems/01-logging-system-systems.md`
  - `02-spec/01-general-spec/02-systems/03-conditional-helpers-systems.md`
  - `02-spec/01-general-spec/10-wordpress/07-overview-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/01-plugin-structure-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/02-rest-api-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/03-cron-system-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/04-admin-ui-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/05-sanitization-wordpress.md`
  - `02-spec/01-general-spec/10-wordpress/06-configuration-wordpress.md`
  - `02-spec/11-spec-management-software/12-prompts/01-coding-guideline/04-backend-php.md`
  - `02-spec/02-coding-guidelines/01-cross-language/04-code-style.md`
  - `02-spec/35-wp-plugin-builder/12-coding-guidelines.md`
- **File paths (inline function calls — 2 files):**
  - `02-spec/27-ai-bridge-cli/01-backend/09-agentic-mode.md`
  - `02-spec/11-spec-management-software/08-roadmap-overview/07-integration-tests-pipeline.md`
...
Systematic regex-based scans across the entire spec tree, triggered by user request to enforce the no-magic-strings and camelCase log key rules documented in `02-spec/01-general-spec/01-foundation/01-coding-standards-foundation.md`.
...
- Updated `02-spec/02-coding-guidelines/03-golang/02-boolean-standards.md` and `02-spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` to add explicit exemptions for error propagation, panic recovery, comma-ok, and type assertions
...
3. **Memory updated:** `.ai-memory/memories/architecture/naming-conventions/context-keys.md` and `.ai-memory/memories/architecture/coding-standards/control-flow.md` both updated with comprehensive rules and exemptions
...
- `02-spec/02-coding-guidelines/03-golang/02-boolean-standards.md` — P7 exemptions
- `02-spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` — P7 exemptions
- `.ai-memory/memories/architecture/coding-standards/control-flow.md` — Updated
- `.ai-memory/memories/architecture/naming-conventions/context-keys.md` — Updated
- `.ai-memory/memories/architecture/coding-standards/no-magic-strings-log-keys.md` — Referenced
...
- [x] Issue write-up created at `02-spec/61-how-app-issues-track/14-snake-case-log-keys-and-inline-calls.md`
