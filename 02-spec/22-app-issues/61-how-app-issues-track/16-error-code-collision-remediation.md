...
> 📋 **Summary report:** [collision-resolution-summary.md](../03-error-manage/03-error-code-registry/03-collision-resolution-summary.md) — consolidated before/after table of all 13 resolutions.
...
- **File paths:**
  - `02-spec/11-spec-management-software/05-features/24-code-generation-system/16-error-codes.md`
  - `02-spec/11-spec-management-software/05-features/24-code-generation-system/05-parallel-executor.md`
  - `02-spec/11-spec-management-software/05-features/24-code-generation-system/15-websocket-events.md`
  - `02-spec/11-spec-management-software/05-features/24-code-generation-system/00-overview.md`
  - `02-spec/11-spec-management-software/05-features/28-project-editor/05-error-codes.md`
  - `02-spec/11-spec-management-software/05-features/21-suggestions-system.md`
  - `02-spec/11-spec-management-software/05-features/18-realtime/00-overview.md`
  - `02-spec/11-spec-management-software/05-features/22-golang-search-cli/15-error-codes.md`
  - `02-spec/31-ai-transcribe-cli/01-backend/03-stt-providers.md`
  - `02-spec/31-ai-transcribe-cli/01-backend/04-tts-providers.md`
  - `02-spec/31-ai-transcribe-cli/01-backend/00-overview.md`
...
1. **Mandatory registry check:** All new error code allocations MUST be verified against `02-spec/03-error-code-registry/01-registry.md` before assignment
...
**Before assigning any error code range to a new module, the developer/AI MUST consult `02-spec/03-error-code-registry/01-registry.md` and register the new range before writing it into any spec file.** No local/ad-hoc code ranges are permitted.

### Acceptance criteria / test scenarios

- **AC-1:** `grep -rn "12[0-7][0-9][0-9]" 02-spec/11-spec-management-software/` returns zero active error code definitions (data values like UUIDs excluded)
- **AC-2:** `grep -rn "13[0-9][0-9][0-9]" 02-spec/31-ai-transcribe-cli/` returns zero error code definitions
...
- `02-spec/03-error-code-registry/01-registry.md` — Resolutions 7-12 added, range table updated
- `02-spec/11-spec-management-software/05-features/24-code-generation-system/16-error-codes.md`
- `02-spec/11-spec-management-software/05-features/24-code-generation-system/05-parallel-executor.md`
- `02-spec/11-spec-management-software/05-features/24-code-generation-system/15-websocket-events.md`
- `02-spec/11-spec-management-software/05-features/24-code-generation-system/00-overview.md`
...
- `02-spec/31-ai-transcribe-cli/01-backend/04-tts-providers.md`
- `02-spec/31-ai-transcribe-cli/01-backend/00-overview.md`
- `.ai-memory/memories/technical/error-code-registry-complete.md`
...
- [x] Issue write-up created at `02-spec/61-how-app-issues-track/16-error-code-collision-remediation.md`
