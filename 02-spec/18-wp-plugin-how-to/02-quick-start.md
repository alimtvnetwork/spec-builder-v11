...
|----------|--------|-------|
| Minimum PHP | **8.1+** (backed enums, readonly, fibers) | [Phase 1, §1.1](03-foundation-and-architecture.md) |
| Minimum WordPress | **5.6+** | [Phase 1, §1.1](03-foundation-and-architecture.md) |
| Array syntax | `[]` only — never `array()` | [Phase 1, §1.1](03-foundation-and-architecture.md) |
| Exception catching | Always `Throwable`, never `Exception` | [Phase 1, §1.1](03-foundation-and-architecture.md) |
| Magic strings | **Forbidden** — use backed enums everywhere | [Phase 2](02-enums-and-coding-style/readme.md) |
...
> **Phase 1, §1.2** — [Full folder structure rules](03-foundation-and-architecture.md)
...
> [Phase 7, §7.1](08-reference-implementations.md) — Full bootstrap

### 2. Autoloader (`includes/Autoloader.php`)

PSR-4 mapping from plugin namespace → `includes/` directory. Must log to `autoloader.log`.

> [Phase 7, §7.2](08-reference-implementations.md) — Full autoloader
...
> [Phase 7, §7.3](08-reference-implementations.md) — Full Plugin.php

### 4. ResponseTrait (`includes/Traits/Core/ResponseTrait.php`)

Provides `safeExecute()` error boundary and standard response builders.

> [Phase 3, §3.4](04-traits-and-composition.md) — safeExecute pattern
> [Phase 7, §7.4](08-reference-implementations.md) — Full ResponseTrait

### 5. FileLogger (`includes/Logging/FileLogger.php`)

Structured file-based logging with rotation, deduplication, and stack traces.

> [Phase 4, §4.3](05-logging-and-error-handling.md) — FileLogger spec
> [Phase 7, §7.5](08-reference-implementations.md) — Full FileLogger
...
> [Phase 2](02-enums-and-coding-style/readme.md) — Enum architecture (4 subcategories)
...
> [Phase 3, §3.4](04-traits-and-composition.md) — safeExecute anatomy
...
> [Phase 4, §4.1](05-logging-and-error-handling.md) — Two-tier architecture
...
> [Phase 5](06-helpers-responses-and-integration.md) — EnvelopeBuilder API

### Fail-Fast Input Validation

Guard clauses at the top of every handler. Use enum-based validation.

> [Phase 6](07-input-validation-patterns.md) — Validation patterns
...
| Step | Action | Phase |
|------|--------|-------|
| 1 | Create enum(s) in `Enums/` for any new constants | [Phase 2](02-enums-and-coding-style/readme.md) |
| 2 | Create trait(s) in `Traits/[Feature]/` | [Phase 3](04-traits-and-composition.md) |
| 3 | Add `use` statement in `Plugin.php` | [Phase 1, §1.5](03-foundation-and-architecture.md) |
| 4 | Register routes in `RouteRegistrationTrait` | [Phase 3, §3.6](04-traits-and-composition.md) |
| 5 | Add input validation guard clauses | [Phase 6](07-input-validation-patterns.md) |
| 6 | Add database migration if needed | [Phase 8, §8.5](09-wordpress-integration-patterns.md) |
| 7 | Add admin page template if needed (≤200 lines) | [Phase 11](12-frontend-and-template-patterns.md) |
| 8 | Add tests | [Phase 9](10-testing-patterns.md) |

> [Phase 5](06-helpers-responses-and-integration.md) — Full integration checklist
...
> [Phase 11, §11.3](12-frontend-and-template-patterns.md) — Orchestrator pattern
...
| ❌ Don't | ✅ Do | Phase |
|----------|-------|-------|
| Call WordPress functions in constructors | Use lazy initialization / hook callbacks | [Phase 1](03-foundation-and-architecture.md) |
| Use `is_array()` directly | Use `TypeCheckerTrait::isArray()` | [Phase 3, §3.8](04-traits-and-composition.md) |
| Hardcode strings | Use backed enums | [Phase 2](02-enums-and-coding-style/readme.md) |
| Let exceptions escape handlers | Wrap in `safeExecute()` | [Phase 3, §3.4](04-traits-and-composition.md) |
| Use `array()` syntax | Use `[]` short syntax | [Phase 1, §1.1](03-foundation-and-architecture.md) |
| Put business logic in Plugin.php | Compose via traits | [Phase 3](04-traits-and-composition.md) |
| Skip input validation | Guard clauses at handler top | [Phase 6](07-input-validation-patterns.md) |
| Use regex in route patterns | Plain string endpoints | [Phase 14](15-rest-api-conventions.md) |
| Include source maps in production | Dev-only source maps | [Phase 11, §11.8](12-frontend-and-template-patterns.md) |
| Store option names as strings | `OptionNameType` enum | [Phase 15](16-settings-architecture.md) |
