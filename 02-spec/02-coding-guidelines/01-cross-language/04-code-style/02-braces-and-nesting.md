...
>
> - **Go:** [Enum Specification](../../03-golang/01-enum-specification/readme.md) — pattern, required methods, folder layout
> - **TypeScript:** [TypeScript Enums](../../02-typescript/readme.md) — string enum definitions, usage patterns
...
```typescript
// ── TypeScript ──────────────────────────────────────────────
// See: ../../02-typescript/readme.md for all enum definitions
