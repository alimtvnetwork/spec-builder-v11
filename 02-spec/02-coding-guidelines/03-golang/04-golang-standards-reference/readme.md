...
- [Cross-Language Code Style](../../01-cross-language/04-code-style/readme.md) — Braces, nesting & spacing rules
...
- [Enum Specification](../01-enum-specification/readme.md) — Byte-based enum pattern, required methods, folder structure
