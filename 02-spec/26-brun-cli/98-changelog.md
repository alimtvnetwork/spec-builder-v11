...
All notable changes to the BRun CLI specification are documented here.
...
Project-wide major version increment (+1.0.0) applied to all specification files in `21-brun-cli`.
