...
**Cross-References:**
- [Configuration](../01-backend/03-configuration.md) — Config file management
- [Error Handling](../01-backend/06-error-handling.md) — Error codes reference
- [Implementation Guide](../01-backend/14-implementation-guide.md) — Build setup
- [Observability](../01-backend/15-observability.md) — Metrics and health checks
- [gsearch Deployment](../../25-gsearch-cli/03-deploy/01-deployment-guide.md) — Reference deployment guide
...
- [Core Architecture](../01-backend/01-core-architecture.md)
- [Configuration](../01-backend/03-configuration.md)
- [Error Handling](../01-backend/06-error-handling.md)
- [Integration API](../01-backend/09-integration-api.md)
- [Observability](../01-backend/15-observability.md)
- [gsearch Deployment Guide](../../25-gsearch-cli/03-deploy/01-deployment-guide.md)
