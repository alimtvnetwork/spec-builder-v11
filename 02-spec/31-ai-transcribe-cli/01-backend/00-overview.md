...
| AI Bridge Delegation | [02-spec/27-ai-bridge-cli/01-backend/32-tool-delegation.md](../../27-ai-bridge-cli/01-backend/32-tool-delegation.md) |
| Error Code Registry | [02-spec/11-spec-management-software/06-error-management/error-code-registry.md](../../21-app/spec-management-software/06-error-management/01-error-code-registry.md) |
| Split DB Architecture | [02-spec/06-split-db-architecture/00-overview.md](../../05-split-db-architecture/00-overview.md) |
