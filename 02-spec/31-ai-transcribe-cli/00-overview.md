...
- [Shared CLI Frontend](../33-shared-cli-frontend/00-overview.md) — Common UI components
- **[DBOperation Wrapper](../04-database-conventions/01-sqlite-standards.md)** — Mandatory DB operation wrapper
- **[ORM-Only Policy](../04-database-conventions/02-orm-standards.md)** — No raw SQL mandate
