...
| Reference | Location |
|-----------|----------|
| Long-Chain Commands | `02-spec/27-ai-bridge-cli/01-backend/50-long-chain-command-system.md` |
| Vector Database | `02-spec/27-ai-bridge-cli/01-backend/51-vector-database-integration.md` |
| Reasoning Defaults | `02-spec/27-ai-bridge-cli/01-backend/42-lovable-reasoning-defaults.md` |
| GSearch Multi-Source | `02-spec/25-gsearch-cli/01-backend/56-multi-source-search.md` |
| Plan Generation | `02-spec/27-ai-bridge-cli/01-backend/44-plan-generation.md` |
