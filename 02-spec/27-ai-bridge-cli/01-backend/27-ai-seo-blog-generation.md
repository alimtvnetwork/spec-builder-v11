...
> **Note:** See `02-spec/27-ai-bridge-cli/01-backend/26-database-paths-reference.md` for all DB path definitions.
...
| GSearch CLI | `02-spec/11-spec-management-software/05-features/22-golang-search-cli/` |
