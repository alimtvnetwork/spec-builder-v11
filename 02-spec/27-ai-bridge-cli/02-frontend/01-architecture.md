...
| E2E Test Spec | `02-spec/33-shared-cli-frontend/11-e2e-test-spec.md` |
| Accessibility Spec | `02-spec/33-shared-cli-frontend/12-accessibility-spec.md` |
| Visual Regression | `02-spec/33-shared-cli-frontend/13-visual-regression-spec.md` |
...
| Model Management | `02-spec/27-ai-bridge-cli/01-backend/07-model-management.md` |
| Split DB Integration | `02-spec/27-ai-bridge-cli/01-backend/08-split-db-integration.md` |
