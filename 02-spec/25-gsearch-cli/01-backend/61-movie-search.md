...
type Provider interface {
    Name() string
    Search(context stdctx.Context, query string, opts SearchOptions) MediaResultSlice
...
func (o *Orchestrator) SearchAll(context stdctx.Context, query string, opts SearchOptions) MediaResultSlice {
    if !o.parallel {
