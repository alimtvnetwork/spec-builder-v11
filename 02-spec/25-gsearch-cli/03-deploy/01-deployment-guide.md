...
**Cross-References:**
- [Configuration](../01-backend/02-configuration.md) — Config file management
- [Error Codes](../01-backend/15-error-codes.md) — Error handling reference
- [Implementation Guide](../01-backend/13-implementation-guide.md) — Build setup
- [Skipped Features](../../21-app/spec-management-software/11-skipped-features/00-overview.md) — Deferred complex features
...
The following features are deferred for simplicity. See [Skipped Features](../../21-app/spec-management-software/11-skipped-features/00-overview.md) for details:
...
| [02-configuration.md](../01-backend/02-configuration.md) | Config details |
| [13-implementation-guide.md](../01-backend/13-implementation-guide.md) | Build setup |
| [15-error-codes.md](../01-backend/15-error-codes.md) | Error reference |
