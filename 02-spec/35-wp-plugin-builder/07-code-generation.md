...
```go
func (g *CodeGenerator) generateComponent(req GenerationRequest, comp Component) GeneratedFileSlice {
    // 1. Build RAG context
...
```go
func (g *CodeGenerator) parseResponse(response string, comp Component) GeneratedFileSlice {
