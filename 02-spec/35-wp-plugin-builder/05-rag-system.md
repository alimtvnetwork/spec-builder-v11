...
// RAGResultMetadata holds source context for a RAG result
type RAGResultMetadata struct {
    SourceName string    `json:",omitempty"`
    IndexedAt  time.Time `json:",omitempty"`
    PresetName string    `json:",omitempty"`
...
- [AI Bridge Input Formats](../27-ai-bridge-cli/01-backend/02-input-formats.md)
