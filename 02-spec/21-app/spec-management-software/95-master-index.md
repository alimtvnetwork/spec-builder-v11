...
|------|-------------|--------|
| [README](./01-ideas/07-readme-legacy.md) | Ideas folder guide | Active |
| [00-readme-legacy](./01-ideas/07-readme-legacy.md) | Legacy documentation reference | Archive |
...
| File | Description | Status |
|------|-------------|--------|
| [README](./02-instructions/02-instructions-reference.md) | Instructions folder guide | Active |
| [01-file-naming-convention](./02-instructions/01-file-naming-convention.md) | Mandatory file naming rules & AI template | Active |
...
| [99-remediation-summary](./05-features/22-golang-search-cli/98-remediation-summary.md) | Quality journey summary | Complete |
...
| [10-repository-structure](./05-features/24-code-generation-system/10-repository-structure.md) | Generated repo layout (02-spec/BE/FE) | Active |
...
| [01-offline-first-storage](./05-features/25-ai-enhancements/10-offline-first-storage.md) | Offline-first architecture | Active |
| [01-01-versioned-storage](./05-features/25-ai-enhancements/11-versioned-storage.md) | Versioned storage system | Active |
| [01-02-sync-queue](./05-features/25-ai-enhancements/12-sync-queue.md) | Sync queue management | Active |
| [01-03-storage-hooks](./05-features/25-ai-enhancements/13-storage-hooks.md) | React storage hooks | Active |
| [01-04-sync-api](./05-features/25-ai-enhancements/14-sync-api.md) | Sync API specification | Active |
| [02-voice-resilience](./05-features/25-ai-enhancements/20-voice-resilience.md) | Voice input resilience | Active |
| [02-01-audio-capture](./05-features/25-ai-enhancements/21-audio-capture.md) | Audio capture system | Active |
| [02-02-transcription-service](./05-features/25-ai-enhancements/22-transcription-service.md) | Transcription service | Active |
| [02-03-audio-sync](./05-features/25-ai-enhancements/23-audio-sync.md) | Audio synchronization | Active |
| [02-04-voice-ui-components](./05-features/25-ai-enhancements/24-voice-ui-components.md) | Voice UI components | Active |
| [03-plan-mode](./05-features/25-ai-enhancements/30-plan-mode.md) | AI plan mode | Active |
| [03-01-plan-generation](./05-features/25-ai-enhancements/31-plan-generation.md) | Plan generation | Active |
| [03-02-plan-execution](./05-features/25-ai-enhancements/32-plan-execution.md) | Plan execution | Active |
| [03-03-approval-workflow](./05-features/25-ai-enhancements/33-approval-workflow.md) | Approval workflow | Active |
| [03-04-mermaid-integration](./05-features/25-ai-enhancements/34-mermaid-integration.md) | Mermaid integration | Active |
| [04-mermaid-diagrams](./05-features/25-ai-enhancements/40-mermaid-diagrams.md) | Mermaid diagrams | Active |
| [04-01-model-categorization](./05-features/25-ai-enhancements/41-model-categorization.md) | Model categorization | Active |
| [04-02-diagram-prompts](./05-features/25-ai-enhancements/42-diagram-prompts.md) | Diagram prompts | Active |
| [04-03-diagram-service](./05-features/25-ai-enhancements/43-diagram-service.md) | Diagram service | Active |
| [04-04-diagram-ui](./05-features/25-ai-enhancements/44-diagram-ui.md) | Diagram UI | Active |
| [05-chat-ui-redesign](./05-features/25-ai-enhancements/50-chat-ui-redesign.md) | Chat UI redesign | Active |
| [05-01-chat-layout](./05-features/25-ai-enhancements/51-chat-layout.md) | Chat layout | Active |
| [05-02-chat-input](./05-features/25-ai-enhancements/52-chat-input.md) | Chat input | Active |
| [05-03-message-display](./05-features/25-ai-enhancements/53-message-display.md) | Message display | Active |
| [05-04-mode-selector](./05-features/25-ai-enhancements/54-mode-selector.md) | Mode selector | Active |
| [06-cross-project-memory](./05-features/25-ai-enhancements/60-cross-project-memory.md) | Cross-project memory | Active |
| [06-01-sharing-architecture](./05-features/25-ai-enhancements/61-sharing-architecture.md) | Sharing architecture | Active |
| [06-02-sync-mechanism](./05-features/25-ai-enhancements/62-sync-mechanism.md) | Sync mechanism | Active |
| [06-03-rag-integration](./05-features/25-ai-enhancements/63-rag-integration.md) | RAG integration | Active |
| [06-04-sharing-ui](./05-features/25-ai-enhancements/64-sharing-ui.md) | Sharing UI | Active |
...
| [99-architecture-diagram](./05-features/27-automation-pipeline/00-overview.md) | Architecture visualization | Active |
...
|------|----------|-------|-------------|
| GSearch CLI | `02-spec/25-gsearch-cli/` | 27 | 7000-7999 |
| AI Bridge | `02-spec/27-ai-bridge-cli/` | 8 | 9000-9999 |
| Nexus Flow | `02-spec/29-nexus-flow-cli/` | 7 | 8000-8399 |
| BRun CLI | `02-spec/26-brun-cli/` | 18 | 7100-7599 |
...
| [error-code-registry](./06-error-management/01-error-code-registry.md) | Master error code list | Active |

### Backend Errors
| File | Description | Status |
|------|-------------|--------|
| [01-error-codes](./06-error-management/02-backend/01-error-codes.md) | Go error definitions | Active |

### Frontend Errors
| File | Description | Status |
|------|-------------|--------|
| [01-error-codes](./06-error-management/03-frontend/01-error-codes.md) | React error handling | Active |

### Shared Constants
| File | Description | Status |
|------|-------------|--------|
| [01-error-constants](./06-error-management/04-shared/01-error-constants.md) | Cross-platform constants | Active |
...
|---------|------|--------------|----------|
| Gateway | 8080 | [14-gateway-openapi.md](./14-microservices/14-gateway-openapi.md) | REST |
...
| [02-shared-pkg-modules](./14-microservices/08-shared-pkg-modules.md) | Shared Go packages | Active |
| [06-database-migrations](./14-microservices/11-database-migrations.md) | Migration strategy | Active |
...
| [02-migrations](./07-database-design/02-migrations.md) | Migration strategy | Active |
| [03-unified-schema](./07-database-design/03-unified-schema.md) | Consolidated schema DDL | Active |
| [04-relationships](./07-database-design/04-relationships.md) | Foreign key relationships | Active |
| [05-seed-data](./07-database-design/05-seed-data.md) | Initial data population | Active |
| [04-conventions](./07-database-design/06-conventions.md) | Naming and type conventions | Active |
...
| [02-implementation-order-guide](./08-roadmap-overview/02-implementation-order-guide.md) | Dependency ordering | Active |
| [03-summary](./08-roadmap-overview/03-summary.md) | Executive summary | Active |
| [03-glossary](./08-roadmap-overview/04-glossary.md) | Technical term definitions | Active |
| [04-implementation-guidelines](./08-roadmap-overview/05-implementation-guidelines.md) | Coding patterns | Active |
| [05-gap-analysis](./08-roadmap-overview/06-gap-analysis.md) | Missing feature analysis | Active |
| [06-testing-deployment](./08-roadmap-overview/07-testing-deployment.md) | CI/CD pipeline specs | Planned |
| [07-integration-tests-pipeline](./08-roadmap-overview/08-integration-tests-pipeline.md) | E2E test configuration | Planned |
| [08-config-validator-tests](./08-roadmap-overview/09-config-validator-tests.md) | Config validation tests | Planned |
...
| [00-system-architecture-overview](./09-diagrams/09-system-architecture-overview.md) | Master system diagram | Active |
...
| [07-master-architecture-diagram](./09-diagrams/10-master-architecture-diagram.md) | Microservices, ports, databases, flows | Active |
...
| [01-e2e-integration-tests](./10-research/01-e2e-integration-tests.md) | E2E testing approaches | Complete |
| [02-llm-server-multi-model](./10-research/02-llm-server-multi-model.md) | Multi-model support research | Complete |
| [02-llm-server-config-update-plan](./10-research/03-llm-server-config-update-plan.md) | Config update strategy | Complete |
| [03-model-category-inconsistency-report](./10-research/04-model-category-inconsistency-report.md) | Model categorization analysis | Complete |
| [04-import-export-global-visibility-report](./10-research/05-import-export-global-visibility-report.md) | Import/export scope analysis | Complete |
...
| File | Description | Status |
|------|-------------|--------|
| [openapi.yaml](./16-api/openapi.yaml) | OpenAPI 3.0 specification | Active |
| [types.ts](./16-api/types.ts) | TypeScript API client types (918 lines) | Active |
...
| [93-cross-reference-validation-report](./93-cross-reference-validation-report.md) | Link validation | Active |
| [94-quality-improvement-plan](./94-quality-improvement-plan.md) | Improvement roadmap | Active |
| [92-session-changelog-2026-01-28](./92-session-changelog-2026-01-28.md) | Session changes log | Active |
...
| File | Description |
|------|-------------|
| [98-changelog.md](./98-changelog.md) | Version history and structural changes |
| [97-ai-handoff-guide.md](./97-ai-handoff-guide.md) | AI model handoff instructions |
| [96-context-for-ai.md](./96-context-for-ai.md) | AI-specific context and conventions |
...
- [Glossary](./08-roadmap-overview/04-glossary.md) - Technical terms
- [Implementation Guide](./08-roadmap-overview/05-implementation-guidelines.md) - Coding patterns
