...
`management`, `overview`, `project`, `software`
...
| # | Folder | Purpose |
|---|--------|---------|
| 01 | [ideas/](../01-ideas/08-readme.md) | Raw voice transcriptions, brainstorming |
| 02 | [instructions/](../02-instructions/02-instructions-reference.md) | Refined, actionable instructions |
...
- **Start Here:** [Ideas README](../01-ideas/08-readme.md)
...
- [General Spec Overview](../../01-spec-authoring-guide/00-overview.md) — Universal standards
