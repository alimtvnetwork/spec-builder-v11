...
> **External Spec:** `02-spec/25-gsearch-cli/`  
> **Version:** 3.0.0  
...
📁 **Location:** [`02-spec/25-gsearch-cli/`](../../25-gsearch-cli/00-overview.md)
...
See: [`02-spec/25-gsearch-cli/01-backend/15-error-codes.md`](../../25-gsearch-cli/01-backend/15-error-codes.md)
