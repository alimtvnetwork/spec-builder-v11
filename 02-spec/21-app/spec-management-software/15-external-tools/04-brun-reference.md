...
> **External Spec:** `02-spec/26-brun-cli/`  
> **Version:** 4.0.0  
...
📁 **Location:** [`02-spec/26-brun-cli/`](../../26-brun-cli/00-overview.md)
...
| File | Description |
|------|-------------|
| `01-frontend-architecture.md` | React UI architecture |

### Deploy (`03-deploy/`)

| File | Description |
|------|-------------|
| `01-deployment-guide.md` | Deployment guide |
...
- Used by **Nexus Flow CLI** for build/task nodes
- Integrates with **AI Bridge CLI** for config generation

---

## See Also

- [Full Specification](../../26-brun-cli/00-overview.md)
