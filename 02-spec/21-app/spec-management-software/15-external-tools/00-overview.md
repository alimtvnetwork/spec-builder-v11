...
|---|------|----------|-------------|-------------|
| 01 | [GSearch CLI](./01-gsearch-reference.md) | `02-spec/25-gsearch-cli/` | 7000-7999 | Search, indexing, trend analysis |
| 02 | [AI Bridge CLI](./02-ai-bridge-reference.md) | `02-spec/27-ai-bridge-cli/` | 9000-9999 | LLM adapter, multi-format input |
| 03 | [Nexus Flow CLI](./03-nexus-flow-reference.md) | `02-spec/29-nexus-flow-cli/` | 8000-8399 | Visual workflow orchestration |
| 04 | [BRun CLI](./04-brun-reference.md) | `02-spec/26-brun-cli/` | 7100-7599 | Build runner and task executor |
| 05 | [WP Plugin Builder](./05-wp-plugin-builder.md) | `02-spec/35-wp-plugin-builder/` | 10000-10999 | WordPress plugin development |
...
2. **Error code registry** — Each tool has reserved error ranges in `02-spec/03-error-code-registry/`
