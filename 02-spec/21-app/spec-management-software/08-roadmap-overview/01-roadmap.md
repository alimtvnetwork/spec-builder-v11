...
**Output:** `02-spec/34-wp-plugin/03-exam-manager/ideas/02-spec-management-software.md`
...
**Deliverables:**
- [x] Create `02-spec/11-spec-management-software/` folder
...
- All specs follow [General Spec Standards](../../01-spec-authoring-guide/00-overview.md)
