...
### Fixed
- **Issue #04 — Stale wave count in master status** (`02-spec/61-how-app-issues-track/04-master-status-stale-wave-count.md`)
  - `.ai-memory/memories/workflow/03-master-status.md` reported 8/8 waves and v14.0.0 despite 11 waves and v15.0.0 being current
  - Updated to v12.0.0: wave count 11/11, Waves 9–11 added, Known Issues updated to v15.0.0
- **Issue #05 — Broken suggestion tracker reference** (`02-spec/61-how-app-issues-track/05-broken-suggestion-tracker-reference.md`)
  - Master status referenced nonexistent `.ai-memory/memories/suggestions/01-suggestions-tracker.md`
  - Corrected to `.ai-memory/memories/suggestions/README.md`

### Changed
- **`02-spec/61-how-app-issues-track/00-overview.md`** — Added Issue Index table documenting issues 03–05
- **`.ai-memory/memories/workflow/03-mistake-remediation-protocol.md`** — Added registry entries for issues 04 and 05
...
Ecosystem-wide validation of `.ai-memory/memories/` references, fixing 15 broken links across two passes (v9.3.0 and v9.4.0). Established a systematic issue tracking and prevention workflow.

### Added
- **`02-spec/61-how-app-issues-track/`** — New issue tracking folder with 3 files:
...
- **`.ai-memory/memories/workflow/03-mistake-remediation-protocol.md`** — Memory for issue tracking with registry table
...
### Changed
- **`02-02-spec/99-consistency-report.md`** bumped v9.3.0 → v9.4.0
...
- **`.ai-memory/memories/workflow/02-folder-conventions.md`** — Added folders 14–22 to root index
...
### Fixed
- **Stale cross-references in spec files** — `../spec-management-software/` → `../21-app/spec-management-software/` in 2 files (nexus-flow error codes, general-spec coding standards)
...
- **Stale paths in `.ai-memory/memories/`** — ~60 edits across 25 memory files fixing un-prefixed folder names (`02-spec/brun-cli/` → `02-spec/26-brun-cli/`, etc.)
- **Renamed `03-cw-config-architecture.md`** → `03-seedable-config-architecture.md` in memories/architecture

### Changed
- **`02-02-spec/99-consistency-report.md`** bumped to v9.0.0 — stale patterns section updated to show all resolved, success probability 99%
- **`02-spec/25-gsearch-cli/02-frontend/`** — 3 files updated to reference `28-shared-cli-frontend/` instead of deleted `03-shared-frontend-architecture/`
- **`.ai-memory/memories/training/06-ai-handoff-package.md`** — stale patterns table updated to show all resolved
- **`.ai-memory/memories/project/remediation-status.md`** — added Phase 7 (IX_→Idx) and Phase 8 (v9.0.0 cross-ref)
- **`.ai-memory/memories/workflow/implementation-strategy.md`** — added Wave 9 & 10, compliance stats updated to ≥95%
...
- **`.ai-memory/memories/features/automation-pipeline.md`** updated with full file count
