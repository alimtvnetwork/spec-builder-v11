...
- See [General Coding Standards §9](../../01-spec-authoring-guide/01-foundation/01-coding-standards-foundation.md) for full rules
...
- [General Spec Foundation](../../01-spec-authoring-guide/01-foundation/01-coding-standards-foundation.md)
