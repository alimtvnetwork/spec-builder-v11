...
`features`, `history`, `management`, `software`, `system`
...
| 02 | [History Service](./02-history-system.md) | Backend | Snapshots and version management |
| 03 | [Diff Engine](./04-file-history-comparison.md) | Backend | Diff algorithms and three-way merge |
| 04 | [History UI](./03-history-ui.md) | Frontend | Version history interface |
| 05 | [File Comparison](./04-file-history-comparison.md) | Frontend | Side-by-side diff viewer |
...
|------|----------|-------------|
| 7001 | `ErrHistoryNotFound` | Version not found |
| 7002 | `ErrHistoryCorrupt` | Git repository corrupted |
| 7003 | `ErrSnapshotNotFound` | Snapshot not found |
| 7004 | `ErrSnapshotCreateFailed` | Failed to create snapshot |
| 7005 | `ErrRestoreFailed` | Restore operation failed |
| 7006 | `ErrMergeConflict` | Merge has conflicts |
| 7007 | `ErrDiffFailed` | Diff computation failed |
| 7008 | `ErrUndoUnavailable` | Nothing to undo |
| 7009 | `ErrRedoUnavailable` | Nothing to redo |
