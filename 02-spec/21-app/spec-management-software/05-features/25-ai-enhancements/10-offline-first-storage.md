...
|---|-----------|------|-------------|
| 01 | [Versioned Storage](./11-versioned-storage.md) | Frontend | Version-keyed localStorage with auto-cleanup |
| 02 | [Sync Queue](./12-sync-queue.md) | Frontend | Background sync with retry logic |
| 03 | [Storage Hooks](./13-storage-hooks.md) | Frontend | React hooks for offline-first patterns |
| 04 | [Sync API](./14-sync-api.md) | Backend | Batch sync endpoint for queued operations |
...
- [11-versioned-storage.md](./11-versioned-storage.md) — Detailed storage implementation
- [12-sync-queue.md](./12-sync-queue.md) — Queue manager details
- [13-storage-hooks.md](./13-storage-hooks.md) — React integration
- [14-sync-api.md](./14-sync-api.md) — Backend batch sync endpoint
- [State Management](../16-state-management/00-overview.md)
- [Voice Resilience](./20-voice-resilience.md) — Uses this storage system
