...
`enhancements`, `features`, `management`, `software`
...
|-------|-------|------------|-----------------|
| 1 | [Offline-First Storage](./10-offline-first-storage.md) | localStorage versioning, sync queue | Medium |
| 2 | [Voice Resilience](./20-voice-resilience.md) | Audio capture, Local Whisper, failure recovery | High |
| 3 | [Plan Mode](./30-plan-mode.md) | Execution planning, approval workflow, modification | Medium |
| 4 | [Mermaid Diagrams](./40-mermaid-diagrams.md) | Architectural diagram generation, model categorization | Low |
| 5 | [Chat UI Redesign](./50-chat-ui-redesign.md) | Lovable-style interface, plus menu, actions panel | High |
| 6 | [Cross-Project Memory](./60-cross-project-memory.md) | Memory sharing, project spec references | High |
