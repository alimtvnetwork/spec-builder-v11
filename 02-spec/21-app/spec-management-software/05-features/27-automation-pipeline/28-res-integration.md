...
- [Escalation Notifications](../06-ai-integration/13-escalation-notifications.md)
...
CREATE INDEX IdxResLogStage ON RESExecutionLog(StageExecutionId);
CREATE INDEX IdxResLogMechanism ON RESExecutionLog(Mechanism);
```
