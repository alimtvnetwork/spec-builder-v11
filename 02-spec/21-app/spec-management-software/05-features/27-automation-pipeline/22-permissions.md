...
CREATE INDEX IdxPermPipeline ON PipelinePermission(PipelineId);
CREATE INDEX IdxPermUser ON PipelinePermission(UserId);
CREATE INDEX IdxPermTeam ON PipelinePermission(TeamId);
```
...
CREATE INDEX IdxTeamMemberTeam ON TeamMember(TeamId);
CREATE INDEX IdxTeamMemberUser ON TeamMember(UserId);
```
...
CREATE INDEX IdxAuditPipeline ON PermissionAuditLog(PipelineId);
CREATE INDEX IdxAuditPerformed ON PermissionAuditLog(PerformedAt);
```
