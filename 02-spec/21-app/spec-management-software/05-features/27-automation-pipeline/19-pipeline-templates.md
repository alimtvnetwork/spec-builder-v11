...
CREATE INDEX IdxTemplateCategory ON PipelineTemplate(Category);
CREATE INDEX IdxTemplatePublic ON PipelineTemplate(IsPublic);
```
...
CREATE INDEX IdxParamTemplate ON TemplateParameter(TemplateId);
```
