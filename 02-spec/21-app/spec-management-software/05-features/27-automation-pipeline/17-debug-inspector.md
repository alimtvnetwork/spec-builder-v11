...
CREATE INDEX IdxBreakpointPipeline ON DebugBreakpoint(PipelineId);
CREATE INDEX IdxWatchPipeline ON DebugWatch(PipelineId);
CREATE INDEX IdxSessionExecution ON DebugSession(ExecutionId);
```
