...
function getAnnouncement(prev: PlaybackStatus, next: PlaybackStatus): string | null {
  if (next === PlaybackStatus.Playing) return 'Playback started';
  if (next === PlaybackStatus.Paused) return 'Playback paused';
  if (next === PlaybackStatus.Error) return 'Playback error occurred';
  return null;
}
```
...
- **React Guidelines**: [/memories/constraints/react-guidelines](../../../../.ai-memory/memories/constraints/coding-guidelines.md)
