...
func TestUrlValidator_Scheme(t *testing.T) {
    tests := []struct {
        ...
        // URL-SCH-003: Reject FTP scheme
        {
            ...
            wantErr: true,
            errCode: "ErrKnowledgeInvalidUrl",
        },
...
func TestUrlValidator_PrivateNetworks(t *testing.T) {
    tests := []struct {
        ...
        // URL-PVT-001: Localhost rejected
        {
            ...
            allowPrivate: false,
            wantErr:      true,
            errCode:      "ErrKnowledgePrivateUrl",
        },
...
func TestPatternValidator_InvalidSyntax(t *testing.T) {
    tests := []struct {
        ...
        // PAT-SYN-001: Unmatched opening parenthesis
        {
            ...
            pattern: "(unclosed",
            errCode: "ErrKnowledgePatternInvalid",
        },
...
func TestPatternValidator_Timeout(t *testing.T) {
    ...
    t.Run("PAT-TMO-003: deeply nested groups", func(t *testing.T) {
        ...
        if err != nil {
            assert.Contains(t, err.Error(), "ErrKnowledgePatternInvalid")
        }
    })
}
...
func TestPathValidator_Basic(t *testing.T) {
    ...
    tests := []struct {
        ...
        // PATH-BSC-003: Non-existent path rejected
        {
            ...
            wantErr: true,
            errCode: "ErrKnowledgePathNotFound",
        },
...
func TestPathValidator_AllowedRoots(t *testing.T) {
    ...
    pathutil.EnsureDir(allowedDir)
    pathutil.EnsureDir(forbiddenDir)
    pathutil.EnsureDir(nestedAllowed)
...
func TestPathValidator_DirectoryRequirements(t *testing.T) {
    ...
    pathutil.WriteFile(filePath, []byte("content"), 0644)
    
    // Create unreadable directory
    unreadableDir := filepath.Join(tmpDir, "unreadable")
    pathutil.EnsureDir(unreadableDir)
    defer pathutil.Chmod(unreadableDir, 0755) // Cleanup
...
| 01-general-spec/03-quality/01-testing-standards-quality.md | Test standards |
