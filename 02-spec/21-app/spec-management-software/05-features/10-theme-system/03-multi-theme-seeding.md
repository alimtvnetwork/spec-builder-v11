...
CREATE INDEX IdxThemeBaseTheme ON Theme(BaseTheme);
CREATE INDEX IdxThemeSortOrder ON Theme(SortOrder);
```
...
func (s *ThemeService) GetUserTheme(context stdctx.Context, userId string) appfault.Result[*Theme] {
    ...
    if err != nil {
        ...
        return s.themeRepo.FindDefault(context)
    }
    return s.themeRepo.FindById(context, pref.ThemeId)
}
...
func (s *ThemeService) SetUserTheme(context stdctx.Context, userId, themeId string) error {
    ...
    return s.prefRepo.Upsert(context, &UserThemePreference{
        UserId:  userId,
        ThemeId: themeId,
    })
}
...
- [Seeding System](../../07-database-design/05-seed-data.md)
