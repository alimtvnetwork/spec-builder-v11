...
- [User Management](../03-project-management/00-overview.md)
...
func (g *CreditGuard) CheckBeforeGeneration(
    ...
    if balance.Available >= estimate.TotalEstimate {
        result.Allowed = true
    } else {
        result.Allowed = false
        result.Shortage = estimate.TotalEstimate - balance.Available
