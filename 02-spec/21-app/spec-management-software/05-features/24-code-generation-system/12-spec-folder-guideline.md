...
**This file location:** `02-spec/11-spec-management-software/05-features/24-code-generation-system/12-spec-folder-guideline.md`
...
└── spec-management-software/        # Project-specific specs
    ├── 95-master-index.md           # ★ START HERE - Master navigation
...
```
95-master-index.md → Find feature → Navigate to 05-features/{folder}/00-overview.md
```

The **95-master-index.md** contains:
...
- [Error Management](../../06-error-management/01-error-code-registry.md)
```
...
1. **Start at `95-master-index.md`** - Understand the full project structure
...
6. Update **95-master-index.md** if adding new folders
...
├────────────────────────────────────────────────────────────────┤
│                                                                 │
│  START: 02-spec/11-spec-management-software/95-master-index.md       │
│                                                                 │
│  FEATURES: 02-spec/11-spec-management-software/05-features/          │
│    └── {NN}-{feature}/00-overview.md                           │
│                                                                 │
│  ERRORS: 02-spec/11-spec-management-software/06-error-management/    │
│    └── 02-error-code-registry.md                               │
│                                                                 │
│  DATABASE: 02-spec/11-spec-management-software/07-database-design/   │
