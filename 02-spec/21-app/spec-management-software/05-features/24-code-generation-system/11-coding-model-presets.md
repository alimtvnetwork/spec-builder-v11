...
|------|----------|-------------|
| 8150 | `ErrModelPresetNotFound` | Model preset not found |
| 8151 | `ErrModelCategoryInvalid` | Invalid model category |
| 8152 | `ErrModelNoSuitable` | No suitable model found |
| 8153 | `ErrModelPresetDuplicate` | Duplicate preset name |
| 8154 | `ErrModelTestFailed` | Preset test failed |
