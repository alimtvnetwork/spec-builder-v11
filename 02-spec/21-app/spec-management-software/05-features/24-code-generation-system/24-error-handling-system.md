...
- [Error Code Registry](../../06-error-management/01-error-code-registry.md) - Error code standards
- [WebSocket Protocol](../18-realtime/01-websocket-integration.md) - Connection errors
