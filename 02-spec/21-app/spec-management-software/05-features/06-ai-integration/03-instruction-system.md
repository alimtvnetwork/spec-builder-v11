...
```json
{
  ...
  "Tasks": [
    ...
    },
    {
      ...
      "Type": "create",
      "TargetFile": "02-spec/frontend/12-export-dialog.md"
    }
  ],
  "EstimatedFiles": [
    "02-spec/backend/45-pdf-export-service.md",
    "02-spec/backend/46-pdf-templates.md",
    "02-spec/backend/03-api-endpoints.md",
    "02-spec/frontend/12-export-dialog.md"
  ],
  "Risks": [
...
1. **Create PDF export service spec** (create)
   - Target: `02-spec/backend/45-pdf-export-service.md`
   - Status: ✅ completed

2. **Add PDF template schema** (create)
   - Target: `02-spec/backend/46-pdf-templates.md`
   - Status: ✅ completed

3. **Update API endpoints spec** (update)
   - Target: `02-spec/backend/03-api-endpoints.md`
...
4. **Add frontend export UI spec** (create)
   - Target: `02-spec/frontend/12-export-dialog.md`
   - Status: ✅ completed
...
type InstructionService interface {
    ...
    ListInstructions(context stdctx.Context, projectId string, filter InstructionFilter) InstructionSummarySlice
    ...
    // Task management
    GetTasks(context stdctx.Context, instructionId string) TaskSlice
