...
`features`, `management`, `realtime`, `software`
...
> ⚠️ **REASSIGNED:** Previously used 12001-12031, which collided with WSP (WP SEO Publish CLI, 12000-12599). Moved to SM-RT 2800-2849 (within SM 2000-2999) per collision resolution (2026-02-28).
>
> **Range:** SM-RT 2800-2849 (within SM 2000-2999)

| Code | Constant | Description |
|------|----------|-------------|
| 2800 | `ErrWsConnectionFailed` | WebSocket connection failed |
| 2801 | `ErrWsAuthFailed` | WebSocket authentication failed |
| 2802 | `ErrWsMessageTimeout` | Message timeout |
| 2803 | `ErrWsInvalidMessage` | Invalid message format |
| 2810 | `ErrSseConnectionFailed` | SSE connection failed |
| 2811 | `ErrSseEventParse` | Failed to parse SSE event |
| 2820 | `ErrPresenceSyncFailed` | Presence sync failed |
| 2830 | `ErrOtTransformFailed` | OT transform failed |
| 2831 | `ErrOtConflict` | Unresolvable OT conflict |
