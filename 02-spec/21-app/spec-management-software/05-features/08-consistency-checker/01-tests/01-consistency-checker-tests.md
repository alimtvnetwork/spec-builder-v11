...
- See [Security Patterns](../../../../01-spec-authoring-guide/04-advanced/01-security-patterns-advanced.md) for security guidelines.
`
...
func main() {
	...
	result := processData(context, "input")
	fmt.Println(result)
}

func processData(context stdctx.Context, input string) string {
...
- **Implementation:** [14-consistency-checker-implementation.md](../02-consistency-checker-implementation.md)
- **Spec Definition:** [13-consistency-checker.md](../01-consistency-checker.md)
- **RAG Spec Guidelines:** [18-rag-spec-guidelines.md](../../09-knowledge-memory/02-rag-spec-guidelines.md)
- **Testing Standards:** [../../01-spec-authoring-guide/03-quality/01-testing-standards-quality.md](../../../../01-spec-authoring-guide/03-quality/01-testing-standards-quality.md)
