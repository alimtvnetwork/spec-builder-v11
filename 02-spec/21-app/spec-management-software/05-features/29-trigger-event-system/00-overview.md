...
`event`, `features`, `management`, `software`, `system`, `trigger`
...
|------|----------|-------------|
| 11001 | `ErrEventInvalidType` | Unknown event type |
| 11002 | `ErrEventInvalidPayload` | Payload schema validation failed |
| 11003 | `ErrEventDeliveryFailed` | Handler delivery failed after retries |
| 11004 | `ErrEventSubscriptionNotFound` | Subscription not found |
| 11005 | `ErrEventFilterInvalid` | Invalid filter expression |
| 11006 | `ErrEventHandlerTimeout` | Handler execution timeout |
| 11007 | `ErrEventReplayFailed` | Event replay failed |
| 11008 | `ErrEventStoreFull` | Event store capacity exceeded |
| 11009 | `ErrWebhookUnreachable` | Webhook endpoint unreachable |
| 11010 | `ErrTriggerRuleInvalid` | Invalid trigger rule configuration |
