...
|------|----------|-------------|
| 11011 | `ErrEventSchemaInvalid` | Event schema validation failed |
| 11012 | `ErrEventVersionUnsupported` | Event version no longer supported |
| 11013 | `ErrEventVersionDeprecated` | Event version deprecated (warning) |
| 11014 | `ErrEventPayloadTooLarge` | Payload exceeds size limit |
| 11015 | `ErrEventMigrationFailed` | Schema migration failed |
| 11016 | `ErrEventUuidInvalid` | Invalid UUID v7 format |
| 11017 | `ErrEventTimestampInvalid` | Invalid ISO 8601 timestamp |
| 11018 | `ErrEventNameInvalid` | Invalid event name format |
| 11019 | `ErrEventTypeMismatch` | Event type doesn't match name prefix |
| 11020 | `ErrEventCorrelationMissing` | Missing correlation ID |
