...
type VectorStore interface {
    Search(vector []float32, limit int) VectorResultSlice
...
...
// ModelPool holds typed model assignments by role
...
func selectModel(complexity QueryComplexity, intent string, modelPool ModelPool, threshold float64) string {
    switch intent {
    case "coding":
        return modelPool.Code
    case "creative":
        return modelPool.Creative
    }
    
    switch complexity {
    case ComplexitySimple:
        return modelPool.Simple
    case ComplexityComplex:
        return modelPool.Complex
    default:
        return modelPool.Simple
    }
}
...
func (mps *MultiPassSearcher) Search(query SearchQuery) PassResultSlice {
...
func (ve *ValidationEngine) Validate(claims []string, sources []SearchResult) ValidationResultSlice {
