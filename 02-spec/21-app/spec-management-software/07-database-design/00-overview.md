...
`database`, `design`, `management`, `software`
...
| 03 | [Relationships](./04-relationships.md) | FK constraints, indexes |
| 04 | [Conventions](./06-conventions.md) | Naming and type conventions |

### Diagrams

| # | Diagram | Description |
|---|---------|-------------|
| 01 | [ERD](./08-diagrams/01-erd.md) | Entity-relationship diagram |
| 02 | [System Architecture](./08-diagrams/02-system-architecture.md) | Overall system design |
