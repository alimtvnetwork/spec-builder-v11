...
**Cross-References:**
- [General Error Management](../../01-spec-authoring-guide/01-foundation/02-error-management-foundation.md)
- [Coding Guidelines](../04-coding-guidelines/00-overview.md)
- [Backend Error Codes](./02-backend/01-error-codes.md)
- [Frontend Error Boundaries](./03-frontend/01-error-codes.md)
...
type AppError struct {
    Code       int               // e.g., 3001
    Constant   string            // e.g., "ErrDbQuery"
    Message    string            // Human-readable
    Details    map[string]any    // EXEMPTED: error infrastructure boundary — diagnostic context is inherently unstructured (§7.2)
...
interface AppError {
  ...
  constant: string;       // e.g., "ErrValidationRequired"
...
return errors.NewValidation(
    ...
    "Email is required",
    // EXEMPTED: error factory call — matches AppError.Details signature (§7.2)
...
```json
{
  ...
  "error": {
    "code": 1001,
    "constant": "ErrValidationRequired",
...
- [Error Code Registry](./01-error-code-registry.md)
- [General Error Foundation](../../01-spec-authoring-guide/01-foundation/02-error-management-foundation.md)
