...
|-----------|-----------------|-------------|
| **Full Project** | `02-spec/11-spec-management-software/` | Complete spec set (375+ files) |
| **gsearch CLI** | `02-spec/11-spec-management-software/05-features/22-golang-search-cli/` | Multi-engine search CLI (26 files) |
| **brun CLI** | `02-spec/11-spec-management-software/05-features/23-build-runner-cli/` | Build runner CLI (18 files) |
...
```
02-spec/11-spec-management-software/05-features/22-golang-search-cli/
...
```
02-spec/11-spec-management-software/05-features/23-build-runner-cli/
├── 00-overview.md               # Start here
...
```
Required Context:
├── 02-spec/11-spec-management-software/
│   ├── 95-master-index.md                    # Navigation
│   ├── 96-context-for-ai.md                 # AI-specific context
│   ├── 19-data-models/                       # TypeScript interfaces
│   ├── 04-coding-guidelines/                 # Naming conventions
│   ├── 05-features/
│   │   ├── 31-security-cross-cutting.md      # Security requirements
...
### Reading Order
1. Read 95-master-index.md for full navigation
2. Read 96-context-for-ai.md for AI-specific context
3. Read 31-security-cross-cutting.md for security requirements
...
│       ├── 95-master-index.md       # ⭐ START HERE
│       ├── 96-context-for-ai.md    # ⭐ AI-SPECIFIC CONTEXT
│       ├── 97-ai-handoff-guide.md # ⭐ THIS FILE
...
│       │   ├── 31-security-cross-cutting.md  # ⭐ SECURITY
│       │   ├── 22-golang-search-cli/         # gsearch CLI
│       │   └── 23-build-runner-cli/          # brun CLI
│       ├── 06-error-management/     # Error codes
│       ├── 07-database-design/      # Schema
...
| **Full backend** | `95-master-index.md`, `96-context-for-ai.md`, `31-security-cross-cutting.md`, `plan.md` |
