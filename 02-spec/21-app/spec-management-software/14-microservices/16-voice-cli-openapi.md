...
**Cross-References:**
- [Voice-CLI Service](./10-voice-cli.md) — Service implementation details
- [Gateway OpenAPI](./14-gateway-openapi.md) — Gateway routing patterns
- [AI-Bridge Service](./04-ai-bridge.md) — LLM fallback integration
...
- [Voice-CLI Service](./10-voice-cli.md) — Service implementation
- [Gateway OpenAPI](./14-gateway-openapi.md) — Gateway routing
- [AI-Bridge Service](./04-ai-bridge.md) — LLM integration
- [Shared Pkg Modules](./08-shared-pkg-modules.md) — Error handling patterns
