...
`management`, `microservices`, `software`
...
|---------|------|--------------|-------------|
| Gateway | 8080 | [14-gateway-openapi.md](./14-gateway-openapi.md) | 2xxx |
...
7. [Gateway OpenAPI](./14-gateway-openapi.md) - REST API documentation
