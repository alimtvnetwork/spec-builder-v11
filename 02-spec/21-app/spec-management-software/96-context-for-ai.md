...
**File:** `02-spec/11-spec-management-software/95-master-index.md`
...
### 2. Project Overview
**File:** `02-spec/11-spec-management-software/00-overview.md`

Short overview of the project philosophy and folder layout.

### 3. Features Overview (Formerly Split-Spec)
**File:** `02-spec/11-spec-management-software/05-features/00-overview.md`
...
**File:** `.ai-memory/memories/spec-management/file-structure-conventions.md`
...
**Folder:** `02-spec/11-spec-management-software/05-features/24-code-generation-system/`
...
6. Update master index: `95-master-index.md`
...
1. `95-master-index.md` (full structure)
2. `05-features/00-overview.md` (feature index)
3. `.ai-memory/memories/spec-management/file-structure-conventions.md` (conventions)
