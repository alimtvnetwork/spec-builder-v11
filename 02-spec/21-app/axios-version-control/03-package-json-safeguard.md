...
Consistent with the project's [guard pattern standards](../../../.ai-memory/memories/architecture/coding-standards/guard-patterns.md), version validation uses positive existence guards — no compound checks or double negations.
...
- [Guard Pattern Standards](../../../.ai-memory/memories/architecture/coding-standards/guard-patterns.md)
