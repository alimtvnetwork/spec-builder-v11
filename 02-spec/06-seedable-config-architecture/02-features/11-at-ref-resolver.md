# 11 — `@<Table>.<Code>` Resolver (FU-13)

**Spec:** `06-seedable-config-architecture` (extension)
**Version:** 1.0.0
**Created:** 2026-05-04
**Status:** Authoritative
**Resolves:** FU-13 from `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` §3.1.
...
Tables in scope today (from `02-spec/19/15-rbac-and-status-seed.md` §2):
...
Input row from `02-spec/19/15-rbac-and-status-seed.md` §3 `RolePageAccess`:
...
- `02-spec/19-main-worker-service/14-error-codes.md` §2.1 + §2.6 — MWS codes raised by failures.
- `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` §3.1 — original syntax declaration.
