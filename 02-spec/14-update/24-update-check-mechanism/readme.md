...
> **Ambiguity:** None
> **Parent:** [02-spec/14-update/readme.md](../readme.md)
...
| # | File | Description |
|---|------|-------------|
| 00 | [readme.md](./readme.md) | This file — index and defining properties |
...
| Seedable config (where settings live) | [../../06-seedable-config-architecture/readme.md](../../06-seedable-config-architecture/readme.md) |
