...
| All backend-stored credentials MUST use AES-256 encryption | See `02-spec/25-gsearch-cli/02-frontend/05-ui-patterns.md` §Password Storage |
...
| Reference | Location |
|-----------|----------|
| UI Patterns (canonical) | `02-spec/25-gsearch-cli/02-frontend/05-ui-patterns.md` |
| UI Patterns Memory | `.ai-memory/memories/technical/frontend-ui-patterns.md` |
