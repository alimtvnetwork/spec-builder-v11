...
**Data Source:** [02-spec/28-ai-bridge-non-vector-rag/02-tree-index-schema.md](../28-ai-bridge-non-vector-rag/02-tree-index-schema.md)
...
| Reference | Location |
|-----------|----------|
| Non-Vector RAG Overview | `02-spec/28-ai-bridge-non-vector-rag/00-overview.md` |
| Tree Index Schema | `02-spec/28-ai-bridge-non-vector-rag/02-tree-index-schema.md` |
| API Interface | `02-spec/28-ai-bridge-non-vector-rag/07-api-interface.md` |
| Component Library | `./10-component-library.md` |
| Hooks Library | `./15-hooks-library.md` |
| Accessibility Spec | `./12-accessibility-spec.md` |
| Error Codes (12000–12999) | `02-spec/28-ai-bridge-non-vector-rag/08-error-codes.md` |
