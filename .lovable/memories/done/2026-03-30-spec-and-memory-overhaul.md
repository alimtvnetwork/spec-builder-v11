...
## 1. Spec Authoring Guide (`spec/05-spec-authoring-guide/`)
...
## 2. Coding Guidelines (`spec/02-coding-guidelines/`)
...
- Fixed 89 references to `.lovable/memory/` → `.lovable/memories/` across 8 files:
  - `plan.md`
  - `spec/61-how-app-issues-track/05-broken-suggestion-tracker-reference.md`
  - `spec/61-how-app-issues-track/06-broken-plan-md-references.md`
  - `spec/11-spec-management-software/98-changelog.md`
  - `spec/11-spec-management-software/05-features/30-ai-bridge/07-ai-suggestions-persistence.md`
  - `spec/11-spec-management-software/05-features/30-ai-bridge/08-ai-suggestions-filesystem-persistence.md`
...
| Reference | Location |
|-----------|----------|
| Spec Authoring Guide | `spec/05-spec-authoring-guide/00-overview.md` |
| Cyclomatic Complexity | `spec/02-coding-guidelines/01-cross-language/06-cyclomatic-complexity.md` |
| Type Safety Plan | `spec/02-coding-guidelines/02-typescript/07-type-safety-remediation-plan.md` |
| Memory Index | `.lovable/memories/00-memory-index.md` |
| Memory Folder Guide | `spec/05-spec-authoring-guide/06-memory-folder-guide.md` |
