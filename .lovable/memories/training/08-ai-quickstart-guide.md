...
**Reference:** `spec/06-split-db-architecture/00-overview.md`
...
**Reference:** `spec/07-seedable-config-architecture/00-overview.md`
...
**Reference:** `spec/03-error-code-registry/00-overview.md`
...
**Reference:** `spec/28-shared-cli-frontend/00-overview.md`
...
**Reference:** `spec/11-spec-management-software/05-features/09-knowledge-memory/`
...
1. `spec/01-general-spec/00-overview.md` - Foundation standards
2. `spec/06-split-db-architecture/00-overview.md` - Database hierarchy
3. `spec/07-seedable-config-architecture/00-overview.md` - Config pattern
4. `spec/03-error-code-registry/00-overview.md` - Error standards

## Tier 2 Reading (Supporting)

5. `spec/28-shared-cli-frontend/00-overview.md` - CLI patterns
6. `spec/50-powershell-integration/00-overview.md` - Build scripts
...
| Resource | Path |
|----------|------|
| Master Spec Index | `spec/00-overview.md` |
| SM Implementation Guide | `spec/11-spec-management-software/05-features/00-overview.md` |
| AI Bridge Spec | `spec/22-ai-bridge-cli/00-overview.md` |
