...
|----------|-------|----------|
| Main Software | 1 | `spec/11-spec-management-software/` |
| CLI Tools | 4 | `spec/08-*` through `spec/11-*` |
| Shared Architecture | 4 | `spec/03-*` through `spec/06-*` |
| WordPress | 2 | `spec/12-*` and `spec/13-*` |
| Infrastructure | 2 | `spec/01-*` and `spec/07-*` |
...
|------|--------|-------|-------------------|----------|
| General | `GEN` | 1000-1999 | N/A | `spec/03-error-code-registry/` |
| Spec Management | `SM` | 2000-2999 | N/A | `spec/11-spec-management-software/` |
| Link Manager | `LM` | 3000-3999 | N/A | `spec/30-wp-plugin/link-manager/` |
| GSearch | `GS` | 7000-7099 | 7050-7069 | `spec/20-gsearch-cli/` |
| BRun | `BR` | 7100-7599 | 7150-7169 | `spec/21-brun-cli/` |
| Nexus Flow | `NF` | 8000-8399 | 8050-8069 | `spec/24-nexus-flow-cli/` |
| AI Bridge | `AB` | 9000-9999 | 9050-9069 | `spec/22-ai-bridge-cli/` |
| PowerShell | `PS` | 9500-9599 | N/A | `spec/50-powershell-integration/` |
| WP Builder | `WPB` | 10000-10999 | N/A | `spec/31-wp-plugin-builder/` |
...
| 4 | `spec/11-spec-management-software/00-master-index.md` | Navigation index |
| 5 | `spec/11-spec-management-software/AI-HANDOFF-GUIDE.md` | Implementation guide |

### Tier 2: Architecture

| Order | File | Purpose |
|-------|------|---------|
| 6 | `spec/06-split-db-architecture/00-overview.md` | Database pattern |
| 7 | `spec/07-seedable-config-architecture/00-overview.md` | Config pattern |
| 8 | `spec/28-shared-cli-frontend/00-overview.md` | Frontend pattern |
| 9 | `spec/03-error-code-registry/01-registry.md` | Error codes |

### Tier 3: Implementation Specs

| Order | File | Purpose |
|-------|------|---------|
| 10 | `spec/11-spec-management-software/05-features/SM-010-golang-backend-implementation.md` | Backend spec |
| 11 | `spec/20-gsearch-cli/02-frontend/02-implementation-checklist.md` | CLI checklist template |
...
- [ ] Read `spec/11-spec-management-software/00-master-index.md`
- [ ] Read `spec/11-spec-management-software/AI-HANDOFF-GUIDE.md`
- [ ] Understand Split DB pattern (`spec/06-split-db-architecture/`)
- [ ] Understand Seedable Config pattern (`spec/07-seedable-config-architecture/`)
- [ ] Review error code registry (`spec/03-error-code-registry/01-registry.md`)
...
4. spec/11-spec-management-software/00-master-index.md
```
...
```
Read these:
1. spec/11-spec-management-software/AI-HANDOFF-GUIDE.md
2. spec/11-spec-management-software/05-features/SM-010-golang-backend-implementation.md
