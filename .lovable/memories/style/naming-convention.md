...
| Reference | Location |
|-----------|----------|
| AI Bridge DB Schema | `spec/22-ai-bridge-cli/01-backend/12-database-architecture.md` |
| WP SEO DB Schema | `spec/32-wp-seo-publish-cli/01-backend/06-split-db-schema.md` |
| GSearch DB Schema | `spec/20-gsearch-cli/01-backend/` |
