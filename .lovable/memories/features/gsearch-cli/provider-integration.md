...
- Specification: `spec/20-gsearch-cli/01-backend/59-provider-integration.md`
- Enum Architecture: `spec/20-gsearch-cli/01-backend/58-enum-architecture.md`
- Split DB: `spec/06-split-db-architecture/00-overview.md`
