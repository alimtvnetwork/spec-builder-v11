...
**Updated:** 2026-02-17  
**Version:** 1.0.0  
**Spec Location:** `spec/21-brun-cli/` (standalone, extracted from spec-management-software)
...
Integration reference at: `spec/11-spec-management-software/15-external-tools/04-brun-reference.md`
