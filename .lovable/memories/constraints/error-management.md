...
**Reference:** [Error Code Registry](../../../spec/11-spec-management-software/06-error-management/01-error-code-registry.md)
...
- [Error Code Registry](../../../spec/11-spec-management-software/06-error-management/01-error-code-registry.md)
- [Backend Error Codes](../../../spec/11-spec-management-software/06-error-management/02-backend/01-error-codes.md)
- [Frontend Error Codes](../../../spec/11-spec-management-software/06-error-management/03-frontend/01-error-codes.md)
- [Project Editor Errors](../../../spec/11-spec-management-software/05-features/28-project-editor/05-error-codes.md)
