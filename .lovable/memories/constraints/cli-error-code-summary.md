...
|----------|--------|------------|-------------------|---------------|
| **GSearch CLI** | `GS` | 7000-7099 | 7050-7069 | `spec/20-gsearch-cli/` |
| **BRun CLI** | `BR` | 7100-7599 | 7150-7169 | `spec/21-brun-cli/` |
| **Nexus Flow** | `NF` | 8000-8399 | 8050-8069 | `spec/24-nexus-flow-cli/` |
| **AI Bridge** | `AB` | 9000-9540 | 9050-9069 | `spec/22-ai-bridge-cli/` |
| **PowerShell** | `PS` | 9500-9599 | N/A | `spec/50-powershell-integration/` |
| **WP Plugin Builder** | `WPB` | 10000-10999 | N/A | `spec/31-wp-plugin-builder/` |
...
**Spec Location:** `spec/07-seedable-config-architecture/03-rag-validation-helpers.md`  
**Test Spec:** `spec/07-seedable-config-architecture/04-rag-validation-tests.md`  
**Coverage Matrix:** `spec/07-seedable-config-architecture/05-rag-test-coverage-matrix.md`
...
|-----------|----------|-----------------|
| 7000-7049 | Backend Core | `spec/20-gsearch-cli/01-backend/15-error-codes.md` |
...
| Sub-Range | Category | Error Codes Doc |
|-----------|----------|-----------------|
| 7100-7149 | Backend Core | `spec/21-brun-cli/01-backend/06-error-handling.md` |
...
| Sub-Range | Category | Error Codes Doc |
|-----------|----------|-----------------|
| 8000-8049 | Backend Core | `spec/24-nexus-flow-cli/01-backend/04-error-codes.md` |
...
| Sub-Range | Category | Error Codes Doc |
|-----------|----------|-----------------|
| 9000-9049 | Backend Core | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
...
| Document | Purpose |
|----------|---------|
| [Error Code Registry](../../../spec/03-error-code-registry/01-registry.md) | Central registry |
| [GSearch Error Codes](../../../spec/20-gsearch-cli/01-backend/15-error-codes.md) | GSearch CLI errors |
| [BRun Error Handling](../../../spec/21-brun-cli/01-backend/06-error-handling.md) | BRun CLI errors |
| [AI Bridge Error Codes](../../../spec/22-ai-bridge-cli/01-backend/05-error-codes.md) | AI Bridge CLI errors |
| [Nexus Flow Error Codes](../../../spec/24-nexus-flow-cli/01-backend/04-error-codes.md) | Nexus Flow CLI errors |
