...
|----------|---------|-------|--------|
| `spec/11-spec-management-software/05-features/` | ~982 | 29 | 🔴 Needs remediation |
| `spec/11-spec-management-software/08-roadmap-overview/` | ~116 | 1 | 🟡 Partially fixed |
| `spec/11-spec-management-software/14-microservices/` | ~656 | 8 | 🟡 External API structs EXEMPT |
| `spec/20-gsearch-cli/` | ~197 | 6 | 🟡 Partially fixed |
| `spec/30-wp-plugin/` | ~342 | 11 | 🟡 External WP API structs EXEMPT |
| `spec/26-ai-transcribe-cli/` | ~323 | 8 | 🟡 Some EXEMPT (external TTS APIs) |
| `spec/22-ai-bridge-cli/` | ~34 | 1 | 🟡 EXEMPT (external Ahrefs API) |
| `spec/24-nexus-flow-cli/` | ~67 | 1 | 🟢 Fixed this session |
| `spec/21-brun-cli/` | ~45 | 2 | 🟢 Fixed this session |
| `spec/28-shared-cli-frontend/` | ~32 | 3 | 🟢 Fixed this session |
| `spec/99-archive/` | ~50 | 1 | ⚪ Archive — no action needed |
| **TOTAL** | **~3,331** | **87** | |
...
| Location | Matches | Files | Status |
|----------|---------|-------|--------|
| `spec/11-spec-management-software/07-database-design/` | ~80 | 2 | 🔴 Needs ErrPascalCase |
| `spec/11-spec-management-software/05-features/09-knowledge-memory/` | ~50 | 3 | 🔴 Needs ErrPascalCase |
| `spec/11-spec-management-software/05-features/24-code-generation-system/` | ~40 | 2 | 🟡 Partially fixed |
| `spec/25-spec-reverse-cli/` | ~30 | 2 | 🔴 Uses `SRC_ERR_` prefix |
| `spec/11-spec-management-software/10-research/` | ~200 | 2 | 🟡 Test code examples |
| `spec/11-spec-management-software/14-microservices/` | ~100 | 5 | 🟡 Mixed |
| **TOTAL** | **~2,994** | **79** | |
...
| Location | Matches | Files | Status |
|----------|---------|-------|--------|
| `spec/11-spec-management-software/05-features/30-ai-bridge/` | ~60 | 3 | 🔴 Internal config structs |
| `spec/22-ai-bridge-cli/01-backend/` | ~100 | 2 | 🟡 Mixed (some PascalCase already) |
| `spec/99-archive/` | ~50 | 1 | ⚪ Archive |
| **TOTAL** | **~212** | **12** | |
