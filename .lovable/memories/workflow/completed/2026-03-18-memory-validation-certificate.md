...
| 5 | `project/folder-rename-history.md` | `../../spec/.../CONTEXT-FOR-AI.md` — renamed | → `96-context-for-ai.md` |
...
| 9 | `features/ai-bridge/plan-synchronization.md` | `spec/22-ai-bridge-cli/...` — wrong depth | → `../../../../spec/22-ai-bridge-cli/...` |
...
- **Spec baseline certificate:** `spec/validation-reports/14-audit-certificate-2026-03-18.md` (CERT-2026-0318-REFRESH)
