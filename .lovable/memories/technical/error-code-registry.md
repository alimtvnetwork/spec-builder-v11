...
- Source: `pkg/typecast/`
- Spec: `spec/02-coding-guidelines/01-cross-language/03-casting-elimination-patterns.md`
...
- Central Registry: `spec/03-error-code-registry/01-registry.md`
- GSearch BI Suite: `spec/20-gsearch-cli/01-backend/openapi-bi-suite.yaml`
- GSearch Movie Search: `spec/20-gsearch-cli/01-backend/15-error-codes.md`
- GSearch Model Decomposition: `spec/20-gsearch-cli/01-backend/54-model-decomposition.md`
- AI Bridge Errors: `spec/22-ai-bridge-cli/01-backend/05-error-codes.md`
- AI Bridge Long-Chain: `spec/22-ai-bridge-cli/01-backend/50-long-chain-command-system.md`
- AI Bridge Vector DB: `spec/22-ai-bridge-cli/01-backend/51-vector-database-integration.md`
- BRun CLI Errors: `spec/21-brun-cli/01-backend/06-error-handling.md`
- Nexus Flow Errors: `spec/24-nexus-flow-cli/01-backend/04-error-codes.md`
