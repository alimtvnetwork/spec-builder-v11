...
All projects (React, CLI, WordPress) MUST follow the Error Resolution specification at `spec/04-error-resolution/`. Key requirements:
...
Cross-References:
- Error Resolution: `spec/04-error-resolution/00-overview.md`
- Verification Patterns: `spec/04-error-resolution/02-verification-patterns/01-frontend-backend-sync.md`
...
- PHP Coding Guidelines: `spec/11-spec-management-software/12-prompts/01-coding-guideline/04-backend-php.md`
- React Guidelines: `spec/11-spec-management-software/12-prompts/01-coding-guideline/03-frontend-react.md`
