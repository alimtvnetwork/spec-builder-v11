...
|---------------|----------|
| **pkg/database Operations** | `spec/11-spec-management-software/13-shared-packages/06-pkg-database-operations.md` |
...
| Resource | Path |
|----------|------|
| **Seedable Config Spec** | `spec/07-seedable-config-architecture/00-overview.md` |
