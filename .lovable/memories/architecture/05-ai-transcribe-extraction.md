...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `spec/26-ai-transcribe-cli/00-overview.md`
...
- Main Spec: `spec/26-ai-transcribe-cli/00-overview.md`
- AI Bridge Delegation: `spec/22-ai-bridge-cli/01-backend/07-model-management.md`
- Original Voice Spec: `spec/11-spec-management-software/14-microservices/10-voice-cli.md` (deprecated)
