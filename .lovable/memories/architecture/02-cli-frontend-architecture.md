...
**Version:** 1.0.0  
**Status:** Active  
**Spec Location:** `spec/28-shared-cli-frontend/`
...
| Pattern | Location |
|---------|----------|
| Split DB | `spec/06-split-db-architecture/` |
| Seedable Config | `spec/07-seedable-config-architecture/` |
| PowerShell | `spec/50-powershell-integration/` |
...
- `spec/28-shared-cli-frontend/` (15+ files)
