...
- `spec/11-spec-management-software/05-features/20-testing/01-test-strategy.md`
...
|----------|--------------|
| [Test Naming & Structure](../../../spec/02-coding-guidelines/01-cross-language/14-test-naming-and-structure.md) | Naming rules R1–R7 |
| [Master Coding Guidelines §13](../../../spec/02-coding-guidelines/01-cross-language/15-master-coding-guidelines.md) | Index entry |
| [Frontend Test Strategy](../../../spec/11-spec-management-software/05-features/20-testing/01-test-strategy.md) | Frontend-specific detail |
| [WP Plugin Testing](../../../spec/30-wp-plugin/03-exam-manager/01-admin-backend/02-split-spec/41-testing-requirements.md) | PHPUnit / plugin tests |
