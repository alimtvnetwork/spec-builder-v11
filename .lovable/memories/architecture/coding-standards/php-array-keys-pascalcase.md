...
| Reference | Location |
|-----------|----------|
| Coding Standards §12 | `spec/01-general-spec/01-foundation/01-coding-standards-foundation.md` |
| PHP Naming Conventions | `spec/02-coding-guidelines/04-php/naming-conventions.md` §API/DB Keys |
| Forbidden Patterns §11 | `spec/02-coding-guidelines/04-php/forbidden-patterns.md` §11 (snake_case API keys) |
