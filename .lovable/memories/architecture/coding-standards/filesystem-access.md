...
~1,912 raw `os.*` violations remain across 96 spec files (updated 2026-03-12, post-Wave 11). See `spec/61-how-app-issues-track/13-raw-filesystem-nested-if-violations.md`.
