...
- `spec/02-coding-guidelines/04-php/forbidden-patterns.md` § 9 (Magic Strings — Plugin Identity)
- `spec/33-wp-plugin-development/11-coding-guidelines.md` (Early-boot logging)
