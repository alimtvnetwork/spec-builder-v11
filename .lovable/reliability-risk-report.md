...
| 5 | P-001 | Register 9xxx error codes | `spec/03-error-code-registry/` |
...
| Document | Purpose |
|----------|---------|
| [Master Index](../spec/11-spec-management-software/95-master-index.md) | Full spec navigation (400+ files) |
