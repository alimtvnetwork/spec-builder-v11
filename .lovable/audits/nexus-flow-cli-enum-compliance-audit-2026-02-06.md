...
Create `spec/24-nexus-flow-cli/01-backend/10-enum-architecture.md` with all enum definitions following `spec/17-enum-specification/` standard.
...
| Core Specification | `spec/24-nexus-flow-cli/01-backend/01-core-specification.md` |
