 ...
 **Evidence**: `00-overview.md` lines 375-395 define comprehensive error code registry:
 ...
 | Document | Path |
 |----------|------|
 | AI Bridge Overview | `spec/22-ai-bridge-cli/00-overview.md` |
 | Backend Overview | `spec/22-ai-bridge-cli/01-backend/00-overview.md` |
 | Database Architecture | `spec/22-ai-bridge-cli/01-backend/12-database-architecture.md` |
 | Settings Service | `spec/22-ai-bridge-cli/01-backend/12-settings-service.md` |
 | Error Codes | `spec/22-ai-bridge-cli/01-backend/05-error-codes.md` |
 | Observability | `spec/22-ai-bridge-cli/01-backend/11-observability.md` |
