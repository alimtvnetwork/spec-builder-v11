...
| File | Changes |
|------|---------|
| `spec/31-wp-plugin-builder/15-enum-architecture.md` | Created with all 14 compliant enums |
| `spec/31-wp-plugin-builder/01-core-architecture.md` | Replaced Command.Type switch with `Is*()` methods |
| `spec/31-wp-plugin-builder/03-configuration.md` | Added enum references to JSON schema |
| `spec/31-wp-plugin-builder/04-database-schema.md` | Replaced string enums and RunMigrations with `db_type.Variant` |
| `spec/31-wp-plugin-builder/07-code-generation.md` | Replaced OverwriteMode and Action strings with enum types |
...
| Enum Architecture | `spec/31-wp-plugin-builder/15-enum-architecture.md` |
