...
**File:** `spec/30-wp-plugin/link-manager/00-overview.md` (line 8)  
...
**File:** `spec/03-error-code-registry/01-registry.md` (line 14)  
**Issue:** The registry lists `LM` at range **3000-3999**, but `spec/30-wp-plugin/link-manager/00-overview.md` uses **14000-14999**. These are contradictory.  
...
**File:** `spec/30-wp-plugin/wp-plugin-publish/66-shared-constants.md`  
...
**File:** `spec/30-wp-plugin/wp-plugin-publish/00-overview.md` (line 33)  
...
**File:** `spec/30-wp-plugin/wp-plugin-publish/00-overview.md` (line 211)  
...
**File:** `spec/30-wp-plugin/exam-manager/66-shared-constants.md`  
...
**File:** `spec/30-wp-plugin/exam-manager/00-overview.md` (line 349)  
**Issue:** Has debugging section but it references `spec/11-spec-management-software/12-prompts/` path for PHP coding guidelines which is non-standard.  
**Fix:** Ensure path is `spec/03-spec-management-software/` or wherever it actually lives (directory listing shows `11-spec-management-software/`).
...
**File:** `spec/31-wp-plugin-builder/11-api-interface.md` (line 22)  
...
**File:** `spec/31-wp-plugin-builder/03-configuration.md` (line 114)  
...
**File:** `spec/31-wp-plugin-builder/03-configuration.md` (lines 66-160)  
...
**File:** `spec/31-wp-plugin-builder/04-database-schema.md` (lines 41-63, 94-110, etc.)  
...
**File:** `spec/31-wp-plugin-builder/04-database-schema.md` (lines 128, 166-167, 270-271)  
...
**File:** `spec/31-wp-plugin-builder/04-database-schema.md` (lines 356-362)  
...
**File:** `spec/31-wp-plugin-builder/15-enum-architecture.md` (lines 125-135)  
...
**File:** `spec/31-wp-plugin-builder/` (directory)  
...
**File:** `spec/31-wp-plugin-builder/10-error-handling.md` (lines 213-271)  
...
**File:** `spec/31-wp-plugin-builder/10-error-handling.md` (lines 111-207)  
...
**File:** `spec/31-wp-plugin-builder/04-database-schema.md` (lines 22-31)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/06-split-db-schema.md` (line 92)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/06-split-db-schema.md` (line 101)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/06-split-db-schema.md` (lines 392-473)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/01-architecture.md` (lines 89-120)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/01-architecture.md`  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/06-split-db-schema.md` (lines 157, 162, 205, 209, 220, 247, 260)  
...
**File:** `spec/03-error-code-registry/01-registry.md` (line 25)  
**Issue:** SRC spec location listed as `spec/12-spec-reverse-cli/` but actual location is `spec/25-spec-reverse-cli/`.  
**Fix:** Update registry to `spec/25-spec-reverse-cli/`.

### Finding 3.8 — 🔵 MINOR: WP SEO Publish Path in Central Registry is Wrong

**File:** `spec/03-error-code-registry/01-registry.md` (line 26)  
**Issue:** WSP spec location listed as `spec/14-wp-seo-publish/` but actual location is `spec/14-wp-seo-publish-cli/`.  
**Fix:** Update registry to `spec/14-wp-seo-publish-cli/`.

### Finding 3.9 — 🔵 MINOR: Missing Mandatory Specs

**File:** `spec/14-wp-seo-publish-cli/01-backend/` (directory)  
...
**File:** `spec/14-wp-seo-publish-cli/01-backend/06-split-db-schema.md` (lines 163-168)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md` (line 360)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md`  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md` (lines 351-367)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md` (lines 415-422)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/` (directory)  
**Issue:** Missing mandatory specs per CLI documentation requirements:
...
**File:** `spec/25-spec-reverse-cli/00-overview.md` (lines 20-31)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md` (line 307)  
...
**File:** `spec/25-spec-reverse-cli/01-backend/01-architecture.md` (line 338)  
...
**File:** `spec/25-spec-reverse-cli/00-overview.md` (lines 189-196)  
...
|----------------|-------------|-------------|
| SRC (Spec Reverse) | `spec/12-spec-reverse-cli/` | `spec/25-spec-reverse-cli/` |
| WSP (WP SEO Publish) | `spec/14-wp-seo-publish/` | `spec/14-wp-seo-publish-cli/` |
