...
**Scope:** `spec/26-ai-transcribe-cli/` (22 files), `spec/60-ai-research/` (6 files)  
**Date:** 2026-02-07  
**Status:** Complete  
...
`spec/60-ai-research/` is a **reference-only** research silo containing guides and analysis. It has no:
- Error codes
- Database schemas
- API endpoints
- Configuration files
...
| Reference | Issue |
|-----------|-------|
| `spec/22-ai-bridge-cli/01-backend/47-onboarding-guide.md` | File may not exist; unverified |
| `.lovable/memories/features/ai-bridge/rag-pipeline.md` | Memory file; not a spec |
| `spec/22-ai-bridge-cli/01-backend/41-memory-classification-flags.md` | Unverified |
