...
| File | Changes |
|------|---------|
| `spec/20-gsearch-cli/01-backend/58-enum-architecture.md` | Full rewrite with 15 compliant enums |
| `spec/20-gsearch-cli/01-backend/02-configuration.md` | Updated struct fields to use enum types |
