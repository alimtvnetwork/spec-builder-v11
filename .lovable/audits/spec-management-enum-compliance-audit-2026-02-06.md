...
Create `spec/11-spec-management-software/07-database-design/05-enum-architecture.md` with all enum definitions following `spec/17-enum-specification/` standard.
...
| Core Entities | `spec/11-spec-management-software/03-data-models/01-core-entities.md` |
| AI Types | `spec/11-spec-management-software/03-data-models/02-ai-types.md` |
