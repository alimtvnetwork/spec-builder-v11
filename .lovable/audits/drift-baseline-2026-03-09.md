...
|--------|------|---------|-------|--------|
| GSearch CLI (main) | `spec/20-gsearch-cli/` | **431** | 16 | 🔴 Active remediation |
| BRun CLI | `spec/21-brun-cli/` | **143** | 7 | 🔴 Open (BR-I08) |
| AI Bridge CLI | `spec/22-ai-bridge-cli/` | **73** | 10 | 🟢 Mostly exempted (v4.0.1) |
| NexusFlow CLI | `spec/24-nexus-flow-cli/` | **120** | 2 | 🔴 Unremediated |
| WP Plugin Publish | `spec/30-wp-plugin/` | **75** | 4 | 🔴 Unremediated |
| WP Plugin Builder | `spec/31-wp-plugin-builder/` | **70** | 1 | 🟡 All in enum Parse() |
| AI Transcribe CLI | `spec/26-ai-transcribe-cli/` | **295** | 9 | 🔴 Unremediated |
| Spec Management | `spec/11-spec-management-software/` | **1,953** | 73 | 🔴 Largest backlog |
| License Manager | `spec/27-license-manager/` | **5** | 1 | 🟢 Report text only |
| Golang Standards | `spec/02-coding-guidelines/03-golang/` | **77** | 7 | 🟡 Mixed (examples + templates) |
...
| Module | Path | Matches | Files | Status |
|--------|------|---------|-------|--------|
| GSearch CLI (main) | `spec/20-gsearch-cli/` | **374** | 17 | 🔴 Active remediation |
| BRun CLI | `spec/21-brun-cli/` | **20** | 3 | 🟡 Low count (BR-I10) |
| AI Bridge CLI | `spec/22-ai-bridge-cli/` | **199** | 13 | 🟡 Partially remediated |
| NexusFlow CLI | `spec/24-nexus-flow-cli/` | **152** | 3 | 🔴 Unremediated |
| WP Plugin Publish | `spec/30-wp-plugin/` | **508** | 10 | 🔴 Unremediated |
| WP Plugin Builder | `spec/31-wp-plugin-builder/` | **0** | 0 | 🟢 Clean |
| AI Transcribe CLI | `spec/26-ai-transcribe-cli/` | **233** | 6 | 🔴 Unremediated |
| Spec Management | `spec/11-spec-management-software/` | **2,856** | 71 | 🔴 Largest backlog |
| License Manager | `spec/27-license-manager/` | **0** | 0 | 🟢 Clean |
...
- GSearch CLI feature spec directory (`spec/11-spec-management-software/05-features/22-golang-search-cli/`) was remediated in Wave 2/2.5 and is at ~99/100.
