...
| 04 | [04-update-health-dashboard-file-counts.md](./pending/04-update-health-dashboard-file-counts.md) | Medium | Update `spec/00-overview.md` for `spec/10-app/` file count (P-084) | None |
