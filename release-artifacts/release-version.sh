...
# ║  Built:      2026-04-21T10:38:24Z
# ║  Commit:     dc844ef32d55
# ║  Builder:    root
# ║  Asset URL:  https://github.com/alimtvnetwork/coding-guidelines-v15/releases/download/v3.16.0/release-version.sh
# ╚═══════════════════════════════════════════════════════════════════════╝
# ────────────────────────────────────────────────────────────────────────────
...
# (release.sh / release.ps1) replaces the https://github.com/alimtvnetwork/coding-guidelines-v15/releases/download/v3.16.0/release-version.sh token with the
...
GENERAL_INSTALLER='https://github.com/alimtvnetwork/coding-guidelines-v15/raw/main/install.sh'
