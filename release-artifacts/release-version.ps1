...
.DESCRIPTION
    ...
    (release.sh / release.ps1) replaces the https://github.com/alimtvnetwork/coding-guidelines-v15/releases/download/v3.16.0/release-version.ps1 token below with
